...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link sps xbrldi xbrli xlink xs xsi">
	...
	<xsl:param name="_Version_Name" select="'APCTOBOX150511'"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.2cm" margin-right="0.2cm" page-height="55mm" page-width="127mm" margin-top="0.2in" margin-bottom="0.0in">
				<fo:region-body margin-top="-0.46cm" margin-bottom="-0.60cm" column-count="1" column-gap="0.50in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.2cm" margin-right="0.2cm" page-height="55mm" page-width="127mm" margin-top="0.2in" margin-bottom="0.0in">
				<fo:region-body margin-top="-0.46cm" margin-bottom="-0.60cm" column-count="1" column-gap="0.50in"/>
			</fo:simple-page-master>
						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" font-size="6.5pt" line-height="7pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row font-size="6.5pt">
													...
													<fo:table-cell number-rows-spanned="3" border="none" border-bottom-style="none" border-collapse="collapse" border-left-style="none" font-family="Arial" font-size="6pt" line-height="5.5pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																...
																<xsl:choose>
																	<xsl:when test="SHIP_TO_COUNTRY_NAME=&quot;Australia&quot;">
																		<xsl:for-each select="BOX_ID">
																			...
																			<xsl:choose>
																				<xsl:when test="contains(string($value-of-template_2),'&#x200B;')">
																					<fo:block font-family="Free 3 of 9 Extended" font-size="35pt">
												...
												<fo:table-row height="0.01in">
													<fo:table-cell number-columns-spanned="3" border="none" border-bottom-style="none" border-collapse="collapse" border-left-style="none" border-top-style="none" font-family="Arial" font-size="6pt" font-weight="bold" line-height="6pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
												...
												<fo:table-row height="0.08in">
													<fo:table-cell number-columns-spanned="3" border="none" border-collapse="collapse" font-family="Arial" font-size="5.5pt" line-height="5pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
												...
												<fo:table-row height="0.01in">
													<fo:table-cell number-columns-spanned="3" border="none" font-family="Arial" font-size="5.5pt" font-weight="bold" line-height="6pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" margin="0" padding="0" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row>
													<fo:table-cell number-columns-spanned="3" border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="7pt" line-height="3pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
												...
												<fo:table-row>
													...
													<fo:table-cell number-columns-spanned="2" border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="5.5pt" font-weight="bold" line-height="6pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:block>
																	<fo:leader leader-pattern="space"/>
																</fo:block>
																<fo:inline font-family="Arial" font-size="5.5pt" font-weight="bold" line-height="6pt">
																	<xsl:text>DESCRIPTION:</xsl:text>
																</fo:inline>
																<fo:inline font-family="Arial" font-size="9pt" font-weight="bold" line-height="6pt">
																	<xsl:text>&#160;</xsl:text>
																</fo:inline>
																<xsl:for-each select="UDF_DETAIL">
												...
												<fo:table-row>
													<fo:table-cell number-columns-spanned="2" border="none" border-collapse="collapse" border-top-style="none" font-size="6pt" line-height="6pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
