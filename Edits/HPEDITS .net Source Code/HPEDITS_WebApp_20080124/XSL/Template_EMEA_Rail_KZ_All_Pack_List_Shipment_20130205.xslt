												...
												<fo:table-row>
													<fo:table-cell border="none" padding="2pt" display-align="center">
														<fo:block>
															...
															<fo:inline>
																<xsl:value-of select="SHIP_TO_ID"/>
															</fo:inline>
															<fo:block/>
															<fo:inline>
															...
															<fo:block/>
															<fo:inline>
																<xsl:value-of select="SHIP_TO_NAME_3"/>
															</fo:inline>
															<fo:block/>
															<fo:inline>
																<xsl:value-of select="SHIP_TO_STREET"/>
															</fo:inline>
															<fo:block/>
															<fo:inline>
																<xsl:value-of select="SHIP_TO_STREET_2"/>
															</fo:inline>
															<fo:block/>
															<fo:inline>
																<xsl:value-of select="SHIP_TO_CITY"/>
															</fo:inline>
															<fo:inline>
																<xsl:text>&#160;</xsl:text>
															</fo:inline>
															<fo:inline>
																<xsl:value-of select="SHIP_TO_STATE"/>
															</fo:inline>
															<fo:block/>
															<fo:inline>
																<xsl:value-of select="SHIP_TO_COUNTRY_NAME"/>
															</fo:inline>
															<fo:inline>
																<xsl:text>&#160;</xsl:text>
															</fo:inline>
															<fo:inline>
																<xsl:value-of select="SHIP_TO_ZIP"/>
															</fo:inline>
															<fo:block/>
															<fo:inline>
																<xsl:value-of select="SHIP_TO_CONTACT"/>
															</fo:inline>
															<fo:inline>
																<xsl:text>&#160;</xsl:text>
															</fo:inline>
															<fo:inline>
																<xsl:value-of select="SHIP_TO_TELEPHONE"/>
															</fo:inline>
														</fo:block>
													</fo:table-cell>
													<fo:table-cell border="none" padding="2pt" display-align="center">
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>EMEAAKRAILPK130129</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
