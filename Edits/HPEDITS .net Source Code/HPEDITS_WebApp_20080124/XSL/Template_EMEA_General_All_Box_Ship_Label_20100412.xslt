...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:param name="CUST_PO_max" select="'21'"/>
	...
	<xsl:param name="SHIP_FROM_CITY_max" select="'8'"/>
	<xsl:param name="SHIP_FROM_COUNTRY_NAME_max" select="'8'"/>
							...
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" font-weight="bold" line-height="7pt" display-align="before" padding="2pt" text-align="right">
													<fo:block>
														...
														<fo:block margin="0pt">
															<fo:block>
																<fo:inline>
																	<xsl:text>EGOBSL100412</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block>
													</fo:block>
													...
													<fo:block>
														...
														<fo:table border="none" margin="none" padding="none" table-layout="fixed" width="100%" border-spacing="2pt">
															...
															<fo:table-body start-indent="0pt">
																...
																<fo:table-row margin="none" padding="none" display-align="before">
																	<fo:table-cell border="none" font-family="Free 3 of 9 Extended" font-size="30pt" font-weight="normal" line-height="24pt" margin="none" padding="none" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" height="8">
																		<fo:block>
																			<fo:inline display-align="before">
																				<xsl:text>*</xsl:text>
																			</fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-column column-width="30%"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row height="0.5pt" line-height="0.5pt">
