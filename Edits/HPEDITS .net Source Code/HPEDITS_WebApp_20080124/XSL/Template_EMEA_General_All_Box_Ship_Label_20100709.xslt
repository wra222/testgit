...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:param name="SHIP_FROM_ZIP_max" select="'8'"/>
	<xsl:param name="SHIP_TO_CITY_max" select="'16'"/>
	<xsl:param name="SHIP_TO_ID_max" select="'16'"/>
	...
	<xsl:param name="SHIP_TO_STREET_2_max" select="'30'"/>
	<xsl:param name="SHIP_TO_STREET_max" select="'30'"/>
						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="10pt" font-weight="bold" line-height="7pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row border-collapse="collapse">
												<fo:table-cell border="none" font-family="Arial" font-size="16pt" font-weight="bold" padding="2pt" height="6" text-align="left" display-align="center">
													<fo:block>
														<fo:block/>
														<fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="12pt" font-weight="bold" padding="2pt" height="6" text-align="center" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="16pt" font-weight="bold" number-columns-spanned="2" padding="2pt" height="6" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:value-of select="substring(SUB_REGION , 1 , $SUB_REGION_max)"/>
														</fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" font-family="Arial" font-size="7pt" line-height="8pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" font-weight="bold" padding="2pt" height="48" display-align="before">
													<fo:block>
														...
														<fo:block/>
														<fo:inline>
															<xsl:value-of select="substring( SHIP_TO_COUNTRY_CODE , 1 , $STCC_max )"/>
														</fo:inline>
														<fo:inline>
															<xsl:text>&#160; </xsl:text>
														</fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" font-weight="bold" line-height="7pt" display-align="before" padding="2pt" text-align="right">
													<fo:block>
														<fo:external-graphic border-collapse="collapse" content-height="20px" display-align="before" content-width="30px">
														...
														<fo:block margin="0pt">
															<fo:block>
																<fo:inline>
																	<xsl:text>EGOBSL100709</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block>
													</fo:block>
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row line-height="6pt">
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:inline>
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:inline>
											...
											<fo:table-row line-height="8pt">
												<fo:table-cell border="none" font-family="Free 3 of 9 Extended" font-size="20pt" line-height="16pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>*</xsl:text>
														</fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" height="17pt" line-height="17pt" table-layout="fixed" width="100%">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row font-family="Arial" font-size="10pt" height="1PT">
												<fo:table-cell border="none" font-family="Arial" font-size="9pt" font-weight="bold" number-columns-spanned="2" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
														...
														<fo:table border="none" margin="none" padding="none" table-layout="fixed" width="100%" border-spacing="2pt">
															<fo:table-column column-width="50%"/>
															<fo:table-column column-width="50%"/>
															<fo:table-body start-indent="0pt">
																<fo:table-row margin="none" padding="none" display-align="after">
																	<fo:table-cell border="none" font-family="Arial" font-size="9pt" font-weight="bold" margin="none" padding="none" display-align="after" height="1" text-align="left">
																		<fo:block>
																	...
																	<fo:table-cell border="none" font-family="Free 3 of 9 Extended" font-size="30pt" font-weight="normal" line-height="24pt" margin="none" padding="none" display-align="after" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" height="1" text-align="right">
																		<fo:block>
																			<fo:inline height="10pt">
																				<xsl:text>*</xsl:text>
																			</fo:inline>
																			<xsl:for-each select="PACK_ID">
																				<xsl:variable name="value-of-template">
																...
																<fo:table-row margin="none" padding="none" display-align="before">
																	<fo:table-cell border="none" font-family="Free 3 of 9 Extended" font-size="30pt" font-weight="normal" line-height="24pt" margin="none" padding="none" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" height="1" text-align="left">
																		<fo:block>
																			<fo:inline height="10pt">
																				<xsl:text>*</xsl:text>
																			</fo:inline>
																	...
																	<fo:table-cell border="none" font-family="Arial" font-size="9pt" font-weight="bold" margin="none" padding="none" display-align="before" height="1" text-align="right">
																		<fo:block>
																			<fo:inline display-align="before">
																				<xsl:text>Pack ID: </xsl:text>
																			</fo:inline>
																...
																<fo:table-row margin="none" padding="none" display-align="after">
																	<fo:table-cell border="none" font-family="Arial" font-size="9pt" font-weight="bold" margin="none" padding="none" display-align="after" height="1">
																		<fo:block>
																			<fo:inline display-align="after">
																	...
																	<fo:table-cell border="none" font-family="Free 3 of 9 Extended" font-size="30pt" font-weight="normal" line-height="24pt" margin="none" padding="none" display-align="after" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" height="8" text-align="right">
																		<fo:block>
																			<fo:inline display-align="after">
																				<xsl:text>*</xsl:text>
																			</fo:inline>
																...
																<fo:table-row margin="none" padding="none" display-align="before">
																	<fo:table-cell border="none" font-family="Free 3 of 9 Extended" font-size="30pt" font-weight="normal" line-height="22pt" margin="none" padding="none" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" height="8">
																		<fo:block>
																			<fo:inline display-align="before">
																				<xsl:text>*</xsl:text>
																			</fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row margin="none" padding="none">
												<fo:table-cell border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" line-height="11pt" margin="none" padding="none" number-columns-spanned="4" height="1" display-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
