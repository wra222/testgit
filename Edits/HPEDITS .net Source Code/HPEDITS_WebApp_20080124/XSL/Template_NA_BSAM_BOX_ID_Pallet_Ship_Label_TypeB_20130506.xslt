									...
									<fo:table border="none" table-layout="fixed" width="100%" border-spacing="2pt">
										...
										<fo:table-body border="none" start-indent="0pt">
											<fo:table-row border="none">
												...
												<fo:table-cell border="none" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" line-height="8pt" padding="2pt" text-align="center" display-align="center">
													<fo:block>
