						...
						<fo:table-row>
							<fo:table-cell border="none" line-height="8pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt">
								<fo:block>
									...
									<fo:block/>
									<fo:inline>
										<xsl:text>JL. Prof. Dr. Satrio Kav. EIV/6</xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline>
										<xsl:text>Menara Bank Danamon LT 23-26 </xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline>
										<xsl:text>12950 Jakarta</xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>IDOPKT121109</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
