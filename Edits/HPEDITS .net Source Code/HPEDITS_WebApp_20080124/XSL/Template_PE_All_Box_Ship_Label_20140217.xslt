											...
											<fo:table-row border-collapse="collapse" line-height="6pt" width="100%">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" line-height="5.5pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" number-rows-spanned="2" padding="2pt" height="1" text-align="center">
													<fo:block>
														...
														<fo:block/>
														<fo:inline>
															<xsl:text>RUC: 20335020872</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row line-height="3pt">
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline font-size="larger" line-height="4pt">
												...
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-size="7pt" font-weight="bold" margin="none" padding="none" number-columns-spanned="4" height="1" text-align="right" display-align="center">
													<fo:block>
														...
														<fo:inline font-family="Arial" font-size="5pt" font-weight="bold">
															<xsl:text>LAPEBOX140217</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
