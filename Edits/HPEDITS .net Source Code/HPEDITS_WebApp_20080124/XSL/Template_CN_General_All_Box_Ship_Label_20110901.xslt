								...
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="7pt" line-height="8pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row border-collapse="collapse" width="100%">
												...
												<fo:table-cell border="none" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="0.5pt" border-left-style="none" font-family="新宋体" font-size="6pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="left">
													<fo:block>
														<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="新宋体" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline font-family="Arial">
												...
												<fo:table-cell border="none" font-family="新宋体" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" text-align="right" display-align="center">
													<fo:block>
														<fo:inline font-family="Arial">
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="新宋体" font-size="7pt" line-height="4pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline font-family="Arial">
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" line-height="4pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
											...
											<fo:table-row width="100%">
												<fo:table-cell border="none" font-family="新宋体" font-size="7pt" line-height="4pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" display-align="center">
													<fo:block>
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" height="10pt" line-height="10pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row line-height="4pt">
												<fo:table-cell border="none" border-top-color="transparent" border-top-style="none" line-height="4pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="after">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
