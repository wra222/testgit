						...
						<xsl:for-each select="$XML">
							...
							<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" padding="0pt" table-layout="fixed" width="100%">
								...
								<fo:table-body start-indent="0pt">
									...
									<fo:table-row>
										<fo:table-cell border="none" border-collapse="collapse" border-style="none" padding="2pt" height="16" display-align="center">
											<fo:block/>
										</fo:table-cell>
										<fo:table-cell border="none" border-top-color="black" border-top-style="solid" border-top-width="0.5pt" padding="2pt" height="16" display-align="center">
											<fo:block>
												<fo:inline>
							...
							<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" padding="0pt" table-layout="fixed" width="100%">
								...
								<fo:table-body start-indent="0pt">
									...
									<fo:table-row>
										...
										<fo:table-cell border="none" padding="0pt" padding-left="3pt" display-align="center">
											<fo:block>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>EGOPKT100201</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
