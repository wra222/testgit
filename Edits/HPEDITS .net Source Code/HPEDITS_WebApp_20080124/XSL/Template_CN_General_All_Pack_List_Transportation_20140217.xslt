...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:param name="SHIP_TO_STATE_max" select="'5'"/>
	...
	<xsl:param name="SHIP_VIA_CITY_MAX" select="'25'"/>
						...
						<xsl:for-each select="$XML">
							...
							<xsl:for-each select="PACK_ID">
								...
								<xsl:if test="PACK_ID_LINE_ITEM">
									<fo:table border="none" border-collapse="collapse" font-family="宋体" font-size="8pt" font-style="normal" font-variant="normal" font-weight="normal" padding="0pt" table-layout="fixed" width="100%">
							...
							<fo:table border="none" border-collapse="collapse" border-style="none" font-family="Arial" font-size="8pt" font-style="normal" font-variant="normal" font-weight="normal" padding="0pt" display-align="before" table-layout="fixed" width="100%">
								...
								<fo:table-column column-width="6.05in"/>
									...
									<fo:table-row>
										<fo:table-cell border="none" border-style="none" padding="0pt" display-align="before">
											<fo:block>
												...
												<fo:inline font-family="宋体" font-size="8pt">
													<xsl:text>总重量</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
							...
							<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" padding="0pt" table-layout="fixed" width="100%">
								...
								<fo:table-body start-indent="0pt">
									...
									<fo:table-row>
										...
										<fo:table-cell border="none" border-top-color="black" border-top-style="solid" border-top-width="0.5pt" font-family="Arial" font-size="8pt" padding="2pt" height="14" display-align="center">
											<fo:block>
												<fo:inline>
													<xsl:text>Signature (</xsl:text>
												</fo:inline>
												<fo:inline font-family="宋体" font-size="8pt">
													<xsl:text>签字</xsl:text>
												</fo:inline>
												<fo:inline>
													<xsl:text>)</xsl:text>
												</fo:inline>
							...
							<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" padding="0pt" table-layout="fixed" width="100%">
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										<fo:table-cell border="none" border-collapse="collapse" border-style="none" font-family="宋体" font-size="8pt" padding="2pt" display-align="center">
											<fo:block/>
										</fo:table-cell>
										...
										<fo:table-cell border="none" border-collapse="collapse" border-style="none" font-family="宋体" font-size="8pt" padding="2pt" display-align="center">
											<fo:block>
												<xsl:if test="string-length(PACK_ID/PICKING_INSTR_HEAD) &gt;0 or string-length(PACK_ID/SHIPPING_INSTR_HEAD) &gt; 0 or string-length(PACK_ID/DELIVERY_INSTR_HEAD) &gt; 0 or string-length(PACK_ID/SPECIAL_INSTR_HEAD) &gt; 0">
													<fo:block/>
													<xsl:for-each select="PACK_ID">
														<fo:inline font-family="宋体" font-size="8pt" font-weight="bold">
															<xsl:text>特别运输指示:</xsl:text>
														</fo:inline>
				...
				<fo:table border="none" border-collapse="collapse" font-family="宋体" font-size="8pt" font-style="normal" font-variant="normal" font-weight="normal" padding="0pt" table-layout="fixed" width="100%">
					...
					<fo:table-body start-indent="0pt">
						...
						<fo:table-row>
							...
							<fo:table-cell border="none" font-family="Arial" font-size="12pt" font-style="normal" font-variant="normal" font-weight="bold" padding="2pt" text-align="center" display-align="center">
								<fo:block>
									...
									<fo:block margin="0pt">
										<fo:block>
											<fo:inline>
												<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; DELIVERY NOTE/PACKING LIST</xsl:text>
											</fo:inline>
										</fo:block>
									</fo:block>
									<fo:inline font-family="宋体" font-size="12pt">
										<xsl:text>装箱单</xsl:text>
									</fo:inline>
									<fo:inline>
										<xsl:text>&#160;&#160; </xsl:text>
									</fo:inline>
							...
							<fo:table-cell border="none" font-family="SimSun" font-size="8pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
						...
						<fo:table-row>
							...
							<fo:table-cell border="none" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt">
								<fo:block>
									...
									<fo:block/>
									<fo:inline font-weight="bold">
										<xsl:text>SHIP VIA (运经地) :</xsl:text>
									</fo:inline>
									<fo:block/>
									<xsl:for-each select="$XML">
										<xsl:for-each select="PACK_ID">
							...
							<fo:table-cell border="none" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt">
								<fo:block>
									...
									<fo:block/>
									<fo:inline>
										<xsl:text>SHIP REF# (运输单号)</xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline-container>
										<fo:block>
									...
									<fo:block/>
									<fo:inline>
										<xsl:text>INT&apos;L CARRIER / FF (承运商)</xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline>
									...
									<fo:block/>
									<fo:inline>
										<xsl:text>SHIP MODE (运输方式)</xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline>
										<xsl:text>SHIP DATE (出货日期)</xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline>
										<xsl:text>SHIP FROM (货运地)</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="none" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt">
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>CGLAPKT140217</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
