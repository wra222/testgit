	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="default-page" page-height="8.27in" page-width="11.69in" margin-left=".5cm" margin-right=".5cm">
				<fo:region-body margin-top="8.5cm" margin-bottom="0.5in"/>
			...
			<fo:page-sequence master-reference="default-page" initial-page-number="1" format="1">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block border="none">
						...
						<fo:block border="none" height="5pt" line-height="5pt" margin="0pt">
							<fo:block>
						...
						<xsl:for-each select="$XML">
							...
							<xsl:for-each select="PACK_ID">
								...
								<xsl:if test="PACK_ID_LINE_ITEM">
									<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="10pt" font-style="normal" font-variant="normal" font-weight="normal" padding="0pt" table-layout="fixed" width="100%">
										...
										<fo:table-column column-width="10%"/>
										<fo:table-header border="none" start-indent="0pt">
											<fo:table-row background-color="#787878" border="none" color="white" text-align="center">
												<fo:table-cell border="1pt" border-color="black" border-style="solid" padding="0" height="25" display-align="center">
													<fo:block>
														<fo:inline border="none">
												...
												<fo:table-cell border="1pt" border-color="black" border-left-style="none" border-style="solid" padding="0" height="25" display-align="center">
													<fo:block>
														<fo:inline border="none">
												...
												<fo:table-cell border="1pt" border-color="black" border-left-style="none" border-style="solid" padding="0" height="25" display-align="before">
													<fo:block>
														<fo:inline border="none">
												...
												<fo:table-row border="none">
													...
													<fo:table-cell border="none" padding="0" display-align="before">
														<fo:block>
															...
															<fo:inline border="none" font-family="Free 3 of 9 Extended" font-size="30pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed">
																<xsl:text>*</xsl:text>
															</fo:inline>
															<xsl:for-each select="$XML">
																<xsl:for-each select="PACK_ID">
							...
							<fo:block text-align="center">
								<fo:leader border="none" leader-pattern="rule" rule-thickness="1pt" leader-length="100%"/>
							</fo:block>
							<fo:inline-container>
								<fo:block>
									<xsl:text>&#x2029;</xsl:text>
			...
			<fo:block>
				...
				<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="10pt" font-style="normal" font-variant="normal" font-weight="normal" padding="0pt" table-layout="fixed" width="100%">
					...
					<fo:table-body border="none" start-indent="0pt">
						...
						<fo:table-row border="none">
							...
							<fo:table-cell border="none" padding="2pt" display-align="center">
								<fo:block>
									...
									<fo:page-number border="none"/>
									<fo:inline border="none">
										<xsl:text>&#160; of&#160;&#160;&#160;&#160; </xsl:text>
									</fo:inline>
									<fo:page-number-citation ref-id="SV_RefID_PageTotal" border="none"/>
									<fo:block/>
									<fo:inline-container>
										<fo:block>
											<xsl:text>&#x2029;</xsl:text>
						...
						<fo:table-row border="none">
							<fo:table-cell border="none" font-size="8pt" line-height="8pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="995">
								<fo:block>
									<xsl:for-each select="$XML">
										<xsl:for-each select="PACK_ID">
											<fo:inline border="none">
									...
									<fo:block/>
									<fo:inline border="none" font-size="8pt">
										<xsl:text>PT. HEWLETT PACKARD INDONESIA</xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline border="none" font-size="8pt">
										<xsl:text>GEDUNG PERKANTORAN PRUDENTIAL CENTRE </xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline border="none" font-size="8pt">
										<xsl:text>KOTA KASABLANKA LANTAI 9 &amp; 10, UNIT A-H</xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline border="none" font-size="8pt">
										<xsl:text>JL. CASABLANCA KAV. 88 MENTENG DALAM, TEBET </xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline border="none" font-size="8pt">
										<xsl:text>JAKARTA SELATAN, DKI JAKARTA 12870</xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline border="none" font-size="8pt">
							...
							<fo:table-cell border="none" font-size="10pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="995">
								<fo:block>
									<fo:inline border="none" font-family="Arial" font-size="10pt" font-style="normal" font-weight="bold">
									...
									<fo:block/>
									<fo:inline border="none" font-family="Free 3 of 9 Extended" font-size="35pt">
										<xsl:text>*</xsl:text>
									</fo:inline>
									<xsl:for-each select="$XML">
										<xsl:for-each select="PACK_ID">
											<xsl:for-each select="SHIP_REF">
												...
												<xsl:choose>
													<xsl:when test="contains(string($value-of-template),'&#x2029;')">
														<fo:block border="none" font-family="Free 3 of 9 Extended" font-size="35pt" font-style="normal">
															<xsl:copy-of select="$value-of-template"/>
														</fo:block>
													</xsl:when>
													<xsl:otherwise>
														<fo:inline border="none" font-family="Free 3 of 9 Extended" font-size="35pt" font-style="normal">
															<xsl:copy-of select="$value-of-template"/>
														</fo:inline>
													</xsl:otherwise>
												</xsl:choose>
									...
									<fo:inline border="none" height="1PT" line-height="1PT">
										<xsl:text>&#160;&#160; </xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline border="none" font-size="10pt" font-weight="bold">
									...
									<xsl:for-each select="$XML">
										<xsl:for-each select="PACK_ID">
											...
											<fo:block border="none" font-family="Arial" font-size="10PT" margin="0pt">
												<fo:block>
													<fo:inline border="none" font-size="10pt">
							...
							<fo:table-cell border="none" font-size="8pt" display-align="before" padding="2pt" height="995">
								<fo:block>
									<fo:inline border="none">
							...
							<fo:table-cell border="none" font-size="8pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="995">
								<fo:block>
									<fo:inline border="none">
										<xsl:text>: </xsl:text>
									</fo:inline>
					...
					<fo:table-body border="none" start-indent="0pt">
						<fo:table-row border="none">
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline border="none">
										<xsl:text>IDAPKS140217</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="none" font-size="smaller" padding="0" text-align="left" display-align="center">
								<fo:block>
									...
									<fo:block border="none" font-family="Arial Black" font-size="7pt" white-space="pre" white-space-collapse="false" margin="0pt">
										<fo:block>
											<xsl:for-each select="$XML">
												<xsl:for-each select="PACK_ID">
						...
						<fo:table-row border="none">
							...
							<fo:table-cell border="none" font-size="smaller" padding="0" text-align="right" display-align="center">
								<fo:block>
									...
									<fo:page-number border="none" font-weight="bold"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
