	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="default-page" page-height="15.24cm" page-width="10.16cm" margin-left="0.3cm" margin-right="0.3cm">
				<fo:region-body margin-top="0.3cm" margin-bottom="0.3in"/>
							...
							<xsl:for-each select="PALLETS">
								<xsl:for-each select="PALLET">
									...
									<fo:table border="none" font-size="10pt" height="15pt" line-height="15pt" table-layout="fixed" width="100%" border-spacing="2pt">
										...
										<fo:table-body border="none" start-indent="0pt">
											<fo:table-row border="none">
												<fo:table-cell border="none" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" font-weight="normal" line-height="8pt" padding="2pt" text-align="left" display-align="center">
													<fo:block>
												...
												<fo:table-cell border="none" border-bottom-style="none" border-left-style="none" border-right-style="none" border-top-style="none" font-size="8pt" line-height="8pt" padding="2pt" text-align="left" display-align="center">
													<fo:block>
									...
									<fo:table border="none" table-layout="fixed" width="100%" border-spacing="2pt">
										...
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body border="none" start-indent="0pt">
											<fo:table-row border="none" line-height="14pt" display-align="before">
															...
															<xsl:for-each select="BOX">
																<xsl:if test="position() mod 2 = 1">
																	<xsl:for-each select="BOX_ID">
																		...
																		<fo:block border="none" font-family="Free 3 of 9 Extended" font-size="24pt" margin="0pt">
																			<fo:block>
																				<fo:inline border="none">
																					<xsl:text>*</xsl:text>
																				</fo:inline>
																		...
																		<fo:block border="none" font-family="Arial" font-size="6pt" margin-left="(100% - 100%) div 2" margin-right="(100% - 100%) div 2" margin="0pt">
																			<fo:block>
																				<xsl:variable name="value-of-template">
																					<xsl:apply-templates/>
																				</xsl:variable>
												...
												<fo:table-cell border="none" padding="2pt" text-align="center" display-align="before">
													<fo:block>
														...
														<fo:block border="none" font-family="Arial" font-size="6pt" margin="0pt">
															<fo:block>
																<fo:inline border="none">
																	<xsl:text>&#160;</xsl:text>
																</fo:inline>
						...
						<fo:table-row border="none">
							<fo:table-cell border="none" padding="0" number-columns-spanned="2" height="30" text-align="center" display-align="center">
								<fo:block>
									...
									<fo:inline border="none" font-size="6pt">
										<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; EMEAPLB110805</xsl:text>
									</fo:inline>
									<fo:inline border="none">
										<xsl:text>&#160;</xsl:text>
									</fo:inline>
