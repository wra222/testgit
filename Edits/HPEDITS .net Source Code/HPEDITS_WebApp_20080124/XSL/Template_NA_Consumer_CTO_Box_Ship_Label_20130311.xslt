							...
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" height="4pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="5.5pt" font-weight="normal" line-height="5pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="5" padding="2pt" display-align="before">
													<fo:block>
														<fo:block/>
									...
									<fo:table border="none" border-collapse="collapse" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row line-height="2pt">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="7pt" font-weight="normal" line-height="1pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="right" display-align="before">
													<fo:block>
														<fo:inline font-size="5pt" font-weight="bold">
															<xsl:text>NACCTOBOX130311</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
