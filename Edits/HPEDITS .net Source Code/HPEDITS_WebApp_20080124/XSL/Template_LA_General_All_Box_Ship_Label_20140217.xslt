						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" height="5pt" line-height="3pt" table-layout="fixed" width="100%">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="50%"/>
										<fo:table-body height="5pt" line-height="3pt" start-indent="0pt">
											<fo:table-row>
											...
											<fo:table-row height="5pt" line-height="3pt">
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" height="5pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" text-align="left" display-align="center">
													<fo:block>
														<fo:inline height="5pt" line-height="3pt">
															<xsl:text>PO #:&#160; </xsl:text>
														</fo:inline>
														<fo:inline height="5pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed">
															<xsl:value-of select="substring( CUST_PO , 1 , $CUST_PO_max )"/>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" height="5pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" text-align="right" display-align="center">
													<fo:block>
														<fo:inline font-size="larger" height="5pt" line-height="3pt">
											...
											<fo:table-row font-family="Free 3 of 9 Extended" font-size="20pt" height="5pt" line-height="3pt" width="100%">
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" height="5pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline height="5pt" line-height="3pt">
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" height="5pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="right" display-align="center">
													<fo:block>
														<fo:inline height="5pt" line-height="3pt">
														...
														<xsl:for-each select="BOX_SEQUENCE">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																	<fo:block height="5pt" line-height="3pt">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:block>
																</xsl:when>
																<xsl:otherwise>
									...
									<fo:table border="none" border-collapse="collapse" height="5pt" line-height="3pt" table-layout="fixed" width="100%">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="50%"/>
										<fo:table-body height="5pt" line-height="3pt" start-indent="0pt">
											<fo:table-row height="5pt" line-height="3pt">
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" height="5pt" line-height="3pt" number-columns-spanned="3" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
														...
														<fo:block height="5pt" line-height="3pt" white-space="pre" white-space-collapse="false" margin="0pt">
															<fo:block>
																<xsl:for-each select="UDF_HEADER">
																	<xsl:if test="./KEY = &apos;ODM_TEXT1&apos; and string-length(./VALUE)&gt;0">
																		<fo:inline font-family="Arial" font-size="7pt" font-weight="bold" height="5pt" line-height="3pt">
