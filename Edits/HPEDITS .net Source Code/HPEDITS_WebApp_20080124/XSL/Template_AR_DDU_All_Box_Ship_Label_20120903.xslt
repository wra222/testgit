...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:param name="SOLD_TO_CITY_max" select="'30'"/>
	<xsl:param name="SOLD_TO_COUNTRY_NAME_max" select="'30'"/>
	<xsl:param name="SOLD_TO_NAME2_max" select="'35'"/>
	<xsl:param name="SOLD_TO_NAME3_max" select="'35'"/>
	<xsl:param name="SOLD_TO_NAME_max" select="'35'"/>
	<xsl:param name="SOLD_TO_STATE_max" select="'30'"/>
	<xsl:param name="SOLD_TO_STREET2_max" select="'35'"/>
	<xsl:param name="SOLD_TO_STREET_max" select="'35'"/>
	<xsl:param name="SOLD_TO_ZIP_max" select="'30'"/>
						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" line-height="7pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row border-collapse="collapse" line-height="7pt" width="100%">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" number-rows-spanned="2" padding="2pt" height="1" text-align="center">
													<fo:block>
														...
														<xsl:for-each select="UDF_HEADER">
															<xsl:if test="./KEY = &apos;SOLD_TO_NAME&apos; and string-length(./VALUE)&gt;0">
																<fo:inline>
																	<xsl:value-of select="substring( VALUE , 1 , $SOLD_TO_NAME_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:block/>
														<xsl:for-each select="UDF_HEADER">
															<xsl:if test="./KEY = &apos;SOLD_TO_NAME2&apos; and string-length(./VALUE)&gt;0">
																<fo:inline>
																	<xsl:value-of select="substring( VALUE , 1 , $SOLD_TO_NAME2_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:inline>
														...
														<xsl:for-each select="UDF_HEADER">
															<xsl:if test="./KEY = &apos;SOLD_TO_NAME3&apos; and string-length(./VALUE)&gt;0">
																<fo:inline>
																	<xsl:value-of select="substring( VALUE , 1 , $SOLD_TO_NAME3_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:block/>
														<xsl:for-each select="UDF_HEADER">
															<xsl:if test="./KEY = &apos;SOLD_TO_STREET&apos; and string-length(./VALUE)&gt;0">
																<fo:inline>
																	<xsl:value-of select="substring( VALUE , 1 , $SOLD_TO_STREET_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:inline>
														...
														<xsl:for-each select="UDF_HEADER">
															<xsl:if test="./KEY = &apos;SOLD_TO_STREET2&apos; and string-length(./VALUE)&gt;0">
																<fo:inline>
																	<xsl:value-of select="substring( VALUE , 1 , $SOLD_TO_STREET2_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:block/>
														<xsl:for-each select="UDF_HEADER">
															<xsl:if test="./KEY = &apos;SOLD_TO_CITY&apos; and string-length(./VALUE)&gt;0">
																<fo:inline>
																	<xsl:value-of select="substring( VALUE , 1 , $SOLD_TO_CITY_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:inline>
														...
														<xsl:for-each select="UDF_HEADER">
															<xsl:if test="./KEY = &apos;SOLD_TO_STATE&apos; and string-length(./VALUE)&gt;0">
																<fo:inline>
																	<xsl:value-of select="substring( VALUE , 1 , $SOLD_TO_STATE_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:inline>
														...
														<xsl:for-each select="UDF_HEADER">
															<xsl:if test="./KEY = &apos;SOLD_TO_ZIP&apos; and string-length(./VALUE)&gt;0">
																<fo:inline>
																	<xsl:value-of select="substring( VALUE , 1 , $SOLD_TO_ZIP_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:inline>
														...
														<xsl:for-each select="UDF_HEADER">
															<xsl:if test="./KEY = &apos;SOLD_TO_COUNTRY_NAME&apos; and string-length(./VALUE)&gt;0">
																<fo:inline>
																	<xsl:value-of select="substring( VALUE , 1 , $SOLD_TO_COUNTRY_NAME_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
													</fo:block>
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-size="7pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="8pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" height="18" display-align="center">
													<fo:block>
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="4pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="1" text-align="left" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="4pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row margin="none" padding="none">
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" margin="none" padding="none" height="1" text-align="left" display-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
												...
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="5pt" font-weight="bold" line-height="4pt" margin="none" padding="none" number-columns-spanned="5" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>LAARDDUBOX120905</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
