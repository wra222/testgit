...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link sps xbrldi xbrli xlink xs xsi">
	...
	<xsl:param name="aVersion_Name" select="'LAPEBOX150901'"/>
							...
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
													...
													<fo:table-cell number-rows-spanned="2" border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" line-height="5.5pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="center">
																...
																<fo:block/>
																<fo:inline>
																	<xsl:text>HP Inc. Peru SRL </xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>Victor Andres Belaunde 147,Torre Real 12, Piso 3</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>San Isidro, Lima - Peru, RUC: 20335020872</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
													...
													<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" line-height="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Free 3 of 9 Extended" font-size="28pt" line-height="6pt">
																	<xsl:text>*</xsl:text>
																</fo:inline>
																<xsl:for-each select="BOX_ID">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_2),'&#x200B;')">
																			<fo:block font-family="Free 3 of 9 Extended" font-size="28pt" line-height="6pt">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row height="0.01in">
													<fo:table-cell number-columns-spanned="2" border="none" font-family="Arial" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-family="Free 3 of 9 Extended" font-size="24pt" line-height="3pt">
																	<xsl:text>*</xsl:text>
																</fo:inline>
																<xsl:for-each select="CUST_PO">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_7),'&#x200B;')">
																			<fo:block font-family="Free 3 of 9 Extended" font-size="24pt" line-height="3pt">
												...
												<fo:table-row height="0.01in" line-height="3pt">
													<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-weight="bold" line-height="4pt">
													...
													<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-size="larger" font-weight="bold" line-height="4pt">
																...
																<xsl:for-each select="BOX_SEQUENCE">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_8),'&#x200B;')">
																			<fo:block font-weight="bold" line-height="4pt">
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row height="0.01in" line-height="5pt" margin="none" padding="none">
													...
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-size="7pt" font-weight="bold" line-height="6pt" margin="none" padding="none" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
