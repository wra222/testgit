														...
														<xsl:for-each select="BOX">
															<xsl:if test="position() mod number(substring($NumBoxPerPage,count(../BOX[1]/SERIAL_NUM)*2-1,2)) = 1">
																...
																<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" table-layout="fixed" width="100%">
																	...
																	<fo:table-body start-indent="0pt">
																		<fo:table-row>
																			<fo:table-cell border="none" height="80pt" padding="2pt" text-align="left" display-align="center">
																				<fo:block>
																					<fo:inline>
														...
														<xsl:for-each select="BOX">
															<xsl:if test="position() mod number(substring($NumBoxPerPage,count(../BOX[1]/SERIAL_NUM)*2-1,2)) = 1">
																...
																<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" table-layout="fixed" width="100%">
																	...
																	<fo:table-body start-indent="0pt">
																		<fo:table-row>
																			<fo:table-cell border="none" height="80pt" number-columns-spanned="3" padding="2pt" text-align="center" display-align="center">
																				<fo:block>
																					<fo:inline-container>
																						<fo:block>
																							<xsl:text>&#x2029;</xsl:text>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" font-family="Arial" font-size="7pt" padding="0" height="30" display-align="center">
								<fo:block>
									<fo:inline width="15%">
										<xsl:text>WGOPLA131111</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
