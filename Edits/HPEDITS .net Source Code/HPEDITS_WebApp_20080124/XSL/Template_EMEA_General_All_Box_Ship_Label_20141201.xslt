										...
										<fo:table-body margin="0" padding="0" start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													...
													<fo:table-cell number-columns-spanned="2" number-rows-spanned="2" border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial" font-size="5pt" line-height="6pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Arial" font-size="5pt" font-weight="bold" line-height="6pt" margin="0" padding="0">
																	<xsl:text>SHIP FROM:&#160; </xsl:text>
																</fo:inline>
																<fo:inline font-family="Arial" font-size="5pt" font-weight="bold" line-height="7pt" margin="0" padding="0">
																...
																<fo:block/>
																<fo:inline font-family="Arial" font-size="5pt" font-weight="bold" margin="0" padding="0">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell number-columns-spanned="2" border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial" font-size="5pt" line-height="6pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-family="Arial" font-size="6pt" font-weight="bold" line-height="8pt">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													...
													<fo:table-cell number-rows-spanned="2" border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial Narrow" font-size="24pt" font-weight="bold" line-height="5pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="after">
														<fo:block-container overflow="hidden">
															<fo:block text-align="center">
																<fo:block-container border="none" height="10mm" margin="0" padding="0" width="10mm" overflow="hidden">
																	<fo:block-container absolute-position="absolute" font-family="Arial Narrow" font-size="9pt" height="10mm" margin="0" text-align="center" width="10mm" overflow="hidden" reference-orientation="-90">
																		<fo:block>
																			<fo:inline font-family="Arial Narrow" font-size="24pt" margin="0" padding="0">
																				<xsl:value-of select="substring( PACK_ID ,  string-length( PACK_ID )-1)"/>
																			</fo:inline>
																		</fo:block>
																	</fo:block-container>
																</fo:block-container>
													...
													<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" line-height="6pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="after">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																...
																<xsl:for-each select="BOX_SEQUENCE">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_4),'&#x200B;')">
																			<fo:block font-family="Arial" font-size="6pt" font-weight="bold" line-height="6pt">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="9pt" line-height="11pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="after">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell number-columns-spanned="2" border="none" border-collapse="collapse" font-family="Arial" font-size="5pt" line-height="7pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Free 3 of 9 Extended" font-size="30pt">
																	<xsl:text>*</xsl:text>
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row line-height="6pt">
													...
													<fo:table-cell border="none" margin="0" padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-family="Arial" font-size="8pt" font-weight="bold">
																	<xsl:text>BOX ID: </xsl:text>
													...
													<fo:table-cell border="none" margin="0" padding="0" display-align="after">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Arial" font-size="6pt" font-weight="bold">
												...
												<fo:table-row line-height="6pt">
													<fo:table-cell number-columns-spanned="2" border="none" margin="0" padding="0" padding-bottom="2pt" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Arial" font-size="6pt" font-weight="bold" line-height="5pt">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row line-height="8pt">
													<fo:table-cell number-rows-spanned="2" border="none" border-collapse="collapse" line-height="10pt" margin="0" padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-family="Arial" font-size="10pt" font-weight="bold">
																	<xsl:value-of select="substring(SUB_REGION , 1 , $SUB_REGION_max)"/>
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row margin="none" padding="none">
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="5.5" line-height="5pt" margin="none" padding="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
													...
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="5.5" line-height="5pt" margin="none" padding="none" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Arial" font-size="5pt" font-weight="bold">
																	<xsl:text>EMEABOX141212</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
