...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link sps xbrldi xbrli xlink xs xsi">
	...
	<xsl:param name="aVersion_Name" select="'LAARBOX150901'"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.1cm" margin-right="0.1cm" page-height="55mm" page-width="127mm" margin-top="0.0in" margin-bottom="0.0in">
				<fo:region-body margin-top="0.10cm" margin-bottom="-0.60cm" column-count="1" column-gap="0.50in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.1cm" margin-right="0.1cm" page-height="55mm" page-width="127mm" margin-top="0.0in" margin-bottom="0.0in">
				<fo:region-body margin-top="0.10cm" margin-bottom="-0.60cm" column-count="1" column-gap="0.50in"/>
			</fo:simple-page-master>
							...
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" line-height="7pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row border-collapse="collapse" height="0.01in" line-height="7pt" width="100%">
													...
													<fo:table-cell number-rows-spanned="2" border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="center">
																...
																<fo:block/>
																<fo:inline>
																	<xsl:text>HP Inc Argentina S.R.L.</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>Montañeses 2150, (C1428AQH)</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>Ciudad de Buenos Aires, Argentina</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>CUIT: 30-71480937-3 </xsl:text>
																</fo:inline>
																<fo:block/>
															</fo:block>
														</fo:block-container>
												...
												<fo:table-row border-collapse="collapse" height="0.01in" width="100%">
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row height="0.01in" margin="none" padding="none">
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="5pt" line-height="6pt" margin="none" padding="none" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline-container>
																	<fo:block>
																...
																<fo:block text-align="left" margin-right="100% - 100%" white-space="pre" white-space-collapse="false" margin="0pt">
													...
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="4pt" font-weight="bold" line-height="4pt" margin="none" padding="none" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; </xsl:text>
