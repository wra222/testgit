														...
														<xsl:for-each select="BOX">
															<xsl:if test="position() mod number(substring($NumBoxPerPage,count(../BOX[1]/SERIAL_NUM)*2-1,2)) = 1">
																...
																<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" table-layout="fixed" width="100%">
																	...
																	<fo:table-body start-indent="0pt">
																		<fo:table-row>
																			<fo:table-cell border="none" font-family="宋体" height="80pt" padding="2pt" text-align="left" display-align="center">
																				<fo:block>
																					<fo:inline-container>
																						<fo:block>
																							<xsl:text>&#x2029;</xsl:text>
																		...
																		<fo:table-row>
																			<fo:table-cell border="none" border-bottom="0.5pt" border-bottom-color="black" border-bottom-style="solid" padding="2pt" text-align="left" display-align="before">
																				<fo:block>
																					<fo:inline>
																				...
																				<fo:block>
																					...
																					<fo:block margin-left="(100% - 100%) div 2" margin-right="(100% - 100%) div 2" margin="0pt">
																						<fo:block>
																							...
																							<fo:inline font-family="宋体" font-size="10pt" font-weight="bold">
																								<xsl:text>箱号单</xsl:text>
																							</fo:inline>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" font-family="Arial" font-size="7pt" padding="0" height="30" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>CGLAPKA140217</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
