									...
									<fo:table border="none" table-layout="fixed" width="100%" border-spacing="2pt">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row line-height="3pt">
												...
												<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="5.5pt" font-weight="bold" line-height="3pt" padding="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" height="6" text-align="right" display-align="center">
													<fo:block>
											...
											<fo:table-row>
												...
												<fo:table-cell border="none" border-collapse="collapse" border-left-style="none" font-family="Arial" font-size="5pt" font-weight="bold" line-height="1pt" display-align="auto" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="right">
													<fo:block>
														<fo:inline>
															<xsl:text>APCOBOX131118</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
