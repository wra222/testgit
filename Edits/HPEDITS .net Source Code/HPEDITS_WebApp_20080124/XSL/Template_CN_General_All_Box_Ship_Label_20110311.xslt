												...
												<fo:table-cell border="none" border-bottom-style="none" border-left-style="none" font-family="新宋体" font-size="6pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="right">
													<fo:block>
														...
														<fo:inline font-family="Arial" font-size="6pt">
															<xsl:text>CNBOX110311M</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
											...
											<fo:table-row width="100%">
												<fo:table-cell border="none" font-family="新宋体" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" display-align="center">
													<fo:block>
