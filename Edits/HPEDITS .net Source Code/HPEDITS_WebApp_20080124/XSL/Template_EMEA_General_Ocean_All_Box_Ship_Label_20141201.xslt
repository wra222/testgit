...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link map math sps xbrldi xbrli xlink xs xsi">
	...
	<xsl:param name="PACK_ID_max" select="'11'"/>
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" keep-with-next.within-page="always" keep-with-next.within-column="always" margin="0" padding="0" table-layout="fixed" width="100%">
										...
										<fo:table-body margin="0" padding="0" start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell number-columns-spanned="2" border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial" font-size="6pt" line-height="6pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													...
													<fo:table-cell number-rows-spanned="2" border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial Narrow" font-weight="bold" line-height="5pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="after">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:block-container border="none" height="10mm" margin="0" padding="0" width="10mm" overflow="hidden">
																	<fo:block-container absolute-position="absolute" height="10mm" left="0mm" margin="0" text-align="left" top="0mm" width="10mm" overflow="hidden" reference-orientation="-90">
																		<fo:block>
																			<fo:inline font-family="Arial Narrow" font-size="24pt" line-height="9pt" margin="0" padding="0">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell number-columns-spanned="2" border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" line-height="7pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Free 3 of 9 Extended" font-size="30pt">
																	<xsl:text>*</xsl:text>
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row margin="none" padding="none">
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="5.5pt" line-height="5pt" margin="none" padding="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
													...
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="5pt" line-height="5pt" margin="none" padding="none" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
