									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" line-height="4pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row line-height="4pt">
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="8" text-align="right" display-align="center">
													<fo:block>
											...
											<fo:table-row line-height="3pt">
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" height="8" text-align="left" display-align="center">
													<fo:block>
														<fo:inline line-height="3pt">
											...
											<fo:table-row font-family="Free 3 of 9 Extended" font-size="20pt" line-height="3pt" width="100%">
