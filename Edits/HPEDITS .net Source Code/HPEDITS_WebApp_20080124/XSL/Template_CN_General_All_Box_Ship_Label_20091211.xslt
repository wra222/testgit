							...
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" font-family="Arial" font-size="7pt" line-height="8pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" border-collapse="collapse" font-family="新宋体" font-size="8pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="before">
													<fo:block>
														<fo:inline font-family="新宋体" font-size="9pt" font-weight="bold">
															<xsl:text>收货方/运到 :</xsl:text>
														</fo:inline>
														<fo:inline font-family="Arial" font-size="9pt">
															<xsl:text>&#160;</xsl:text>
														</fo:inline>
														<fo:inline font-family="新宋体" font-size="9pt">
												...
												<fo:table-cell border="none" border-left="1pt" border-left-color="black" border-left-style="solid" font-family="新宋体" font-size="6pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-rows-spanned="2" padding="2pt">
													<fo:block>
														<fo:inline font-family="新宋体" font-size="9pt" font-weight="bold">
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" height="4pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="none" font-family="新宋体" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>SO# 销售合同号</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												...
												<fo:table-cell border="none" font-family="新宋体" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="5" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>PN# 产品货号</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
									...
									<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" height="4pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="新宋体" font-size="8pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Carrier 承运商</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="新宋体" font-size="8pt" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>AWB# 运输单号</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" font-family="Arial" font-size="8pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" height="10pt" line-height="10pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row font-family="Arial" font-size="10pt">
												<fo:table-cell border="none" font-family="新宋体" font-size="9pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Pack ID 包装编号</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											...
											<fo:table-row font-family="Arial" font-size="10pt">
												<fo:table-cell border="none" font-family="新宋体" font-size="9pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="before">
													<fo:block>
														<fo:inline>
															<xsl:text>Box ID 箱号</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											...
											<fo:table-row line-height="14pt">
												<fo:table-cell border="none" font-family="新宋体" font-size="11pt" font-weight="bold" display-align="after" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt">
													<fo:block>
														<xsl:if test="string-length(LABEL_INSTR_HEAD) &gt;0">
															<fo:inline>
																<xsl:text>End User: </xsl:text>
															</fo:inline>
															<fo:inline font-family="新宋体" font-size="12pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed">
											...
											<fo:table-row line-height="5pt">
												<fo:table-cell border="none" border-collapse="collapse" number-columns-spanned="2" padding="2pt" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
														...
														<fo:block margin-left="100% - 100%" margin="0pt">
															<fo:block>
																<fo:inline font-family="Arial" font-size="7pt">
																	<xsl:text> CGLABOX091211</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block>
													</fo:block>
											...
											<fo:table-row line-height="7pt">
												<fo:table-cell border="none" border-top="1pt" border-top-color="black" border-top-style="solid" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="after">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
