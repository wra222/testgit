									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" keep-with-next.within-page="always" keep-with-next.within-column="always" margin="0" padding="0" table-layout="fixed" width="100%">
										...
										<fo:table-body margin="0" padding="0" start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell number-columns-spanned="2" border="none" border-bottom-style="none" border-collapse="collapse" font-family="Consolas" font-size="6pt" line-height="6pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell number-columns-spanned="2" border="none" border-collapse="collapse" font-family="Consolas" font-size="8pt" line-height="7pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Free 3 of 9 Extended" font-size="30pt">
																	<xsl:text>*</xsl:text>
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell number-columns-spanned="4" border="none" border-bottom-style="none" border-collapse="collapse" line-height="8pt" margin="0" padding="0" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-family="Consolas" font-size="10pt" font-weight="bold">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row line-height="6pt">
													...
													<fo:table-cell border="none" font-family="Consolas" font-size="6pt" line-height="6pt" margin="0" padding="0" display-align="after">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Consolas" font-size="6pt" font-weight="bold">
												...
												<fo:table-row line-height="6pt">
													<fo:table-cell number-columns-spanned="2" border="none" font-family="Consolas" font-size="7pt" line-height="6pt" margin="0" padding="0" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Consolas" font-size="6pt" font-weight="bold" line-height="5pt">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row margin="none" padding="none">
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Consolas" font-size="6pt" line-height="5pt" margin="none" padding="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
													...
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Consolas" font-size="5pt" line-height="5pt" margin="none" padding="none" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
