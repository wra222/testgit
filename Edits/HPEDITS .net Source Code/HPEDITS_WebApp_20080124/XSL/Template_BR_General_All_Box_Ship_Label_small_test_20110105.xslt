							...
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" line-height="7pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row border-collapse="collapse" width="100%">
												...
												<fo:table-cell border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial" font-size="7pt" font-weight="normal" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="48" text-align="right" display-align="before">
													<fo:block>
														<fo:external-graphic>
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" number-rows-spanned="2" padding="2pt" height="48" text-align="center">
													<fo:block>
														...
														<fo:block/>
														<fo:inline>
															<xsl:text>CEP 13054-750 </xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline>
															<xsl:text>CNPJ: 61.797.924/0009-02 </xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline>
											...
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" number-rows-spanned="2" padding="2pt" height="6" display-align="before">
													<fo:block>
														<fo:inline>
											...
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="7pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" height="48" text-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-size="7pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="8pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" height="21" display-align="center">
													<fo:block>
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="4" text-align="left" display-align="center">
													<fo:block>
														<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row margin="none" padding="none">
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" line-height="11pt" margin="none" padding="none" number-columns-spanned="4" height="4" display-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
