						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-left-style="none" border-top-style="none" font-family="Arial" font-size="5pt" line-height="8pt" table-layout="fixed" width="100%">
										<fo:table-column column-width="10%"/>
										<fo:table-column column-width="30%"/>
										<fo:table-column column-width="30%"/>
										<fo:table-column column-width="30%"/>
										<fo:table-body font-size="5pt" start-indent="0pt">
											<fo:table-row border-collapse="collapse" font-size="5pt" width="100%">
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" height="4pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row>
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="5pt" font-weight="normal" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" display-align="before">
													<fo:block>
														<fo:inline font-family="Free 3 of 9 Extended" font-size="24pt">
															<xsl:text>*</xsl:text>
														</fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" line-height="8pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" line-height="3pt" number-columns-spanned="3" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
												...
												<fo:table-cell border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial" font-size="5pt" font-weight="bold" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="right" display-align="before">
													<fo:block>
														<fo:inline font-weight="bold">
															<xsl:text>NAOBOX130311</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
