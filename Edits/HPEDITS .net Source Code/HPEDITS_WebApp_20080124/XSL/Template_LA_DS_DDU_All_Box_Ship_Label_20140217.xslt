							...
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-size="7pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="8pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="0" height="18" display-align="center">
													<fo:block>
											...
											<fo:table-row line-height="8pt">
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="0" height="1" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="0" height="1" text-align="right" display-align="center">
													<fo:block>
											...
											<fo:table-row line-height="7pt">
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="0" height="1" text-align="left" display-align="center">
													<fo:block>
														<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row line-height="6pt" margin="none" padding="none">
												...
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="5pt" font-weight="bold" margin="none" padding="none" number-columns-spanned="5" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>LADSDDUBOX140217</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
