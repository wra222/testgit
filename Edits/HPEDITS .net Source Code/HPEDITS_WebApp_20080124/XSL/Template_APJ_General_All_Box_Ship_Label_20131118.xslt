								...
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row line-height="4pt">
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" height="3" text-align="left" display-align="center">
													<fo:block>
														<fo:inline font-weight="bold">
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="3" text-align="right" display-align="center">
													<fo:block>
														<fo:inline font-weight="bold">
