						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="PALLETS">
								<xsl:for-each select="PALLET">
									...
									<fo:table border="none" height="20pt" display-align="before" table-layout="fixed" width="100%" border-spacing="2pt">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row width="100%">
												...
												<fo:table-cell border="none" border-collapse="collapse" font-family="宋体" font-size="9pt" font-weight="bold" line-height="10pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt">
													<fo:block>
														<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" font-family="宋体" font-size="10pt" height="8pt" line-height="10pt" table-layout="fixed" width="100%">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row width="100%">
												<fo:table-cell border="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
													<fo:block>
														...
														<fo:inline>
															<xsl:text>SHIP TO 收货方/运到 : </xsl:text>
														</fo:inline>
														<fo:inline>
									...
									<fo:table border="none" font-family="宋体" font-size="10pt" height="10pt" line-height="10pt" table-layout="fixed" width="100%" border-spacing="2pt">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="40%"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row width="100%">
												<fo:table-cell border="none" border-collapse="collapse" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="before">
													<fo:block>
														<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" font-family="Arial" font-size="10pt" line-height="10pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row width="100%">
												<fo:table-cell border="none" font-family="宋体" font-size="10pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" font-size="10pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" font-size="14pt" line-height="14pt" table-layout="fixed" width="100%">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body start-indent="0pt">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="宋体" font-size="10pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Part Number 产品货号</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" font-size="10pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="宋体" font-size="10pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Air Waybill # 运输单号</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" font-size="10pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" line-height="14pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row border-top="1pt" border-top-color="black" border-top-style="solid" line-height="10pt">
												<fo:table-cell border="none" font-family="宋体" font-size="10pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
													<fo:block>
												...
												<fo:table-cell border="none" font-family="宋体" font-size="10pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline font-size="14pt">
															<xsl:text>Pallet ID 托盘号 </xsl:text>
														</fo:inline>
									...
									<fo:table border-bottom="1pt" border-bottom-color="black" border-bottom-style="solid" border-collapse="collapse" border-style="none" font-family="Arial" font-size="8pt" height="4pt" line-height="4pt" table-layout="fixed" width="100%" border="solid 1pt gray">
										<fo:table-column column-width="30%"/>
										<fo:table-column column-width="70%"/>
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row line-height="15pt" width="100%">
												<fo:table-cell border="none" padding="2pt" display-align="before">
													<fo:block>
														<fo:inline-container>
															<fo:block>
														...
														<fo:block height="7pt" line-height="7pt" margin="0pt">
															<fo:block>
																<fo:inline>
																	<xsl:text>&#160;</xsl:text>
																</fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" padding="2pt" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>CGLAPAA140609</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
