...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link map math sps xbrldi xbrli xlink xs xsi">
	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="3mm" margin-right="3mm" page-height="55mm" page-width="127mm" margin-top="0.0in" margin-bottom="0.0in">
				<fo:region-body margin-top="0cm" margin-bottom="-0.60cm" column-count="1"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="3mm" margin-right="3mm" page-height="55mm" page-width="127mm" margin-top="0.0in" margin-bottom="0.0in">
				<fo:region-body margin-top="0cm" margin-bottom="-0.60cm" column-count="1"/>
			</fo:simple-page-master>
						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
										...
										<fo:table-body margin="0" padding="0" start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													...
													<fo:table-cell border="none" border-bottom-style="none" border-collapse="collapse" line-height="7pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
													...
													<fo:table-cell number-rows-spanned="4" border="none" border-bottom-style="none" border-collapse="collapse" font-family="Consolas" font-size="5pt" line-height="6pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="after">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:block-container border="none" height="21mm" margin="0" padding="0" width="10mm" overflow="hidden">
																	<fo:block-container absolute-position="absolute" font-family="Arial Narrow" font-size="9pt" height="10mm" margin="0" text-align="center" width="21mm" overflow="hidden" reference-orientation="-90">
																		<fo:block>
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell number-columns-spanned="2" border="none" border-bottom-style="none" border-collapse="collapse" font-family="Consolas" font-size="5pt" line-height="6pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																...
																<fo:inline font-family="Consolas" font-size="6pt" font-weight="bold">
																	<xsl:value-of select="translate(substring( PACK_ID ,  1, $PACK_ID_max ),&quot;abcdefghijklmnopqrstuvwxyz&quot;,&quot;ABCDEFGHIJKLMNOPQRSTUVWXYZ&quot;)"/>
																</fo:inline>
																<fo:inline font-family="Consolas" font-size="6pt" font-weight="bold" line-height="8pt">
																	<xsl:text>&#160; </xsl:text>
																</fo:inline>
																...
																<xsl:for-each select="BOX_ID">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_3),'&#x200B;')">
																			<fo:block font-family="Consolas" font-size="8pt" font-weight="bold">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell number-columns-spanned="2" number-rows-spanned="3" border="none" border-bottom-style="none" border-collapse="collapse" line-height="8pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																...
																<fo:block/>
																<xsl:choose>
																	<xsl:when test="string-length( SHIP_TO_NAME_2 )+string-length( SHIP_TO_NAME_3 )&lt;41">
																		<fo:inline font-family="Consolas" font-size="10pt" font-weight="bold">
																			<xsl:value-of select="substring(  SHIP_TO_NAME_2  , 1 , $SHIP_TO_NAME_2_max )"/>
																		</fo:inline>
																		<fo:inline font-family="Consolas">
																			<xsl:text>&#160;</xsl:text>
																		</fo:inline>
																		<fo:inline font-family="Consolas" font-size="10pt" font-weight="bold">
																...
																<fo:block/>
																<xsl:choose>
																	<xsl:when test="(string-length( SHIP_TO_STREET )+string-length( SHIP_TO_STREET_2 ))&lt;41">
																		<fo:inline font-family="Consolas" font-size="10pt" font-weight="bold">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell border="none" border-collapse="collapse" font-family="Consolas" font-size="9pt" line-height="11pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="after">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell number-columns-spanned="2" border="none" border-collapse="collapse" font-family="Consolas" font-size="5pt" line-height="7pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Free 3 of 9 Extended" font-size="30pt">
																	<xsl:text>*</xsl:text>
												...
												<fo:table-row border-collapse="collapse" margin="0" padding="0" width="100%">
													<fo:table-cell number-columns-spanned="4" border="none" border-bottom-style="none" border-collapse="collapse" line-height="8pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-family="Consolas" font-size="10pt" font-weight="bold">
									...
									<fo:table border-collapse="collapse" keep-with-next.within-page="always" keep-with-next.within-column="always" margin="0" padding="0" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row line-height="6pt">
													<fo:table-cell number-rows-spanned="2" border="none" margin="0" padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-family="Free 3 of 9 Extended" font-size="30pt">
																	<xsl:text>*</xsl:text>
													...
													<fo:table-cell border="none" font-family="Consolas" font-size="8pt" line-height="8pt" margin="0" padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-family="Consolas" font-size="8pt" font-weight="bold">
																	<xsl:text>PACK ID: </xsl:text>
													...
													<fo:table-cell border="none" font-family="Consolas" font-size="6pt" line-height="6pt" margin="0" padding="0" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Consolas" font-size="6pt" font-weight="bold">
												...
												<fo:table-row line-height="6pt">
													<fo:table-cell number-columns-spanned="2" border="none" font-family="Consolas" font-size="6pt" line-height="6pt" margin="0" padding="0" display-align="after">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Consolas" font-size="6pt" font-weight="bold" line-height="5pt">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row line-height="8pt">
													<fo:table-cell number-rows-spanned="2" border="none" border-collapse="collapse" font-family="Consolas" font-size="6pt" line-height="6pt" margin="0" padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-family="Consolas" font-size="10pt" font-weight="bold">
																	<xsl:value-of select="substring(SUB_REGION , 1 , $SUB_REGION_max)"/>
													...
													<fo:table-cell border="none" border-collapse="collapse" margin="0" padding="0" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right"/>
														</fo:block-container>
													</fo:table-cell>
												...
												<fo:table-row line-height="8pt">
													<fo:table-cell border="none" border-collapse="collapse" font-family="Consolas" font-size="6pt" line-height="6pt" margin="0" padding="0" padding-top="3pt" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row margin="none" padding="none">
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Consolas" font-size="5pt" line-height="5pt" margin="0" padding="0" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
													...
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Consolas" font-size="5pt" line-height="4pt" margin="none" padding="none" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
																<fo:inline font-family="Consolas" font-size="5pt" font-weight="bold">
																	<xsl:text>EMEABOX150105</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
