						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="PALLETS">
								<xsl:for-each select="PALLET">
									...
									<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="10pt" line-height="10pt" table-layout="fixed" width="100%">
											...
											<fo:table-row border="none">
												...
												<fo:table-cell border="none" line-height="6pt" padding="2pt" height="1" text-align="left" display-align="center">
													<fo:block>
														...
														<fo:inline border="none" width="20%">
															<xsl:value-of select="substring( substring-before(concat(INTL_CARRIER,&quot;-OCP&quot;),&quot;-OCP&quot;) , 1 , $INTL_CARRIER_max )"/>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" line-height="6pt" number-columns-spanned="3" padding="2pt" height="1" text-align="left" display-align="center">
													<fo:block/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row border="none">
										...
										<fo:table-body border="none" start-indent="0pt">
											<fo:table-row border="none" line-height="10pt" width="100%">
												...
												<fo:table-cell border="none" font-family="Arial" font-size="4pt" line-height="3pt" padding="2pt" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline border="none">
															<xsl:text>GCAGLAPAOA140630</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
