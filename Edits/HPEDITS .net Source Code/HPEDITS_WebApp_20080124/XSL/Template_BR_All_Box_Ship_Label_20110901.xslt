...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="default-page" page-height="66mm" page-width="127mm" margin-left="0.2cm" margin-right="0.2cm">
						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-bottom="0.5pt" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" line-height="7pt" table-layout="fixed" width="100%">
										<fo:table-column column-width="11%"/>
										<fo:table-column column-width="39%"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body border-bottom="0.5pt" start-indent="0pt">
											<fo:table-row border-bottom="0.5pt" border-collapse="collapse" line-height="7pt" width="100%">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" line-height="6pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" number-rows-spanned="2" padding="2pt" height="1" text-align="center">
													<fo:block>
														<fo:inline font-size="5.5pt" line-height="6pt" display-align="before">
															<xsl:text>IMPORTADO E DISTRIBUIDO NO BRASIL POR:</xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline font-size="5.5pt" line-height="6pt" display-align="before">
															<xsl:text>Hewlett Packard Brasil Ltda.</xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline font-size="5.5pt" line-height="6pt" display-align="before">
															<xsl:text>Av.Jose Luis Mazzali,360 Galpão B&#160;&#160; </xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline font-size="5.5pt" line-height="6pt" display-align="before">
															<xsl:text>Parte 2 - Louveira, SP, Brasil.</xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline font-size="5.5pt" line-height="6pt" display-align="before">
															<xsl:text>CEP 13054-750, CNPJ: 61.797.924/0009-02 </xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline font-size="5.5pt" line-height="6pt" display-align="before">
															<xsl:text>Inscr estadual:&#160;&#160; 421.081.156.113</xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline font-size="5.5pt" line-height="6pt" display-align="before">
															<xsl:text>INS:MUNICIPAL:5881-0 </xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
											...
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="7pt" font-weight="bold" line-height="7.5pt" display-align="center" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" height="48" text-align="center">
													<fo:block>
														...
														<xsl:for-each select="BOX_ID">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																	<fo:block font-size="7pt" display-align="before">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:block>
																</xsl:when>
																<xsl:otherwise>
																	<fo:inline font-size="7pt" display-align="before">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:inline>
																</xsl:otherwise>
															</xsl:choose>
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-size="7pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" height="21" display-align="center">
													<fo:block>
														<fo:inline font-family="Free 3 of 9 Extended" font-size="24pt" display-align="before">
															<xsl:text>*</xsl:text>
														</fo:inline>
														<xsl:for-each select="CUST_PO">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																	<fo:block font-family="Free 3 of 9 Extended" font-size="24pt" display-align="before">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:block>
																</xsl:when>
																<xsl:otherwise>
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="4" display-align="center">
													<fo:block>
														<fo:inline line-height="5.5pt">
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="4" text-align="right" display-align="center">
													<fo:block>
														<fo:inline line-height="5.5pt">
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="4" display-align="center">
													<fo:block>
														<fo:inline font-size="7pt" line-height="5.5pt">
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" line-height="4pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="4" text-align="left" display-align="center">
													<fo:block>
														<fo:inline line-height="5.5pt">
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" line-height="4pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="4" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row line-height="8pt" margin="none" padding="none">
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" line-height="4pt" margin="none" padding="none" height="4" display-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
														...
														<fo:block font-size="6pt" white-space="pre" white-space-collapse="false" margin="0pt">
															<fo:block>
																<xsl:for-each select="UDF_HEADER">
																	<xsl:if test="./KEY = &apos;ODM_TEXT1&apos; and string-length(./VALUE)&gt;0">
																		<fo:inline font-family="Arial" font-size="7pt" font-weight="bold" display-align="before">
												...
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" font-weight="bold" margin="none" padding="none" number-columns-spanned="4" height="4" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>LABRBOX110901</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
