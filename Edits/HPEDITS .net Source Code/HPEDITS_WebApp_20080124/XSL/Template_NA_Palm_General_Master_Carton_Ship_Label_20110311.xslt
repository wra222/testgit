...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:param name="KEY_DETAIL_BATT_max" select="'30'"/>
	<xsl:param name="KEY_DETAIL_RMN_max" select="'30'"/>
	<xsl:param name="KEY_DETAIL_SPN_max" select="'30'"/>
	<xsl:param name="KEY_DETAIL_SW_max" select="'30'"/>
	<xsl:param name="KEY_DETAIL_UPC_CODE_max" select="'30'"/>
	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="default-page" page-height="6in" page-width="4in" margin-left="0.2cm" margin-right="0.2cm">
							...
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" height="4pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="5" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
											...
											<fo:table-row>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" number-columns-spanned="3" padding="2pt" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" height="3pt" line-height="3pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												...
												<fo:table-cell border="none" line-height="7pt" number-columns-spanned="2" number-rows-spanned="4" padding="2pt" display-align="center">
													<fo:block>
									...
									<fo:table border="none" border-collapse="collapse" line-height="10pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
														...
														<fo:table border="none" border-collapse="collapse" border-left="none" border-right="none" border-top="none" font-family="Arial" font-size="7pt" line-height="3pt" table-layout="fixed" width="100%">
															...
															<fo:table-body start-indent="0pt">
																<fo:table-row>
																	...
																	<fo:table-cell border="none" border-collapse="collapse" number-columns-spanned="2" padding="2pt" display-align="after">
																		<fo:block>
																			<fo:inline>
											...
											<fo:table-row>
												<fo:table-cell border="none" border-top-color="black" border-top-style="solid" border-top-width="1pt" display-align="before" number-columns-spanned="2" padding="2pt" text-align="right">
													<fo:block>
														<fo:external-graphic>
												...
												<fo:table-cell border="none" border-top-color="black" border-top-style="solid" border-top-width="1pt" font-size="8pt" font-weight="bold" display-align="center" padding="2pt" text-align="left">
													<fo:block>
														<fo:inline>
															<xsl:text>TouchPad</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" border-top-color="black" border-top-style="solid" border-top-width="1pt" font-size="8pt" font-weight="bold" number-rows-spanned="3" padding="2pt" text-align="center" display-align="center">
													<fo:block>
														...
														<xsl:for-each select="SERIAL_NUM">
															...
															<fo:block font-family="Free 3 of 9 Extended" font-size="24pt" line-height="20pt" margin-left="(100% - 100%) div 2" margin-right="(100% - 100%) div 2" margin="0pt">
																<fo:block>
																	<fo:inline>
																		<xsl:text>*</xsl:text>
																	</fo:inline>
															...
															<fo:block line-height="8pt" margin="0pt">
																<fo:block>
																	<xsl:variable name="value-of-template">
																		<xsl:apply-templates/>
																	</xsl:variable>
											...
											<fo:table-row>
												<fo:table-cell border="none" border-top-style="none" display-align="before" number-columns-spanned="3" padding="2pt" text-align="center">
													<fo:block>
														<fo:block/>
														...
														<xsl:for-each select="UDF_DETAIL">
															<xsl:if test="./KEY = &apos;KEY_DETAIL_UPC_CODE&apos; and string-length(./VALUE)&gt;0">
																<fo:inline font-family="IDAutomationSUPCEANS" font-weight="normal">
																	<xsl:value-of select="substring( VALUE , 1 , $KEY_DETAIL_UPC_CODE_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:inline-container>
											...
											<fo:table-row>
												<fo:table-cell border="none" border-top-style="none" font-size="6pt" line-height="7pt" display-align="before" number-columns-spanned="2" padding="2pt" text-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Made in China&#160; </xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline>
														...
														<xsl:for-each select="UDF_DETAIL">
															<xsl:if test="./KEY = &apos;KEY_DETAIL_SPN&apos; and string-length(./VALUE)&gt;0">
																<fo:inline font-weight="normal">
																	<xsl:value-of select="substring( VALUE , 1 , $KEY_DETAIL_SPN_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:block/>
														<fo:inline>
															<xsl:text>BATT:</xsl:text>
														</fo:inline>
														<xsl:for-each select="UDF_DETAIL">
															<xsl:if test="./KEY = &apos;KEY_DETAIL_BATT&apos; and string-length(./VALUE)&gt;0">
																<fo:inline font-weight="normal">
																	<xsl:value-of select="substring( VALUE , 1 , $KEY_DETAIL_BATT_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:inline-container>
														...
														<fo:inline font-size="5pt" font-weight="normal">
															<xsl:text>NAMBOXL110311P</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" border-top-style="none" font-size="6pt" line-height="7pt" display-align="before" padding="2pt" text-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>RMN: </xsl:text>
														</fo:inline>
														<xsl:for-each select="UDF_DETAIL">
															<xsl:if test="./KEY = &apos;KEY_DETAIL_RMN&apos; and string-length(./VALUE)&gt;0">
																<fo:inline font-weight="normal">
																	<xsl:value-of select="substring( VALUE , 1 , $KEY_DETAIL_RMN_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:block/>
														...
														<xsl:for-each select="UDF_DETAIL">
															<xsl:if test="./KEY = &apos;KEY_DETAIL_SW&apos; and string-length(./VALUE)&gt;0">
																<fo:inline font-weight="normal">
																	<xsl:value-of select="substring( VALUE , 1 , $KEY_DETAIL_SW_max )"/>
																</fo:inline>
															</xsl:if>
														</xsl:for-each>
														<fo:block/>
														<fo:inline>
															<xsl:text>PI967</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row>
												<fo:table-cell border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" line-height="6pt" number-columns-spanned="4" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:block/>
														<fo:inline-container>
															<fo:block>
