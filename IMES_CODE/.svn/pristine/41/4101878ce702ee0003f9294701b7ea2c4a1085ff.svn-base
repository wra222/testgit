									...
									<xsl:for-each select="HOUSE_WAYBILL">
										...
										<xsl:for-each select="PROD_TYPE_NAME">
											<xsl:for-each select="PALLET">
												...
												<fo:block margin="0pt">
													<fo:block>
														<fo:inline font-family="Arial" font-size="10pt" line-height="4pt">
														...
														<xsl:for-each select="PALLET_ID">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																	<fo:block font-family="Arial" font-size="10pt" line-height="4pt">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:block>
																</xsl:when>
																<xsl:otherwise>
												...
												<xsl:for-each select="BOX">
													<xsl:for-each select="BOX_ID">
														...
														<xsl:choose>
															<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																<fo:block font-family="Arial" font-size="8pt" line-height="4pt">
																	<xsl:copy-of select="$value-of-template"/>
																</fo:block>
															</xsl:when>
															<xsl:otherwise>
																<fo:inline font-family="Arial" font-size="8pt" line-height="4pt">
																	<xsl:copy-of select="$value-of-template"/>
																</fo:inline>
															</xsl:otherwise>
														</xsl:choose>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>EMEARAILKZPK140312</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
