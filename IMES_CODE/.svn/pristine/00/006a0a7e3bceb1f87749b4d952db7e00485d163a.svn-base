...
namespace IMES.Station.Implementation
{
    public class _PCATestStation : MarshalByRefObject, IPCATestStation
    {
              ...
              //  Begin
               ...
               //  end
                ...
                if (Session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(testStation, "PCATest_CQ.xoml", "PCATest_CQ.rules", out wfName, out rlName);
        ...
        //6.25 jiali Add
                ...
                DefectStation = string.IsNullOrEmpty(DefectStation) ? testStation : DefectStation;
        ...
        public IList<string> InputMBSNoForLot(string pdLine, string testStation, string MB_SNo, string editor, string customerId, out string AllowPass, out string DefectStation)
        {
            ...
            try
            {
                ...
                if (Session == null)
                {
                    ...
                    wfArguments.Add("SessionType", TheType);
                    string wfName, rlName;
                    RouteManagementUtils.GetWorkflow(testStation, "PCATestforLot.xoml", "PCATestforLot.rules", out wfName, out rlName);
                    WorkflowInstance instance = WorkflowRuntimeManager.getInstance.CreateXomlFisWorkflow(wfName, rlName, wfArguments);
        ...
        /// <param name="DefectStation"></param>
        /// <returns></returns>
        public IList<string> InputMBSNoTrans(string pdLine, string testStation, string MB_SNo, string editor, string customerId, out string AllowPass, out string DefectStation)
        {
            logger.Debug("(PCATestStation)InputMBSNoTrans start, pdLine:" + pdLine + " testStation:" + testStation + " MB_SNo:" + MB_SNo + " editor:" + editor + " customerId:" + customerId);
            AllowPass = "";
            DefectStation = "";
            FisException ex;
            List<string> erpara = new List<string>();
            ...
            try
            {
                ...
                if (Session == null)
                {
                    ...
                    wfArguments.Add("SessionType", TheType);
                    string wfName, rlName;
                    RouteManagementUtils.GetWorkflow(testStation, "PCATestTrans.xoml", "PCATestTrans.rules", out wfName, out rlName);
                    WorkflowInstance instance = WorkflowRuntimeManager.getInstance.CreateXomlFisWorkflow(wfName, rlName, wfArguments);
            ...
            {
                logger.Debug("(PCATestStation)InputMBSNoTrans end, pdLine:" + pdLine + " testStation:" + testStation + " MB_SNo:" + MB_SNo + " editor:" + editor + " customerId:" + customerId);
            }
        }
        /// <summary>
        /// InputDefectCodeListTrans
        /// </summary>
        /// <param name="MB_SNo"></param>
        /// <param name="defectList"></param>
        public void InputDefectCodeListTrans(string MB_SNo, IList<string> defectList)
        {
            logger.Debug("(PCATestStation)InputDefectCodeListTrans start, MB_SNo:" + MB_SNo);
            ...
            {
                logger.Debug("(PCATestStation)InputDefectCodeListTrans end, MB_SNo:" + MB_SNo);
            }
        }
        //-----------------------------------------------------------------
