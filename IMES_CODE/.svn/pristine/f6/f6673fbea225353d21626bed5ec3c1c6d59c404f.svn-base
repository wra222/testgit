...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true"
    CodeFile="SessionInfo.aspx.cs" Inherits="CommonFunction_SessionInfo" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
            ...
            <tr>
                ...
                <td>
                    <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                        <ContentTemplate>
                            <input type="button" id="BtnQuery" onclick="Query()" style="width: 120px;" value="Execute sp_who2" />
                            <input type="button" id="btnExcel" onclick="ExportExcel()" style="width: 120px;" value="Export Excel" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Query() {
            ...
            SQLText = "Execute sp_who_sqltext 0"; 
...
//            var MsgInfoTODialog = row.cells[0].innerText.trim();//SPID

//            if (MsgInfoTODialog != '') {
//                var SQLText = "Execute sp_who_sqltext " + MsgInfoTODialog;
//                ExecSPWebService.GetSQLResult(editor, db, SQLText, OnQuerySucceed);
//            }
        }
        function ShowDialog() {
