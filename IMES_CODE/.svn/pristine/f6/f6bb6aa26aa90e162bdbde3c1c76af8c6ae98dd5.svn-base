...
* Description:UI for PAQC Output For Docking Page
...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PAQCOutputForDocking.aspx.cs" Inherits="Docking_PAQCOutput" Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        <Services>
            <asp:ServiceReference Path="~/Docking/Service/WebServicePAQCOutputForDocking.asmx" />
        </Services>
    </asp:ScriptManager>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function input(inputData) {
            ...
            if (inputData == "7777") {
                ...
                if (inputData.length == 10) {
                    ...
                    WebServicePAQCOutputForDocking.input(line, customerSN, editor, stationId, customer, inputSucc, inputFail);
                }
                else {
                    alert(msgInputSN);
                    //ShowInfo(msgInputSN);
        ...
        function save() {
            ...
            WebServicePAQCOutputForDocking.save(prodId, defectInTable, saveSucc, saveFail);
        }
        ...
        function OnCancel() {
            if (productID != "") {
                WebServicePAQCOutputForDocking.cancel(productID);
            }
        }
