 ...
 * Update: 临时增加站，可以刷入良品，原来已改为只能刷不良
 * Date        Name                  Reason 
 * ==========  ===================== =====================================
...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"  ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="PCAOQCOutputtmp.aspx.cs" Inherits="SA_PCAOQCOutput" %>
