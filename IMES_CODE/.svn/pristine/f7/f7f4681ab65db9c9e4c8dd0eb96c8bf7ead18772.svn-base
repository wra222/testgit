...
namespace IMES.SAP.Implementation.SAPMOChangeStatusWS {
    ...
    public interface Z_SET_PRODORD_TO_IMES_TECO_WS {
        ...
        IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECOResponse Z_SET_PRODORD_TO_IMES_TECO(IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECORequest request);
    }
    ...
    public partial class Z_SET_PRODORD_TO_IMES_TECORequest {
        ...
        public IMES.SAP.Implementation.SAPMOChangeStatusWS.ZMO_MES_TECO_I INPUT;
        
        public Z_SET_PRODORD_TO_IMES_TECORequest() {
        }
        
        public Z_SET_PRODORD_TO_IMES_TECORequest(IMES.SAP.Implementation.SAPMOChangeStatusWS.ZMO_MES_TECO_I INPUT) {
            this.INPUT = INPUT;
        }
    }
    ...
    public partial class Z_SET_PRODORD_TO_IMES_TECOResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="urn:sap-com:document:sap:rfc:functions", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public IMES.SAP.Implementation.SAPMOChangeStatusWS.ZMO_MES_TECO_E OUTPUT;
        
        public Z_SET_PRODORD_TO_IMES_TECOResponse() {
        }
        
        public Z_SET_PRODORD_TO_IMES_TECOResponse(IMES.SAP.Implementation.SAPMOChangeStatusWS.ZMO_MES_TECO_E OUTPUT) {
            this.OUTPUT = OUTPUT;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface Z_SET_PRODORD_TO_IMES_TECO_WSChannel : IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECO_WS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class Z_SET_PRODORD_TO_IMES_TECO_WSClient : System.ServiceModel.ClientBase<IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECO_WS>, IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECO_WS {
        ...
        IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECOResponse IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECO_WS.Z_SET_PRODORD_TO_IMES_TECO(IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECORequest request) {
            return base.Channel.Z_SET_PRODORD_TO_IMES_TECO(request);
        }
        
        public IMES.SAP.Implementation.SAPMOChangeStatusWS.ZMO_MES_TECO_E Z_SET_PRODORD_TO_IMES_TECO(IMES.SAP.Implementation.SAPMOChangeStatusWS.ZMO_MES_TECO_I INPUT) {
            IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECORequest inValue = new IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECORequest();
            inValue.INPUT = INPUT;
            IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECOResponse retVal = ((IMES.SAP.Implementation.SAPMOChangeStatusWS.Z_SET_PRODORD_TO_IMES_TECO_WS)(this)).Z_SET_PRODORD_TO_IMES_TECO(inValue);
