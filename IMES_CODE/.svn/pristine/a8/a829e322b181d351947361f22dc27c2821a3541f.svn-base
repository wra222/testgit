<%@ Page Title="PLTReadinessReport" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="PLT3.aspx.cs" Inherits="Query_PAK_PLT3" EnableEventValidation="false" %>
...
<center>
 <fieldset id="grpCarton" style="border: thin solid #000000;">
    <legend align ="left" style ="height :20px" >
       <asp:Label ID="lblTitle" runat="server" Text="PLTQuery" 
         ...
         <table border="0" width="100%" style="font-family: Tahoma">                    
            ...
            <tr>
               <td class="style1">
                   <asp:Label ID="lblDate" runat="server" Text="ShipDate:" CssClass="iMes_label_13pt"></asp:Label>
               </td>
               <td>
                    <asp:Label ID="lblFrom" runat="server" Text="" CssClass="iMes_label_13pt"></asp:Label>                   
    ...
    <asp:UpdatePanel runat="server">
       ...
       <iMES:GridViewExt ID="gvResult" runat="server" AutoGenerateColumns="true" GvExtHeight="450px" 
            Width="150%" GvExtWidth="98%" Height="1px" ShowFooter="True">            
        </iMES:GridViewExt>        
        </ContentTemplate>
        <Triggers>
