    ...
    public partial class BlockStation : BaseActivity
    {
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            try
            {
                switch (ProcessType)
                {
                    ...
                    case ProcessTypeEnum.Product:
                        ...
                        if (currentProduct.Status != null && string.IsNullOrEmpty(currentProduct.Status.ReworkCode))
                        {
                            ...
                            //For future Hold add check futureHold setting, if future hold then throw error
                            ActivityCommonImpl.Instance.FutureHold.CheckAndSetFutureHold(null,
                                                                                                               CurrentSession,
                                                                                                              currentProduct,
                                                                                                              firstLine,
                                                                                                              this.Line,
                        ...
                        sn = currentProduct.ProId;
                        preStation = currentProduct.Status.StationId;
                        break;
                    default:
                        break;
                }
                ...
                checkForceNWC(ProcessType, sn, this.Station, preStation);
            }
