...
using System.IO;
public partial class Query_PAK_NonPaletProductQuery : IMESQueryBasePage
{
    ...
    IPAK_NonPaletProductQuery PAK_NonPaletProductQuery = ServiceAgent.getInstance().GetObjectByName<IPAK_NonPaletProductQuery>(WebConstant.PAK_NonPaletProductQuery);
   ...
   private void BindGrv()
   {
         ...
         //DateTime ShipDate = DateTime.Parse(txtShipDate.Text.Trim());
          ...
          foreach (ListItem item in lboxPdLine.Items)
           ...
           DataTable dt = PAK_NonPaletProductQuery.GetQueryResult(Connection, Line);
   ...
   private void EnableBtnExcelandMail( bool enable)
   {
    ...
    {
        gvResult.HeaderRow.Cells[0].Width = Unit.Pixel(40);
        gvResult.HeaderRow.Cells[1].Width = Unit.Pixel(100);
        gvResult.HeaderRow.Cells[2].Width = Unit.Pixel(120);
        gvResult.HeaderRow.Cells[3].Width = Unit.Pixel(120);
        gvResult.HeaderRow.Cells[4].Width = Unit.Pixel(120);
        gvResult.HeaderRow.Cells[5].Width = Unit.Pixel(120);
        gvResult.HeaderRow.Cells[6].Width = Unit.Pixel(120);
        gvResult.HeaderRow.Cells[7].Width = Unit.Pixel(50);
        gvResult.HeaderRow.Cells[8].Width = Unit.Pixel(140);
        gvResult.HeaderRow.Cells[9].Width = Unit.Pixel(50);		
    ...
    protected void gvResult_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            DateTime d;
            if (DateTime.TryParse(e.Row.Cells[4].Text, out d))
            {
                e.Row.Cells[4].Text = d.ToString("yyyy/MM/dd");
            }
            if (DateTime.TryParse(e.Row.Cells[8].Text, out d))
            {
                e.Row.Cells[8].Text = d.ToString("yyyy/MM/dd HH:mm");
            }
