...
<%@ WebService Language="C#" Class="WebServicePCAOQCOutputForDocking" %>
...
public class WebServicePCAOQCOutputForDocking : System.Web.Services.WebService
{

    IPCAOQCOutput iPCAOQCOutput = ServiceAgent.getInstance().GetObjectByName<IPCAOQCOutput>(WebConstant.PCAOQCOutputObjectDocking);
