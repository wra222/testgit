...
<%        
    try
    {
        string[] GvQueryColumnName = { "LESSON", "TimeRange", "D_N" ,"Station", "[A]", "[B]", "[C]", "[D]", "[E]", "[F]", "[G]", "[H]", "[J]", "[K]", "[L]", "[M]", "[R]" };
        int[] GvQueryColumnNameWidth = { 50, 200, 50 ,100, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50 };
