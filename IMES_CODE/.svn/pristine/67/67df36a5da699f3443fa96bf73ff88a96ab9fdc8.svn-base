<%@ Page Title="ProductDistribute" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="PAQCSortingQuery.aspx.cs" Inherits="Query_PAK_PAQCSortingQuery" EnableEventValidation="false" %>
...
<center>
 <fieldset id="grpCarton" style="border: thin solid #000000;">
    <legend align ="left" style ="height :20px" >
       <asp:Label ID="lblTitle" runat="server" Text="PCBNoQuery" 
         ...
         <table border="0" width="100%" style="font-family: Tahoma">                    
            ...
            <tr>
               <td class="style1">
                    <asp:Label ID="lblCUSTSN" runat="server" Text="CUSTSN：" 
                        CssClass="iMes_label_13pt"></asp:Label>                    
               </td>
               <td>
                   <asp:TextBox ID="txtCUSTSN" runat="server" Width="300px"></asp:TextBox>
               </td>            
               <td>
                    &nbsp;</td>
               <td class="style2">
