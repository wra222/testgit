...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ROMEOBattery.aspx.cs" Inherits="PAK_ROMEOBattery" Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        <Services>
            <asp:ServiceReference Path="~/PAK/Service/WebServiceROMEOBattery.asmx" />
        </Services>
    </asp:ScriptManager>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function inputCustomSN(inputData) {
            ...
            WebServiceROMEOBattery.inputSN(line, customerSN, editor, stationId, customer, onCustSNSucc, onCustSNFail);
        ...
        function checkPart(data) {
            ...
            WebServiceROMEOBattery.checkPart(productID, data, onCheckSuccess, onCheckFail);
        }
        ...
        function onCheckSuccess(result) {
            ...
            if (bFinished == true) {
                ...
                beginWaitingCoverDiv();
                WebServiceROMEOBattery.Save(productID, onSaveSucceed, onSaveFail);
                inputFlag = false;
            }
            callNextInput();
        }
        ...
        function OnCancel() {
            if (productID != "") {
                WebServiceROMEOBattery.cancel(productID);
            }
        }
