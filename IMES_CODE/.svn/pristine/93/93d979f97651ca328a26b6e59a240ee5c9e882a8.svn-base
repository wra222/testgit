...
namespace IMES.Activity
{
    ...
    /// <para>
    /// 应用场景：
    ///         应用于055FRUCartonLabelPrint.xoml,061FRUCartonLabelPrint.xoml
    /// </para>
    /// <para>
    /// 实现逻辑：
    ///         1.获取FRU Carton Number最大值;
    ///         2.产生指定机型的FRU Carton Number;
    ///         3.更新FRU Carton Number最大值;
    ///</para> 
    /// <para> 
    /// 异常类型：
    ///         1.系统异常：
    ...
    /// </para> 
    /// </remarks>
    public partial class AcquireFRUCartonSection : BaseAcquireActivity
	{
        private static object _syncRoot_GetSeq = new object();

        public AcquireFRUCartonSection()
		{
			InitializeComponent();
		}
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            //this.AddTemplatesOfAType("FRUCarton", new IConverter[] {new CommonConverter(1,'0',Session.SessionKeys.C), 
            ...
            CurrentSession.AddValue(Session.SessionKeys.C, "C");
            ...
            CurrentSession.AddValue(Session.SessionKeys.FRUCartonNoList, this.GetAllNumbersInRange(snrs, seqCvt, qty, preSeqStr));
        ...
        {
            return GeneratesConstants.FRUCarton;
        }
