<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Order_Test_Shipment.aspx.cs"
    Inherits="Order_Test" Title="=== TestOrder ===" %>
...
<body>
    <form id="form1" runat="server">
        <table style="width: 676px; height: 414px">
            ...
            <tr>
                <td style="width: 377px; height: 79px;">
                    <h4>
                        InternalID</h4>
                    <asp:TextBox ID="BOX_DN" runat="server" OnTextChanged="BOX_DN_TextChanged"></asp:TextBox><asp:Button
                        ID="Button_Qry" runat="server" OnClick="Button_Qry_Click" Text="Query" />
                </td>
                <td valign="top" style="height: 79px; width: 422px; text-align: center;">
                    ...
                    <asp:Label ID="LabelTestID" runat="server" Enabled="False" Height="20px" Text="ID"
            ...
            <tr>
                <td valign="top" style="width: 377px; height: 204px">
                    <asp:GridView ID="SNVIEW" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        BackColor="LightGreen" DataSourceID="SqlDataSource_SN" ShowFooter="True" OnSelectedIndexChanged="SNVIEW_SelectedIndexChanged"
                        Font-Size="Medium" style="margin-right: 29px" Width="357px">
                        <Columns>
                            ...
                            <asp:BoundField DataField="BOX_ID" HeaderText="BOX_ID" SortExpression="BOX_ID" />
                        </Columns>
                        <SelectedRowStyle BorderColor="#FFE0C0" />
                    </asp:GridView>
                </td>
                <td valign="top" style="width: 422px; height: 204px; text-align: center;">
                    <asp:GridView ID="DOCVIEW" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource_DOC"
            ...
            <tr>
                <td style="width: 2000px; height: 53px; vertical-align: sub;">
                    <h6 style="text-align: center">
                        Copyright 2008-07-16 Inventec Corporation</h6>
                    <h6 style="vertical-align: middle; text-align: center">
                        英业达集团</h6>
                </td>
            </tr>
        </table>
        <asp:SqlDataSource ID="SqlDataSource_SN" runat="server" ConnectionString="<%$ ConnectionStrings:HP_EDITSConnStr %>"
            ...
            SelectCommand="SELECT distinct  [PALLET_ID],[SERIAL_NUM],[BOX_ID] FROM [PAK_PackkingData] WHERE ([InternalID] = @InternalID) ORDER BY [PALLET_ID],[BOX_ID]">
            <SelectParameters>
                <asp:ControlParameter ControlID="BOX_DN" Name="InternalID" PropertyName="Text" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
