...
namespace IMES.Activity
{
    ...
    public partial class GetBOM : BaseActivity
    {
        ...
        private IFlatBOM GetSessionBOM()
        {
            ...
            //Vincent 2014-07-20 for PartForbidRule
             return sessionBOM = bomRepository.GetModelFlatBOMByStationModelAndPartForbid(this.Customer, this.Station, this.Line, family, model, mainObj, this.Key);
