...
public partial class Query_PAK_COAStatusReport : IMESQueryBasePage
{
    ...
    private void InitGridView(string type)
    {
        ...
        else if (type == "COADate" || type == "COATR_T")   //COADate欄位名:IECPN/Qty/Status/Line/COAStatus
        {
        ...
        else if (type == "COARemind") //COARemind欄位名:COA Sno/CPQSNO/Status/Line/Cdt/OverDue 
        {
            gvResult.HeaderRow.Cells[0].Width = Unit.Pixel(i);
            gvResult.HeaderRow.Cells[1].Width = Unit.Pixel(j);
            gvResult.HeaderRow.Cells[2].Width = Unit.Pixel(j);
                ...
                if (ddlCOARemind.SelectedValue != "4")
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i <= dt.Rows.Count - 1; i++)
                        {
                            ...
                            gvResult.Rows[i].Cells[5].Text = dt.Rows[i]["OverDue"].ToString();
                        }
                        InitGridView(SelType);
                        EnableBtnExcel(this, true, btnExport.ClientID);
                    }
                ...
                else //超過5天結合未出貨
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i <= dt.Rows.Count - 1; i++)
                        {
                            ...
                            gvResult.Rows[i].Cells[4].Text = dt.Rows[i]["Status"].ToString();
                            gvResult.Rows[i].Cells[5].Text = dt.Rows[i]["CombineDate"].ToString();
                            gvResult.Rows[i].Cells[6].Text = dt.Rows[i]["DeliveryNo"].ToString();
                            gvResult.Rows[i].Cells[7].Text = dt.Rows[i]["Model"].ToString();
                            gvResult.Rows[i].Cells[8].Text = dt.Rows[i]["PGIFlag"].ToString();
                        }
                        InitGridView(SelType);
                        EnableBtnExcel(this, true, btnExport.ClientID);
                    }
