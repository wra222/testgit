...
<%@ Page Language="C#" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="LCMRepairLogAddEdit.aspx.cs" Inherits="FA_LCMRepairLogAddEdit" Title="iMES - LCM Repair Log" %>
...
<body style=" position: relative; width: 100%; text-align:center"> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" >
        <Services>
            <asp:ServiceReference Path="Service/LCMRepairService.asmx" />
        </Services>
    </asp:ScriptManager>
    ...
    <script language="javascript" type="text/javascript">
        ...
        */
        ...
        function addOkClick()
        {
            if (editInputCheck())
            {
                LCMRepairService.add(parentWindow.globalID, getDefect(parentWindow.status), addOkSuccess, addOkFail);
            }        
        }
        ...
        function addAddClick()
        {
            if (editInputCheck())
            {
                LCMRepairService.add(parentWindow.globalID, getDefect(parentWindow.status), addAddSuccess, addOkFail);
            }         
        }
        ...
        function editOkClick()
        {
            if (editInputCheck())
            {
                LCMRepairService.update(parentWindow.globalID, getDefect(parentWindow.status), editSuccess, editFail);
            }
        }
