			...
			<fo:block>
				...
				<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" font-style="normal" font-variant="normal" font-weight="normal" padding="0pt" table-layout="fixed" width="100%">
					...
					<fo:table-body start-indent="0pt">
						...
						<fo:table-row>
							<fo:table-cell border="none" line-height="8pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt">
								<fo:block>
									<fo:block/>
									<xsl:for-each select="$XML">
										<xsl:for-each select="PACK_ID">
									...
									<fo:block/>
									<fo:inline>
										<xsl:text>MENARA BANK DANAMON LT 23-26 JL. </xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline>
										<xsl:text>PROF.DR.SATRIO.KAV EIV/6 MEGA KUNINGAN </xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline>
										<xsl:text>JAKARTA 12950 INDONESIA</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>IDOPKT120802</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
