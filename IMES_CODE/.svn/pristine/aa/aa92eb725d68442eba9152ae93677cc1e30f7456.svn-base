...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PalletWeight_CQ.aspx.cs" Inherits="PAK_PalletWeight_CQ" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
                ...
                <tr>
                    ...
                    <td style="width: 50%">
                        <iMES:GridViewExt ID="gd" runat="server" AutoGenerateColumns="true" GvExtWidth="100%"
                            GvExtHeight="128px" Style="top: 0px; left: 0px; width: 98%;" Height="120px"
    ...
    <div id="div4">
        <table style="width: 100%">
            ...
            <tr>
                <td style="width: 20%">
                    <asp:Label ID="lblManual" runat="server" CssClass="iMes_label_11pt" Visible="false"></asp:Label>
                </td>
                <td  style="width: 60%">
                    <asp:TextBox ID="txtManual" runat="server" CssClass="iMes_textbox_input_Normal" Width="99%" onkeypress='OnKeyPress(this)' Visible="false"/>
                </td>
                <td style="width: 20%">
                    <asp:Label ID="lblKG" runat="server" CssClass="iMes_label_11pt" Visible="false"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 20%">
         ...
         <table style="width: 100%">
            <tr>             
                <td align="right" style="width: 20%" >
                    ...
                    <button id="btnReprint" runat="server" onclick="clkReprint()" class="iMes_button" width ="200px"
                        onmouseover="this.className='iMes_button_onmouseover'" onmouseout="this.className='iMes_button_onmouseout'"/>
                </td>
            </tr>
        </table>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var msgInput='<%=this.GetLocalResourceObject(languagePre + "msgInputSN").ToString() %>'; 
...
//            }
            ...
            if( (palletNo == "") )//&& !( inputData.substring(0,3) == "SCN" || inputData.substring(0,2) == "CN"))
            {
         ...
         function inputPallet(inputData)
         {
                ...
                ||(inputData.length == 12) || (inputData.length == 20))) 
            {
                ...
                //var line = "";
                //palletNo = "0085477195";
                PalletWeightWebService.InputPallet_CQ(inputData, actWeight,"","", editor, station, customer,onPalletReturn);        
            }
        }
     ...
     function inputCustomSN(inputData)
     {
          ...
          //  var type = getPalletTypeCmbValue();
            ...
            {   
                var customerSN = inputData.substring(inputData.length-10,inputData.length);   
                //customerSN ="30012444Q";
                beginWaitingCoverDiv();
                PalletWeightWebService.InputCustSN(customerSN, palletNo, type, onCustomReturn);
             }
    }
