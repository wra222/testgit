                    ...
                    if (tmp.internalID == ele.internalID)
                    {
                        ...
                        if (ele.p4 != "ZP")
                        {
                           ...
                           //     && (tmp.region == "SCA" || tmp.region == "SNA" || tmp.region == "SAF"))
                            bCarrier = new[] {"BNAF","DZNA","NPN9" }.Any(tmp.intl_carrier.Trim().Equals);
                            bShRegId = new[] { "SCA", "SNA", "SAF" }.Any(tmp.region.Trim().Equals);
                            bCqRegId = new[] { "QCA", "QNA", "QAF" }.Any(tmp.region.Trim().Equals);
