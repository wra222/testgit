...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class BindIECVersion : BaseActivity
	{
        /// <summary>
        /// 构造函数
        /// </summary>
		public BindIECVersion()
		{
			InitializeComponent();
		}
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            currentMB.IECVER = (string)CurrentSession.GetValue(Session.SessionKeys.IECVersion);
