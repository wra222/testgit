...
public partial class Query_PAK_PLT3: IMESQueryBasePage
{
   ...
   // IMES.Query.Interface.QueryIntf.IFamily Family = ServiceAgent.getInstance().GetObjectByName<IMES.Query.Interface.QueryIntf.IFamily>(WebConstant.IFamilyBObject);
    ...
    IPAK_PLT3 PAK_PLT3 = ServiceAgent.getInstance().GetObjectByName<IPAK_PLT3>(WebConstant.IPAK_PLT3);

    public string[] GvQueryColumnName = { };
    public int[] GvQueryColumnNameWidth = { };
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //int sum = 0;
            dt = PAK_PLT3.GetPLT3Report(DBConnection, DateTime.Parse(txtFromDate.Text));
