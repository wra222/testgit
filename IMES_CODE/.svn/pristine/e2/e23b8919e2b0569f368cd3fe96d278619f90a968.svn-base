<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SA_OUT_Boss.aspx.cs" Inherits="webroot_aspx_SA_OUT_Boss" %>
        ...
        function DrawEChartFAPieOut(ec) {
            ...
            pieoption = {
               ...
               calculable: true,
                ...
                WebServiceEchart.GetData_OutPut("SA", inputSucc, inputFail);
