...
public partial class PAK_CT13KeyPartsRequirementQuery : IMESBasePage
{
    ...
    public void uploadOver(object sender, System.EventArgs e)
    {
        try
        {
            ...
            ICT13KeyPartsRequirementQuery iKeyParts = ServiceAgent.getInstance().GetObjectByName<ICT13KeyPartsRequirementQuery>(WebConstant.CT13KeyPartsRequirementQueryObject);
    ...
    private void bindTable(DataTable dt, string models)
    {
        ...
        DataRow leftdr = null;
        leftdt.Columns.Add(this.GetLocalResourceObject(Pre + "_colType").ToString());
    ...
    {
        gdleft.HeaderRow.Cells[0].Width = Unit.Pixel(200);
        gdleft.HeaderRow.Cells[1].Width = Unit.Pixel(50);
