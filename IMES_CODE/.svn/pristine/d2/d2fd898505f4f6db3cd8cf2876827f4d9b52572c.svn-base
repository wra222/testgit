...
namespace IMES.Station.Implementation
{
    ...
    public class IECLabelPrint : MarshalByRefObject, IIECLabelPrint
    {
       ...
       // #region IIECLabelPrint Members
        ...
        ArrayList IIECLabelPrint.Print(string dataCode, string config, string rev, string qty, string line, string editor, string station, string customer, List<PrintItem> printItems)
        {
            ...
            try
            {
                ...
                if (currentSession == null)
                {
                    ...
                    {
                        num = Convert.ToInt32(qty.ToString());
                    }
        ...
        public ArrayList ReprintLabel(string vendorCT, string reason, string line, string editor, string station, string customer, IList<PrintItem> printItems)
        {
            ...
            try
            {
                ...
                string config = session.GetValue("Config") as string;
