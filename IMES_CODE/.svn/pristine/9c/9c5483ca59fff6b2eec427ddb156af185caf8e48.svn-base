...
namespace IMES.Infrastructure.Extend
{
    ...
    public class ExtendSession //:IMES.Infrastructure.Session
    {
          ...
          {             
              ...
              //PCB Test Log 
              public static string TestLogJoinId = "TestLogJoinId";
              ...
              //MB CustSN
              public static string MBCustSNList = "MBCustSNList";
              public static string DeviceType="DeviceType";

              //QCStatus
              public static string QCType = "QCType";
              public static string QCFlag = "QCFlag";
              public static string IsQCDevice = "IsQCDevice"; //Y or N
              public static string IsQCCheckIMG = "IsQCCheckIMG"; //Y or N
              public static string AllowQCStatusList = "AllowQCStatusList"; //IList<string>
              public static string QCSamplingDefineList = "QCSamplingDefineList"; //IList<QCDefine>
              public static string QCAssignDefineList = "QCAssignDefineList"; //IList<QCDefine>
              public static string QCTypeRatioList = "QCTypeRatioList "; //IList<QCTypeRatio>
              public static string QCStation = "QCStation"; //String

              //CheckItem & FlatBomItem
              public static string NeedMoveOut = "NeedMoveOut"; // Y/N
              public static string ActualCartonNetWeight = "ActualCartonNetWeight";
              public static string ActualCartonQty = "ActualCartonQty";

              //UPS
              public static string UPSJPGFiles = "UPSJPGFiles";//~分隔file

              public static string AstPo="AstPo";

              //SmallBoardSN
              public static string SmallBoardSNList = "SmallBoardSNList";//IList<string> SmallBoardSN,ChildMBSN
              public static string SmallBoardMBList = "SmallBoardMBList";//IList<IMB>
              public static string SmallBoardPartNoList = "SmallBoardPartNoList";//IList<string>
              public static string SmallBoardECRList = "SmallBoardECRList";//IList<string>

              //SMT Collect CPU SN
              public static string CPUSnList = "CPUSnList"; //IList<string>


              //TxnLog Session
              public static string TxnId ="TxnId"; //string
              public static string TxnRawData = "TxnRawData"; //TxnRawData
              public static string TxnKeyValue1 = "TxnKeyValue1";
              public static string TxnKeyValue2 = "TxnKeyValue2";
              public static string TxnErrorCode = "TxnErrorCode";
              public static string TxnErrorDescr = "TxnErrorDescr";
