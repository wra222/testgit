...
namespace IMES.Station.Interface.StationIntf
{
    public interface IKBCTCheck
    {
        ...
        /// <param name="stationId">stationId</param>
        /// <param name="customerId">customerId</param>
        void CheckProdIdOffline(string prodid, string pdLine, string editor, string stationId, string customerId);
        ...
        /// <param name="stationId">stationId</param>
        /// <param name="customerId">customerId</param>
        string CheckAndSaveOffline(string prodid, string kbct, string pdLine, string editor, string stationId, string customerId);
        ...
        void SaveDefect(string prodid, string defect);
