<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="QuerySnByPalletNo.aspx.cs" Inherits="Query_PAK_QuerySnByPalletNo"  %>
...
<center>
 <fieldset id="grpCarton" style="border: thin solid #000000;">
    <legend align ="left" style ="height :20px" >
       <asp:Label ID="lblTitle" runat="server" Text="Query SN by Pallet No" 
         ...
         <table border="0" width="100%" style="font-family: Tahoma;">                    
            <tr>
                ...
                <td width ="35%" align="left" >
                    ...
                    <asp:Label ID="lblModel" runat="server" Text="Pallet No:" CssClass="iMes_label_13pt" ></asp:Label>
