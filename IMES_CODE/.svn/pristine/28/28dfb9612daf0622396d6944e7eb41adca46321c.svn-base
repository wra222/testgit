...
public partial class CleanRoom_ReprintTouchGlass : System.Web.UI.Page
{
    ...
    public static ArrayList RePrint(string ct, string reason, string editor, string station, string customer, IList<PrintItem> printItemLst)
    {
        try
        {
              ITouchGlassCheckTime touchglass = ServiceAgent.getInstance().GetObjectByName<ITouchGlassCheckTime>(WebConstant.TouchGlassChecktime);
            ArrayList arr =  touchglass.RePrint(ct, reason, printItemLst, editor, station, customer);
            return arr;
        }
