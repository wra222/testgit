...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" Runat="Server">
	    ...
	    <TD align="left" colspan="5">
	     <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                 ...
                 <input type="radio" name="month" id="nextMonth" runat="server" disabled /><asp:Label ID="lbNextMonth" runat="server" CssClass="iMes_label_11pt"></asp:Label>
                </ContentTemplate>   
                 <Triggers>
    ...
    <TR>
	    ...
	    <TD colspan="4">
			...
			<input type="radio" name="label" id="tabletLabel" runat="server" /><asp:Label ID="lblTabletLabel" runat="server" CssClass="iMes_label_11pt"></asp:Label>
	    </TD>
	    <TD  align="right">
    ...
    try {
        ...
        if (!errorFlag) {
            ...
            if (document.getElementById("<%=largeLabel.ClientID%>").checked) {
                labelType = "MB Label";
            } else if (document.getElementById("<%=smallLabel.ClientID%>").checked) {
                labelType = "MB Label-1";
            } else {
                labelType = "Tablet MB Label";
            }
