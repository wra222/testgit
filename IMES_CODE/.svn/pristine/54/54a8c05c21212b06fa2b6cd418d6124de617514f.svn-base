...
namespace IMES.Station.Implementation
{
    ...
    public class VirtualMo : MarshalByRefObject, IVirtualMo, IModel
    {
        ...
        {
            logger.Debug("(VirtualMo)CreateNewVirtualMo start, model:" + model + "qty:" + qty + " editor:" + editor + " stationId:" + stationId + " customerId:" + customerId);
            ...
            try
            {
                ...
                if (Session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(stationId, "102VirtualMo.xoml", null, out wfName, out rlName);
            ...
            {
                logger.Debug("(VirtualMo)CreateNewVirtualMo end, model:" + model + "qty:" + qty + " editor:" + editor + " stationId:" + stationId + " customerId:" + customerId);
            }
        }
