...
--%>
<%@ WebService Language="C#" Class="WebServiceTravelCard" %>
...
public class WebServiceTravelCard : System.Web.Services.WebService
{
    ...
    [WebMethod]
    public ArrayList WSCheckModel(string family, string model)
    {
        ArrayList retLst = new ArrayList();
