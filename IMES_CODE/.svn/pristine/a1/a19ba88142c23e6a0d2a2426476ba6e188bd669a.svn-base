<%@ Page Title="ProductDistribute" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="KeyPartDefectReport.aspx.cs" Inherits="Query_FA_KeyPartDefectReport" EnableEventValidation="false" %>
 ...
 <fieldset id="grpCarton" style="border: thin solid #000000;">
    ...
    <asp:UpdatePanel runat="server">
       ...
       <iMES:GridViewExt ID="gvResult" runat="server" AutoGenerateColumns="true" GvExtHeight="450px" 
            Width="200%" GvExtWidth="98%" Height="1px" ShowFooter="True">            
        </iMES:GridViewExt>        
        </ContentTemplate>
        <Triggers>
