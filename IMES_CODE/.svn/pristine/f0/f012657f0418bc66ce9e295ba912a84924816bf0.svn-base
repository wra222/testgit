<%@ Page Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="PCBOQCQuery.aspx.cs" Inherits="Query_SA_PCBOQCQuery" Title="Untitled Page" %>
        ...
        <fieldset style="border: solid #000000">
            ...
            <table border="0" width="100%" style="border-width:thin;">
                <tr>
                    ...
                    <td  width="10%">
                    <asp:Label ID="Label10" runat="server" Text="OK/NG:" CssClass="iMes_label_13pt"></asp:Label>                                      
                    </td>
                    <td  width="40%">
                        <asp:DropDownList ID="lboxStatus" runat="server" Width="30%">
            ...
            <tr>                                    
                ...
                <td width="40%">
                    <asp:DropDownList ID="IboxProcess" runat="server" Width="30%">
                        <asp:ListItem>SA OQC</asp:ListItem>
            ...
            <tr>
                ...
                <td> 
                    <asp:Label ID="Label9" runat="server" Text="MB Cause:" 
                        CssClass="iMes_label_13pt"></asp:Label>
                </td>
                <td  width="40%"> 
                 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                  <ContentTemplate>
                    <asp:ListBox ID="lboxcause" runat="server" SelectionMode="Multiple" 
                        Width="150px"  CssClass="CheckBoxList">
