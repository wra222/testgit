...
public partial class Query_PAK_QuerySnByPalletNo : IMESQueryBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //  dbName = Request["DBName"] != null ? Request["DBName"].ToString().Trim() : "HPIMES";
   ...
   private void BindGrv()
   {
      ...
      if (string.IsNullOrEmpty(txtModel.Text) && string.IsNullOrEmpty(hidModelList.Value))
      {
      ...
      string[] palletArr = hidModelList.Value.Split(new string[] { "," }, StringSplitOptions.RemoveEmptyEntries);
       string palletList =  string.Join(",", palletArr) ;
       if (!string.IsNullOrEmpty(txtModel.Text))
       {
           palletList = txtModel.Text.Trim();
     
       }

       DataTable dt = PAK_Common.GetSnByPalletNo(DBConnection, palletList);
