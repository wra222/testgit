...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"  ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="OfflineLabelPrint.aspx.cs" Inherits="Docking_OfflineLabelPrint"%>
...
<div>
    <asp:ScriptManager ID="ScriptManager1" runat="server" >
        <Services>
            <asp:ServiceReference Path="~/Docking/Service/WebServiceOfflineLabelPrint.asmx" />
        </Services>
    </asp:ScriptManager>
    <center>
    ...
    function print() 
    {
        ...
        else 
        {
            ...
            if (_lbParameter1.innerText != "") {
                _transfer_string += "set " + _lbParameter1.innerText + "=" + __tb1.value + "##";
            }
            if (_lbParameter2.innerText != "") {
                _transfer_string += "set " + _lbParameter2.innerText + "=" + __tb2.value + "##";
            }
            if (_lbParameter3.innerText != "") {
                _transfer_string += "set " + _lbParameter3.innerText + "=" + __tb3.value + "##";
            }
            if (_lbParameter4.innerText != "") {
                _transfer_string += "set " + _lbParameter4.innerText + "=" + __tb4.value + "##";
            }
            if (_lbParameter5.innerText != "") {
                _transfer_string += "set " + _lbParameter5.innerText + "=" + __tb5.value + "##";
            }
            if (_lbParameter6.innerText != "") {
                _transfer_string += "set " + _lbParameter6.innerText + "=" + __tb6.value + "##";
            }
            if (_lbParameter7.innerText != "") {
                _transfer_string += "set " + _lbParameter7.innerText + "=" + __tb7.value + "##";
            }
            if (_lbParameter8.innerText != "") {
                _transfer_string += "set " + _lbParameter8.innerText + "=" + __tb8.value + "##";
            }
