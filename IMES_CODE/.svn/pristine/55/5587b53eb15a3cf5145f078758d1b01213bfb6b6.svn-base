...
public partial class CommonControl_DataMaintain_CmbMaintainPdLine : System.Web.UI.UserControl
{
    private string cssClass;
    private string width;
    private IFAStation iFAStation;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            iFAStation = (IFAStation)ServiceAgent.getInstance().GetMaintainObjectByName<IFAStation>(WebConstant.MaintainFAStationObject);
    ...
    public void initMaintainPdLine()
    {
        if (iFAStation != null)
        {
            ...
            lstMaintainPdLine = iFAStation.GetLineList();
