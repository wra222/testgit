...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PizzaKittingCheck.aspx.cs" Inherits="PAK_PizzaKitting" Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
        ...
        <div id="div1">
            <table width="100%" border="0" style="table-layout: fixed;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label runat="server" ID="lblStationValue" Text="PKCK" CssClass="iMes_label_13pt"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <script language="javascript" type="text/javascript">
        ...
        window.onload = function() {
            ...
            setInputOrSpanValue(document.getElementById("<%=lblStationValue.ClientID %>"), checkStation);
        ...
        function inputCustomSN(inputData) {
            ...
            WebServicePizzaKitting.inputPizzaCheckSN(line, station, customerSN, editor, stationId, customer, onCustSNSucc, onCustSNFail);
