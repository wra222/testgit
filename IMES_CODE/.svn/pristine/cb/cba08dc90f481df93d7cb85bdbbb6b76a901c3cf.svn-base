								...
								<xsl:for-each select="BOX">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row border-collapse="collapse" width="100%">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="微软雅黑" font-size="8pt" font-weight="normal" line-height="8.5pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-rows-spanned="2" padding="2pt" text-align="center" display-align="center">
													<fo:block>
														...
														<fo:inline font-family="微软雅黑" font-size="8pt">
														...
														<xsl:if test="string-length(LABEL_INSTR_HEAD) &gt;0">
															...
															<fo:inline font-family="微软雅黑" font-size="8pt" font-weight="normal" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed">
											...
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" border-collapse="collapse" font-family="微软雅黑" font-size="8pt" font-weight="normal" line-height="9pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" display-align="before">
													<fo:block>
														<fo:inline font-family="微软雅黑" font-size="8pt" font-weight="bold">
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="center">
													<fo:block>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" text-align="right" display-align="center">
													<fo:block>
														<fo:inline font-family="Arial">
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" font-weight="bold" line-height="4pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline font-family="Arial">
											...
											<fo:table-row width="100%">
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" font-weight="bold" line-height="4pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" display-align="center">
													<fo:block>
