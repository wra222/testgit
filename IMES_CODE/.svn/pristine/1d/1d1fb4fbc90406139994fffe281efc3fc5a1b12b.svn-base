 ...
 * Description: PCAShippingLabelReprint
 * Update: 
 * Date         Name              Reason 
 * ==========   ================= =====================================
...
public partial class FA_PCAShippingLabelReprint : System.Web.UI.Page
{
    ...
    private void initLabel()
    {
        ...
        this.lblDataEntry.Text = this.GetLocalResourceObject(Pre + "_lblMBSn").ToString();
    }
}
