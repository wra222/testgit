...
public partial class Query_SA_CpuQuery : IMESQueryBasePage
{
    ...
    ISA_CpuQuery CpuQuery = ServiceAgent.getInstance().GetObjectByName<ISA_CpuQuery>(WebConstant.ISA_CpuQuery);
    //Type Stage LotNo SpecNo CPUCT SN Status Editor Cdt
    public string[] GvQueryColumnName = { "Type", "Stage", "LotNo", "SpecNo", "SN", "Status", "Editor", "Cdt" };
    public int[] GvQueryColumnNameWidth = { 150, 150, 150, 150, 150, 150, 150, 150 };
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string ID = txtLotNo.Text;
            //int sum = 0;
            dt = CpuQuery.GetCPU( Connection,  ID);
