...
namespace IMES.Station.Implementation
{
    ...
    public partial class ShipToCartonLabel : MarshalByRefObject, IShipToCartonLabel
    {
        ...
        /// <returns></returns>
        public ArrayList InputProcess(string data, int type, string sessionKey, IList<PrintItem> printItemLst, string pdLine, string station, string editor, string customer, out MRPLabelDef MRP)
        {
            logger.Debug("ShipToCartonLabel WF start, pdLine:" + pdLine + " ,editor:" + editor + " ,station:" + station + " ,customer:" + customer);
            string currentSessionKey = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                else
                {
                    ...
                    string delievery = currentDelivery.DeliveryNo;
        ...
        public ArrayList Reprint(string prodid, int type, string editor, string station, string customer, string reason, string pCode, IList<PrintItem> printItems, out MRPLabelDef MRP)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    delievery = currentDelivery.DeliveryNo;
