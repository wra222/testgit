...
namespace IMES.CheckItemModule.TRIS.Modem.Filter
{
    [Export(typeof(IFilterModule))]
    [ExportMetadata("ProgramName", "IMES.CheckItemModule.TRIS.Modem.Filter.dll")]
    public class Filter : IFilterModule, ITreeTraversal
    {
        private int _qty;
        private const string part_check_type = "TRIS-Modem";
        private const string partType = "MODEM";
