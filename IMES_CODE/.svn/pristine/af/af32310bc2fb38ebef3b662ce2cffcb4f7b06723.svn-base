...
public partial class CommonControl_cmbMBFamily : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                if (enabled)
                {
                    //IList<RctombmaintainInfo> retLst = null;
                    //initObject(out retLst);
                }
                else
                {
    ...
    public void initObject(out IList<RctombmaintainInfo> retLst)
    {
        ...
        {
            this.setSelected(1);
            retLst = mbmaintain.getMBMaintaininfo(this.drpMBFamily.SelectedValue);
        }
        else
        {
            retLst = null;
