														...
														<fo:block border="none" margin-left="100% - 100%" margin="0pt">
															<fo:block>
																<fo:inline border="none" font-family="Arial" font-size="7pt">
																	<xsl:text> AGINBOX110212</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block>
													</fo:block>
											...
											<xsl:when test="./UDF_DETAIL/KEY=&apos;KEY_DETAIL_INDIA_PRICE_ID&apos; and ./UDF_DETAIL/VALUE=&apos;MRP LABEL REQUIRED&apos; and BOX_UNIT_QTY= 1">
												...
												<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" font-weight="normal" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" table-layout="fixed" width="100%">
													...
													<fo:table-body border="none" line-height="8pt" start-indent="0pt">
														<fo:table-row border="none">
															<fo:table-cell border="none" font-family="Arial" font-size="7pt" font-weight="normal" line-height="7pt" display-align="after" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-rows-spanned="2" padding="2pt" text-align="left">
																<fo:block>
																	<fo:block/>
												...
												<fo:table border="none" table-layout="fixed" width="100%" border-spacing="2pt">
													...
													<fo:table-column column-width="41.5%"/>
													<fo:table-column column-width="23.5%"/>
													<fo:table-body border="none" start-indent="0pt">
														<fo:table-row border="none">
															<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" font-weight="bold" line-height="0.5pt" padding="none" display-align="before" number-columns-spanned="3" height="1">
																<fo:block/>
															</fo:table-cell>
														</fo:table-row>
														<fo:table-row border="none">
															<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" font-weight="bold" line-height="12pt" padding="none" display-align="before">
																<fo:block>
																	<fo:inline border="none">
														...
														<fo:table-row border="none">
															<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" font-weight="bold" line-height="16pt" padding="none" display-align="before">
																<fo:block>
														...
														<fo:table-row border="none">
															<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" font-weight="bold" padding="none" display-align="center" number-columns-spanned="3" height="3">
																<fo:block/>
															</fo:table-cell>
														</fo:table-row>
														<fo:table-row border="none">
															...
															<fo:table-cell border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial" font-size="8pt" font-weight="normal" padding="none" display-align="auto" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" text-align="left">
																<fo:block>
																	<xsl:for-each select="UDF_DETAIL">
														...
														<fo:table-row border="none">
															<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" font-weight="bold" padding="none" display-align="before" number-columns-spanned="3" height="5" text-align="left">
																<fo:block/>
															</fo:table-cell>
														</fo:table-row>
														<fo:table-row border="none">
															<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" font-weight="bold" padding="none" display-align="center" text-align="left">
																<fo:block>
																	<fo:inline border="none">
															...
															<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" font-weight="bold" padding="none" number-columns-spanned="2" text-align="left" display-align="before">
																<fo:block>
														...
														<fo:table-row border="none">
															<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" padding="none" display-align="after" number-columns-spanned="3" height="4">
																<fo:block/>
															</fo:table-cell>
														</fo:table-row>
														<fo:table-row border="none">
															<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" line-height="6pt" padding="none" display-align="after" number-columns-spanned="3">
																<fo:block>
													...
													<fo:block>
														...
														<fo:table border="none" font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
															...
															<fo:table-body border="none" start-indent="0pt">
																...
																<fo:table-row border="none">
																	<fo:table-cell border="none" font-family="Arial" font-size="7pt" number-columns-spanned="2" padding="2pt" text-align="left" display-align="center">
																		<fo:block>
																			<xsl:for-each select="HP_PN">
																				<xsl:variable name="value-of-template">
																					<xsl:apply-templates/>
