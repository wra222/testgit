...
public class WebServiceVirtualMO  : System.Web.Services.WebService {
    ...
    [WebMethod]
    public ArrayList create(string model, int qty, string pCode, string startDate, string editor, string stationId, string customer, string MOPrefix)
    {
        ...
        try
        {
            iVirtualMO.CreateNewVirtualMo(model, qty, pCode, startDate, editor, pdLine, stationId, customer, MOPrefix);
