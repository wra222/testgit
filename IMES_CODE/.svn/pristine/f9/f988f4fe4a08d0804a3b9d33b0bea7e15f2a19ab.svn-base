...
namespace IMES.Station.Interface.StationIntf
{
    ...
    public interface IPalletWeight
    {
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        String InputCustSN(string custSN, string palletNo, string type);
        ...
        /// <returns></returns>
        String CheckIMEI(string palletNo, string imei);
        ...
        ArrayList InputPallet_CQ(string inputID, decimal acturalWeight, string type,
                string line, string editor, string station, string customer);
