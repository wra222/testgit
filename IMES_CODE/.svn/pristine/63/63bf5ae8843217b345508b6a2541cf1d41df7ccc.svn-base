 ...
 * 2012-02-06   Chen Xu             Modify:ITC-1360-0253
 * Known issues:
 * TODO：
...
public partial class PAK_ReprintECRLabel : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                //ITC-1360-0253:对于没有站号的Station，按照Stage 取得Line 
    ...
    private void alertNoPdLine()
    {
        String script = "<script language='javascript'>" + "\r\n" +
            ...
            "</script>";
        ScriptManager.RegisterStartupScript(this.updatePanel, ClientScript.GetType(), "alertNoPdLine", script, false);
    }
