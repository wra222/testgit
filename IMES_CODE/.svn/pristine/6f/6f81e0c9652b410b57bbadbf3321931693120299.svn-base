...
public partial class FA_CheckCombineCT : IMESBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                this.cmbsubStation.Type = "FACombineCheck";
    ...
    private void cmbsubStation_Selected(object sender, System.EventArgs e)
    {
        ...
        this.cmbsubStation.refreshByPdline(this.cmbPdLine.InnerDropDownList.SelectedValue, "FACombineCheck");
    ...
    private DataTable getBomDataTable(string pdLine, string subStation, string prodId)
    {
        ...
        IList<BomItemInfo> list = iCheckCombineCT.InputProdIdorCustsn(pdLine, prodId, Master.userInfo.UserId, subStation, Master.userInfo.Customer, out realProdID, out strModel);
	...
	private void CallCommSendFail()
    {
        String script = "<script language='javascript'>" + "\r\n" +
            "CommSendFail();" + "\r\n" +
            "</script>";
        ScriptManager.RegisterStartupScript(this.updatePanelAll, ClientScript.GetType(), "CallCommSendFail", script, false);
    }
