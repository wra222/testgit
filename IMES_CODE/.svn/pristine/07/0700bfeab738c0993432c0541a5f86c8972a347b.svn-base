...
&nbsp; 
       <asp:Button ID="btnUpload" runat="server" onclick="btnUpload_Click" OnClientClick="return Check();" Text="上傳" />
     
    &nbsp; 
       <asp:Button ID="btnExcel" runat="server" onclick="btnExcel_Click" style=" display:none"      Text="Excel" />
     &nbsp;
    <asp:CheckBox ID="chkGrpByLine" runat="server" Checked="True" Text="線別分組" />
    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
