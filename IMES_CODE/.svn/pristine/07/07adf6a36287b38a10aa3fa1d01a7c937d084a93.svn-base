...
public partial class Query_SA_PCBTestReport : IMESQueryBasePage
{
    ...
    public string[] GvQueryColumnName = { "PCBNo", "MAC", "Type", "Status", "FixtureID", 
                                            "Station", "PdLine", "PCBModelID", "Descr", "Editor","Remark","Cdt" };
    public int[] GvQueryColumnNameWidth = { 55, 65, 25, 30, 40, 35, 30, 60, 80, 45, 74, 100 };
    ...
    public int[] GvDetailColumnNameWidth = { 50, 30, 30, 30, 30, 40, 50, 45, 25, 40, 80, 80 };
    string customer = "";
    String DBConnection = "";
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            dt = SA_PCBTestReport.GetPCBTestReportResult(DBConnection, DateTime.Parse(txtFromDate.Text), DateTime.Parse(txtToDate.Text),
                                lstFamily, lstTestItem, lstFixtureID);
