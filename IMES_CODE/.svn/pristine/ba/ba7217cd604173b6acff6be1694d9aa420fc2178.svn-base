...
public class WebServiceIECLabelPrint : System.Web.Services.WebService
{
    ...
    [WebMethod]
    public ArrayList print(string dateCode, string config, string rev, string ctqty, string qty, string line, string editor, string station, string customer, List<PrintItem> printItems)
    {
       ...
       //List<PrintItem> printList = new List<PrintItem>();
        try
        {
            ret = iIECLabelPrint.Print(dateCode, config, rev, ctqty, qty, line, editor, station, customer, printItems);
