...
public partial class CommonControl_CmbPreStationForMaintain : System.Web.UI.UserControl
{
    //combobox宽度
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (isPercentage)
            {
                ...
                {
                    DropDownList_PreStation.Width = Unit.Percentage(100);
                }
                else
                {
                    DropDownList_PreStation.Width = Unit.Percentage(Convert.ToDouble(length));
                }
            }
            else
            {
                DropDownList_PreStation.Width = Unit.Parse(length);
            }

            DropDownList_PreStation.CssClass = css;
            this.DropDownList_PreStation.Enabled = enabled;
            if (enabled)
            {
                initStation();
            }
            ...
            {
                this.DropDownList_PreStation.Items.Add(new ListItem("", ""));
            }
    ...
    public DropDownList InnerDropDownList
    {
        get
        {
            return this.DropDownList_PreStation;
        }
    ...
    public void clearContent()
    {
        ...
        //清空combobox内容
        this.DropDownList_PreStation.Items.Clear();
        DropDownList_PreStation.Items.Add(new ListItem("", ""));
        this.up.Update();
    ...
    protected void initStation()
    {
        ...
        if (iProcessManager != null)
        {
            ...
            if (lstStation != null)
            {
                ...
                {
                    DropDownList_PreStation.Items.Add(new ListItem(station.Station, station.Station));
                }
            }
    ...
    {
        this.DropDownList_PreStation.SelectedIndex = index;
        up.Update();
    }
