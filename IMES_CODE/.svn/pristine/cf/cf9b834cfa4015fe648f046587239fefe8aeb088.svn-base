<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UPH_FA_Month.aspx.cs" Inherits="webroot_aspx_UPH_FA_Month" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>FA每月生产效率排行榜</title>
  <style type="text/css">         
...
//                         y: 'bottom',
                ...
                WebServiceEchart.GetData_Month("FA",inputSucc, inputFail);
