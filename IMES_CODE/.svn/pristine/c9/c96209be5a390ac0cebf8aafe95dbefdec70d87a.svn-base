...
namespace IMES.CheckItemModule.TRIS.DDR.Filter
{
    [Export(typeof(IFilterModule))]
    [ExportMetadata("ProgramName", "IMES.CheckItemModule.TRIS.DDR.Filter.dll")]
    public class Filter : IFilterModule, ITreeTraversal
    {
        private int _qty;
        private const string part_check_type = "TRIS-DDR";
        private const string partType = "DDR";
