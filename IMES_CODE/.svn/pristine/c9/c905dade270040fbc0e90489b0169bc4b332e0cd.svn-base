...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class GetPalletModel : BaseActivity
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public GetPalletModel()
        {
            InitializeComponent();
        }
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            if ((dpList != null) && (!string.IsNullOrEmpty(dpList[0].DeliveryID)))
            {
                ...
                if (CurrentDelivery != null)
                {
                    ...
                    this.CurrentSession.AddValue(Session.SessionKeys.ModelName, CurrentDelivery.ModelName);
                }
                else
                {
                    List<string> errpara = new List<string>();
                    errpara.Add(dpList[0].DeliveryID);
