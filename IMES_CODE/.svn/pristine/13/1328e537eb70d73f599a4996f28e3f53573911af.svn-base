...
<fis:header2 id="header1" runat="server"/>
	...
	*/ 
	function showTable(rs)
	{
		...
		if (ShowItemTable == null)
		{
			...
			ShowItemTable.Widths = new Array(25, tableWidth1 * 0.5 - 25, 1, 1,1,1,tableWidth1 * 0.5);
			ShowItemTable.FieldsType = new Array(0, 0, 0, 0, 0, 0, 0);
			ShowItemTable.HideColumn = new Array(true, true, false, false, false, false, true);
...
<fis:footer2 id="footer1" runat="server"/>
