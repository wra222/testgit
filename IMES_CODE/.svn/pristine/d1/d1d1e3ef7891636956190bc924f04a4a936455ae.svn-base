...
namespace IMES.Query.Interface.QueryIntf
{
    ...
    {       
        ...
        DataTable GetProductHoldHistory(string Connection, string ID);
        ...
        DataTable GetUnpackProductPart(string Connection, string ID);
        DataTable GetUnpackPizzaPart(string Connection, string ID);
