						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-left-style="none" border-top-style="none" font-family="Arial" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
												...
												<fo:table-cell border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial" font-size="6pt" font-weight="bold" line-height="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="before">
													<fo:block>
														...
														<fo:inline font-size="6pt" font-weight="normal">
															<xsl:text>NACRCTOBOX110121M</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="7pt" font-weight="normal" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-rows-spanned="2" padding="2pt" display-align="before">
													<fo:block>
											...
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" border-bottom="1pt" border-bottom-color="black" border-bottom-style="solid" border-collapse="collapse" border-right="1pt" border-right-color="black" border-right-style="solid" border-top="1pt" border-top-color="black" border-top-style="solid" font-family="Arial" font-size="7pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="before">
													<fo:block>
														<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" height="4pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row font-family="Free 3 of 9 Extended" font-size="20pt" line-height="10pt" width="100%">
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" line-height="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" text-align="left" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" line-height="4pt" padding="2pt" text-align="right" display-align="center">
													<fo:block/>
												</fo:table-cell>
											</fo:table-row>
										</fo:table-body>
