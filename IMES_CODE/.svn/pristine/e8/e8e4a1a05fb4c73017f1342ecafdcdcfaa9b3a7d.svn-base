...
namespace IMES.Station.Interface.StationIntf
{
    ...
    public interface IIECLabelPrint
    {
        ...
        /// <returns></returns>
        ArrayList Print(string dataCode, string config, string rev, string ctqty, string qty, string line, string editor, string station, string customer, List<PrintItem> printItems);
