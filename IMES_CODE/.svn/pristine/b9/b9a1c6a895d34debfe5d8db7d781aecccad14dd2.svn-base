...
public partial class FA_TPDLCheckForRCTO : IMESBasePage
{
    ...
    private void initLabel()
    {
        ...
        this.lblLCMCT.Text = this.GetLocalResourceObject(Pre + "_lblLCMCT").ToString();
        this.lblTPDLCT.Text = this.GetLocalResourceObject(Pre + "_lblTPDLCT").ToString();
