...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class WriteProductInfo : BaseActivity
	{
        /// <summary>
        ///  InfoType
        /// </summary>
        public static DependencyProperty InfoTypeProperty = DependencyProperty.Register("InfoType", typeof(string), typeof(WriteProductInfo));
        ...
        /// </summary>
        public static DependencyProperty InfoValueSessionKeyProperty = DependencyProperty.Register("InfoValueSessionKey", typeof(string), typeof(WriteProductInfo));
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            string MBinfoValue = "";
            MBinfoValue = CurrentSession.GetValue(Session.SessionKeys.MBCT) as string;
            string dCode = "";
            dCode = CurrentSession.GetValue(Session.SessionKeys.DCode) as string;
            
            if (dCode != "")
            {
                currentProduct.SetExtendedProperty("DataCode", dCode, Editor);
            }

            if (MBinfoValue != "")
            {
                currentProduct.SetExtendedProperty("MBCT", MBinfoValue, Editor);
