					...
					<fo:block>
						<xsl:for-each select="$XML">
											...
											<fo:table-row background-color="#787878" color="white" text-align="center">
												...
												<fo:table-cell border="1pt" border-color="black" border-left-style="none" border-style="solid" padding="0" display-align="center">
													<fo:block>
														...
														<fo:block/>
														<fo:inline>
															<xsl:text>VERIZON PART NUMBER</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="1pt" border-color="black" border-left-style="none" border-style="solid" padding="0" display-align="center">
							...
							<fo:table border="none" border-collapse="collapse" border-style="none" font-family="Arial" font-size="8pt" font-style="normal" font-variant="normal" font-weight="normal" padding="0pt" display-align="before" table-layout="fixed" width="100%">
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										...
										<fo:table-cell border="none" padding="0pt" text-align="right" display-align="center">
											<fo:block>
												<fo:inline-container>
													<fo:block>
														<xsl:text>&#x2029;</xsl:text>
							...
							<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" padding="0pt" table-layout="fixed" width="100%">
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										<fo:table-cell border="none" number-columns-spanned="8" padding="2pt" display-align="center">
											<fo:block>
												<fo:inline-container>
													<fo:block>
														<xsl:text>&#x2029;</xsl:text>
									...
									<fo:table-row>
										<fo:table-cell border="none" border-collapse="collapse" display-align="before" padding="2pt">
											<fo:block>
												<fo:inline>
													<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; </xsl:text>
												</fo:inline>
										...
										<fo:table-cell border="none" border-collapse="collapse" display-align="before" padding="2pt" text-align="right">
											<fo:block>
												<fo:inline>
													<xsl:text>Pallet Breakdown:</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell border="none" border-collapse="collapse" display-align="before" padding="2pt" text-align="left">
											<fo:block>
												<xsl:for-each select="PACK_ID">
													<xsl:for-each select="UDF_HEADER">
														<xsl:if test="KEY = &apos;KEY_HEADER_PACKID_PLT_UNIT_QTY&apos; and  string-length(  VALUE  )  &gt; 0">
															<fo:inline-container>
																<fo:block>
																	<xsl:text>&#x2029;</xsl:text>
																</fo:block>
															...
															<fo:block margin="0pt">
																<fo:block>
																	<fo:inline>
																		<xsl:value-of select="substring(  VALUE  , 1 , 35 )"/>
																	</fo:inline>
																</fo:block>
															</fo:block>
														</xsl:if>
									...
									<fo:table-row>
										<fo:table-cell border="none" border-collapse="collapse" border-style="none" number-columns-spanned="8" padding="2pt" display-align="center">
											<fo:block/>
										</fo:table-cell>
					...
					<fo:table-body start-indent="0pt">
						...
						<fo:table-row>
							<fo:table-cell border="none" font-family="Arial" font-size="12pt" font-style="normal" font-variant="normal" font-weight="bold" line-height="10pt" display-align="center" padding="2pt" height="43" text-align="left">
								<fo:block>
									<fo:external-graphic content-width="40px">
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>NAVEPKT100201</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
