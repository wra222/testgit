...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class CheckLabelLanguagePrintForCQ : BaseActivity
	{
        /// <summary>
        /// constructor
        /// </summary>
        public CheckLabelLanguagePrintForCQ()
		{
			InitializeComponent();
		}
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            foreach (IBOMNode node in bomList)
            {
                ...
                if (site != "ICC" && (node.Part.PN == "6060B0464901" || node.Part.PN == "6060BCHINA01" || node.Part.PN == "6060BCHINA02"))
                {
                    checkChina =2;
                    if (node.Part.PN == "6060B0464901")
                    {
                ...
                else if (node.Part.PN == "6060B000KC01" || node.Part.PN == "6060B000KC02")
                {
                    language = "KC Label";
                    break;
                }
                else if (node.Part.PN == "6060B0487001" || node.Part.PN == "6060BTAIWAN1" || node.Part.PN=="6060BTAIWAN2")
                {
