...
public partial class PalletVerifyForRCTO : System.Web.UI.Page
{
    ...
    private DataTable getNullDataTable()
    {
        ...
        for (int i = 0; i < initRowsCount; i++)
        {
            ...
            newRow["DeliveryNo"] = String.Empty;
    ...
    private void initTableColumnHeader()
    {
       // this.GridViewExt1.Columns[0].HeaderText = this.GetLocalResourceObject(Pre + "_gridProd").ToString();
        this.GridViewExt1.Columns[0].HeaderText = this.GetLocalResourceObject(Pre + "_gridCarton").ToString();
        this.GridViewExt1.Columns[1].HeaderText = this.GetLocalResourceObject(Pre + "_gridDeliveryNo").ToString();
    }
     ...
     private void initLabel()
    {
        ...
        this.lblCartonLst.InnerText = this.GetLocalResourceObject(Pre + "_lblCartonLst").ToString();
