...
//			else if (cust.length == 11 && CheckCustomerSN(cust) ) {
//                customerSN = cust.substring(1, 11);
//            }
            if (CheckCustomerSN(cust)) {
                if (cust.length == 11) {
                    customerSN = cust.substring(1, 11);
                }
                else {
        ...
        function onPrintSucc(result) {
            ...
            var tmpList = new Array("China label", "Taiwan Label", "ICASA Label L", "GOST Lable",
                    "KC Label", "WWAN ID Label", "Wimax Label", "LA NOM Label", "Win8BoxLabel");
            var count = 0;
            var showList = "";
            ...
            var llabel = result[5];
            var win8label = result[6];
            var postellabel = result[7];
            ...
            try {
                if (result[0] == SUCCESSRET) {
                    ...
                    //WIN8
					//alert(result[1][7].TemplateName);
				   //	
                   //    if (win8label != "") {
                  //      setPrintItemListParam(result[1][7], "Win8BoxLabel");
                  //      printlist[count] = result[1][7];
                    //    count++;
                   // }
                   //WIN8
                   ...
                   // if (win8label != "") { showList = showList + ",WIN8 Label" }
