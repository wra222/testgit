...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="FACombineKeyPartsReprint.aspx.cs" Inherits="FA_FACombineKeyPartsReprint" %>
...
<div>
    <asp:ScriptManager ID="ScriptManager1" runat="server" >
        <Services>
            <asp:ServiceReference Path="~/FA/Service/WebServiceFACombineKeyParts.asmx" />
        </Services>
    </asp:ScriptManager>
    <center>
...
<script type="text/javascript">
            ...
            if (!errorFlag) {
                ...
                try {
                    ...
                    if (lstPrintItem == null)                 //判断 若PrintItem==null, 不继续打印，等待客户维护PrintSetting页面后，再刷入打印
                    {
                        ...
                        WebServiceFACombineKeyParts.RePrint(inpuProdid, reason, line, editor, station, customer, pCode, lstPrintItem, onSucceed, onFail);
                    }
                }
                catch (e1) {
    ...
    function setPrintItemListParam1(backPrintItemList, beginProid) //Modify By Benson at 2011/03/30
    {
