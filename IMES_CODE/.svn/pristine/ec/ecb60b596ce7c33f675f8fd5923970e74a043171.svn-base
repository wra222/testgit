...
{
    /// <summary>
    /// IPACosmeticDocking接口的实现类
    /// </summary>
    public class PACosmeticImplDocking : MarshalByRefObject, IPACosmeticDocking
    {
        ...
        public ArrayList InputCustSn(string pdLine, string prodID, string editor, string stationId, string customer)
        {
            ...
            try
            {
                ...
                if (session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(stationId, "PACosmeticForDocking.xoml", "PACosmeticForDocking.rules", out wfName, out rlName);
                ...
                DataModel.ProductStatusInfo status = productRep.GetProductStatusInfo(prodID);
