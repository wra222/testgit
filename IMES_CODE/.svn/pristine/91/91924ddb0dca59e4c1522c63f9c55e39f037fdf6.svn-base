...
public partial class Query_MPLineInput : IMESQueryBasePage
{
    ...
    {
        gvStationDetail.HeaderRow.Cells[0].Width = Unit.Pixel(40); //ID
        gvStationDetail.HeaderRow.Cells[1].Width = Unit.Pixel(100);//ProductID
        gvStationDetail.HeaderRow.Cells[2].Width = Unit.Pixel(100);//CUSTSN
        gvStationDetail.HeaderRow.Cells[3].Width = Unit.Pixel(100);//PCBID
        gvStationDetail.HeaderRow.Cells[4].Width = Unit.Pixel(100);//Family
        gvStationDetail.HeaderRow.Cells[5].Width = Unit.Pixel(120);//Model
        gvStationDetail.HeaderRow.Cells[6].Width = Unit.Pixel(80); //PalletNo
        gvStationDetail.HeaderRow.Cells[7].Width = Unit.Pixel(80); //ShipDate
        gvStationDetail.HeaderRow.Cells[8].Width = Unit.Pixel(60); //Station
        gvStationDetail.HeaderRow.Cells[9].Width = Unit.Pixel(60); //Status
        gvStationDetail.HeaderRow.Cells[10].Width = Unit.Pixel(200);//Descr
        gvStationDetail.HeaderRow.Cells[11].Width = Unit.Pixel(80); //InputLine
        gvStationDetail.HeaderRow.Cells[12].Width = Unit.Pixel(50); //Line
        gvStationDetail.HeaderRow.Cells[13].Width = Unit.Pixel(160);//Cdt
        gvStationDetail.HeaderRow.Cells[14].Width = Unit.Pixel(160);//Udt
    }
    ...
    public void btnQueryDetail_Click(object sender, System.EventArgs e)
    {
        try
        {
            ...
            DataTable dt = MPLineInput.GetSelectDetail(DBConnection, DateTime.Parse(txtFromDate.Text), DateTime.Parse(txtToDate.Text), lstPdLine, Family, lstModel, Line, Station, bool.Parse(hfLineShife.Value), ddlStation.SelectedValue);
