...
namespace IMES.Station.Interface.StationIntf
{
    ...
    public interface ILabelLightGuide
    {
        ...
        /// <param name="CheckEPIA">CheckEPIA</param>
        void Save(string sesKey, out string CheckEPIA);
        ...
        IList<string> GetLightNumFroAOI(string tool_id, string user_id, string SN, string LabelCode, string WC, string Line, string Timestamp);
