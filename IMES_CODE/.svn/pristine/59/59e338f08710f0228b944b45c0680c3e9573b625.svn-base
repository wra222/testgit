<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UPH_SA_Daily.aspx.cs" Inherits="webroot_aspx_UPH_SA_Daily" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SA每日生产效率排行榜</title>
  <style type="text/css">         
...
<body leftMargin="0" topMargin="0" rightMargin="1">
 <form id="form1" runat="server"  >
    ...
    <div id="main"   style="height:100%;width:100%;  " onmousemove="zoom("main",2)"></div>
    <!-- ECharts单文件引入 -->
        ...
        require(
            [
             ...
             function DrawEChart(ec) {
                    ...
                    // backgroundColor: 'rgb(16, 16, 16)',
                     ...
                     text: 'SA产出（PCS/H）',
                         ...
                         subtextStyle: { //color: '#DDD', 
                                      fontSize: 10, fontWeight: 'bolder'}//副标题
                ...
                WebServiceEchart.GetData_Daily("SA",inputSucc, inputFail);
