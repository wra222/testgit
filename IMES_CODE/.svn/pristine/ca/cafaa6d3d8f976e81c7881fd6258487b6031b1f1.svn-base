<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CmbMaintainMasterLabelFamily2.ascx.cs" Inherits="CommonControl_DataMaintain_CmbMaintainMasterLabelFamily2" %>
