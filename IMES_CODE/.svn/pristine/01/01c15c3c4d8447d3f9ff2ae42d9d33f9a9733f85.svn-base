...
{
    public interface  IBOMNodeData
    {
        #region for new ModelBOM table
        /// <summary>
        /// 添加ModelBOM
        /// </summary>
        ...
        /// <summary>
        /// 复制一个Model/Part & ModelInfo/PartInfo
        /// </summary>
        /// <param name="code"></param>
        /// <param name="newCode"></param>
        /// <param name="editor"></param>
        /// <param name="isNeedCheck"></param>
        /// <returns></returns>
        string SaveAs(string code, string newCode, string editor, Boolean isNeedCheck);

        string SaveAsDummy(string code, string editor, string customer, Boolean isNeedCheck);
        ...
        IList<string> FindBOMNodeRelationParentsByRoot(string TYPE, string ChildType);

        IList<string> FindBOMNodeRelationTypes(string TYPE);
        ...
        bool ChekkMatchingBOMRelation(string ParentPartNo, string ChildPartNo, ref string ParentType, ref string ChildType);
