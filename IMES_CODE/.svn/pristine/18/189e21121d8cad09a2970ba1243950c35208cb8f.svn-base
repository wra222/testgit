...
namespace UPS.CDSI.UPSWS {
    ...
    public interface ATRPSoap {
        ...
        UPS.CDSI.UPSWS.ATRPStruct UPSGetTags(string SN, string Location);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://hp.com/UPSGetRange", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        UPS.CDSI.UPSWS.ATRPStruct UPSGetRange(string PartNumber, string AssetNumber, string HPPO);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://hp.com/UPSGetImages", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        UPS.CDSI.UPSWS.ATRPStruct UPSGetImages(string SN, string Location);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://hp.com/UPSGetATRP", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        UPS.CDSI.UPSWS.ATRPStruct UPSGetATRP(string SN, string Location);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://hp.com/UPSGetBTWFile", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        UPS.CDSI.UPSWS.ATRPStruct UPSGetBTWFile(string PartNumber);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://hp.com/UPSResetSN", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        UPS.CDSI.UPSWS.ResetStruct UPSResetSN(string SN);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://hp.com/UPSUpdateSN", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        UPS.CDSI.UPSWS.ResetStruct UPSUpdateSN(string SN, string newSN);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://hp.com/UPSUpdateHPPO", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        UPS.CDSI.UPSWS.ResetStruct UPSUpdateHPPO(string SN, string PartNumber, string AssetNumber, string HPPO, string newHPPO);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://hp.com/UPSUpdatePrintInfo", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        UPS.CDSI.UPSWS.ATMStruct UPSUpdatePrintInfo(string SN, string PartNumber, string AssetNumber, string HPPO, string MAC, string MAC2, string SystemID, string Placement, string TagInfo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://hp.com/UPSGetATM", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        UPS.CDSI.UPSWS.ATMStruct UPSGetATM(string SN, string PartNumber, string AssetNumber, string HPPO, string AssetTagNumber);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://hp.com/UPSGetUSI", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute()]
        UPS.CDSI.UPSWS.USIStruct UPSGetUSI(string SN, string HPPO, string PartNumber, string FGPartNum);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface ATRPSoapChannel : UPS.CDSI.UPSWS.ATRPSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class ATRPSoapClient : System.ServiceModel.ClientBase<UPS.CDSI.UPSWS.ATRPSoap>, UPS.CDSI.UPSWS.ATRPSoap {
        ...
        public UPS.CDSI.UPSWS.ATRPStruct UPSGetTags(string SN, string Location) {
            return base.Channel.UPSGetTags(SN, Location);
        }
        
        public UPS.CDSI.UPSWS.ATRPStruct UPSGetRange(string PartNumber, string AssetNumber, string HPPO) {
            return base.Channel.UPSGetRange(PartNumber, AssetNumber, HPPO);
        }
        
        public UPS.CDSI.UPSWS.ATRPStruct UPSGetImages(string SN, string Location) {
            return base.Channel.UPSGetImages(SN, Location);
        }
        
        public UPS.CDSI.UPSWS.ATRPStruct UPSGetATRP(string SN, string Location) {
            return base.Channel.UPSGetATRP(SN, Location);
        }
        
        public UPS.CDSI.UPSWS.ATRPStruct UPSGetBTWFile(string PartNumber) {
            return base.Channel.UPSGetBTWFile(PartNumber);
        }
        
        public UPS.CDSI.UPSWS.ResetStruct UPSResetSN(string SN) {
            return base.Channel.UPSResetSN(SN);
        }
        
        public UPS.CDSI.UPSWS.ResetStruct UPSUpdateSN(string SN, string newSN) {
            return base.Channel.UPSUpdateSN(SN, newSN);
        }
        
        public UPS.CDSI.UPSWS.ResetStruct UPSUpdateHPPO(string SN, string PartNumber, string AssetNumber, string HPPO, string newHPPO) {
            return base.Channel.UPSUpdateHPPO(SN, PartNumber, AssetNumber, HPPO, newHPPO);
        }
        
        public UPS.CDSI.UPSWS.ATMStruct UPSUpdatePrintInfo(string SN, string PartNumber, string AssetNumber, string HPPO, string MAC, string MAC2, string SystemID, string Placement, string TagInfo) {
            return base.Channel.UPSUpdatePrintInfo(SN, PartNumber, AssetNumber, HPPO, MAC, MAC2, SystemID, Placement, TagInfo);
        }
        
        public UPS.CDSI.UPSWS.ATMStruct UPSGetATM(string SN, string PartNumber, string AssetNumber, string HPPO, string AssetTagNumber) {
            return base.Channel.UPSGetATM(SN, PartNumber, AssetNumber, HPPO, AssetTagNumber);
        }
        
        public UPS.CDSI.UPSWS.USIStruct UPSGetUSI(string SN, string HPPO, string PartNumber, string FGPartNum) {
