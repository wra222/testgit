...
namespace com.inventec.iMESWEB
{
    public partial class WebConstant
    {
        ...
        public const string MPInputEx = "IMESQueryService.IFA_MPInputEx";
		public const string SQEReport = "IMESQueryService.IFA_SQEReport";
        ...
        public const string IFA_ProductPlanInputQuery_CR = "IMESQueryService.IFA_ProductPlanInputQuery_CR";
        ...
        //add by Viclin
        public const string ISA_SAReceiveReturnMBQuery = "IMESQueryService.ISA_SAReceiveReturnMBQuery";
        public const string PAK_NonPaletProductQuery = "IMESQueryService.IPAK_NonPaletProductQuery";
        public const string IPAK_NoneShipProductQuery = "IMESQueryService.IPAK_NoneShipProductQuery";

        public const string IPAKMRPLabelQuery = "IMESQueryService.IPAK_MrpQuery";
        public const string MPLineInput = "IMESQueryService.IFA_MPLineInput";
        public const string IFA_LocQuery = "IMESQueryService.IFA_LocQuery";

        //add by dyh
        public const string CheatSheet = "IMESQueryService.ICheatSheet";
        public const string IFA_rpt_sqeweeklyreport = "IMESQueryService.IFA_rpt_sqeweeklyreport";
        public const string ISA_OQCQuery = "IMESQueryService.ISA_OQCQuery";
        public const string ISMT_TestDataReport = "IMESQueryService.ISMT_TestDataReport";
        public const string ICT_TAT_Query = "IMESQueryService.ICT_TAT_Query";
        public const string ISA_SMTDashboard = "IMESQueryService.ISA_SMTDashboard";
        public const string IUploadFile = "IMESQueryService.IUploadFile";
        public const string IFA_WaittingRejudge = "IMESQueryService.IFA_WaittingRejudge";
        public const string IFA_ECOModelQuery = "IMESQueryService.ECOModelQuery";
        public const string IFA_ReworkQuery = "IMESQueryService.IFA_ReworkQuery";
        public const string IFA_TouchGlassTimeQuery = "IMESQueryService.IFA_TouchGlassTimeQuery";
        public const string ISARepairWIP_Dashboard = "IMESQueryService.ISARepairWIP_Dashboard";
        public const string ISARepairDashboard = "IMESQueryService.ISARepairDashboard";
