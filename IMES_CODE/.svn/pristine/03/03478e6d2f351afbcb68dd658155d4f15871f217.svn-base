...
<body style=" position: relative; width: 100%"> 
        ...
        <div id="div1" class="iMes_div_center">
            <table width="100%" style="table-layout:fixed;">
                ...
                <tr>
                    ...
                    <td><input type="text" id="txtSite" runat="server" maxlength="10" class="iMes_input_White" style="width: 80%;" /></td>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function editInputCheck() {
            ...
            var site = document.getElementById("<%=txtSite.ClientID %>").value.toUpperCase();
            if (site != "") {
