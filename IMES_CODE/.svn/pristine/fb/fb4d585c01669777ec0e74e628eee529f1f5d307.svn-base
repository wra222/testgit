<%@ Page Title="PrdIdOnLine" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="PrdIdOnLine.aspx.cs" Inherits="Query_FA_PrdIdOnLine"  EnableEventValidation="false"%>
...
<center>
 <fieldset id="grpCarton" style="border: thin solid #000000;">
    <legend align ="left" style ="height :20px" >
       <asp:Label ID="lblTitle" runat="server" Text="PrdId OnLine" CssClass="iMes_label_13pt"></asp:Label></legend> 
         <table border="0" width="100%" style="font-family: Tahoma">                    
            ...
            <tr>
               ...
               <td width ="40%">
                   <asp:TextBox ID="txtPno" runat="server" Width="300px" Visible="false"/>
                    <iMES:CmbPdLine ID="CmbPdLine" runat="server"   Width="300px" Visible="false"/> 
            ...
            <tr>                     
               ...
               <td width ="10%">
                    <asp:Label ID="lblPno" runat="server" Text="Model:" CssClass="iMes_label_13pt"></asp:Label>
               </td>
               <td width ="40%">                
                    <asp:ListBox ID="lboxModel" runat="server" SelectionMode="Multiple" Width="150px"  Visible="false"/>
