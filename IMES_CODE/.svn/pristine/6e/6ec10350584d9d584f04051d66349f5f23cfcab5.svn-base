...
namespace IMES.Station.Implementation
{
    ...
    ///
    /// </summary>
    public class CTBorrowControl : MarshalByRefObject, IBorrowControl
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public string InputKey(string key, string editor, string line, string station, string customer)
        {
            ...
            try
            {
                ...
                if (currentSession == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(station, "CTBorrowControl.xoml", "CTBorrowControl.rules", out wfName, out rlName);
        ...
        public void Save(string key, string borrowerOrReturner, string action)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    currentSession.AddValue(Session.SessionKeys.ModelName, "KP");
