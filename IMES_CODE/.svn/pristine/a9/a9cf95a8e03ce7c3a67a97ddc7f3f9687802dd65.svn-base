...
namespace IMES.Activity.Special
{
    ...
    /// </para> 
    /// </remarks>
    public partial class DocTypeList : BaseActivity
	{
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Get Product Object and Put it into Session.SessionKeys.DOCType
        /// </summary>
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            IList<string> doc_type = PAK_PAKComnRepository.GetDocTypeByDOCCAT();
            if (null == doc_type || doc_type.Count == 0)
            {
                FisException ex;
            ...
            CurrentSession.AddValue(Session.SessionKeys.DOCType, doc_type);
