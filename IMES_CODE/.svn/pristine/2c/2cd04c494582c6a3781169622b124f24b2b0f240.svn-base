					...
					<fo:block-container overflow="hidden" display-align="before">
						<fo:block>
							...
							<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" font-style="normal" font-variant="normal" font-weight="normal" padding="0pt" table-layout="fixed" width="100%">
								...
								<fo:table-column column-width="2.594in"/>
								<fo:table-column column-width="1.615in"/>
								<fo:table-column column-width="3.010in"/>
								<fo:table-column column-width="2.563in"/>
								...
								<fo:table-body start-indent="0pt">
									<xsl:variable name="altova:tablerows">
										...
										<fo:table-row>
											...
											<fo:table-cell number-columns-spanned="3" border="none" font-family="Arial" font-size="12pt" font-style="normal" font-variant="normal" font-weight="bold" padding="2pt" display-align="center">
												<fo:block-container overflow="hidden">
										...
										<fo:table-row height="0.01in">
											<fo:table-cell number-columns-spanned="2" border="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="before">
												<fo:block-container overflow="hidden">
													<fo:block text-align="left">
														<fo:inline>
										...
										<fo:table-row height="0.01in">
											<fo:table-cell number-columns-spanned="2" border="none" padding="2pt" display-align="center">
												<fo:block-container overflow="hidden">
													<fo:block text-align="left">
							...
							<xsl:for-each select="MASTER_WAYBILLS">
								<xsl:for-each select="MASTER_WAYBILL">
									...
									<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" padding="0pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row background-color="#787878" color="white" height="0.01in">
													<fo:table-cell border="none" padding="2pt" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="center">
																<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" padding="0pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row font-weight="bold" height="0.27in">
													<fo:table-cell border="none" padding="2pt" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left"/>
														</fo:block-container>
								...
								<fo:table-body start-indent="0pt">
									<xsl:variable name="altova:tablerows">
										<fo:table-row>
											...
											<fo:table-cell border="none" line-height="10pt" padding="2pt" display-align="before">
												<fo:block-container overflow="hidden">
													<fo:block text-align="left">
														<fo:inline>
