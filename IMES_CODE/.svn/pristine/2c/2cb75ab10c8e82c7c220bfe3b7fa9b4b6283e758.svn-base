...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReprintCombineCartonandDNfor146_CommonParts.aspx.cs" Inherits="PAK_ReprintCombineCartonandDNfor146_CommonParts" Title="Untitled Page" %>
...
<div>
    ...
    <TR>
	    <TD style="width:15%" align="left"><asp:Label ID="lblProdID" runat="server" 
                Text="Carton SN:" CssClass="iMes_label_13pt"></asp:Label></TD>
...
<script type="text/javascript">
            ...
            if (!errorFlag) {
                ...
                try {
                    ...
                    if (lstPrintItem == null)                 //判断 若PrintItem==null, 不继续打印，等待客户维护PrintSetting页面后，再刷入打印
                    {
                        ...
                        PageMethods.RePrint(inpuProdid, reason, editor, station, customer, lstPrintItem, onSucceed, onFail);
                    }
                }
                catch (e1) {
    ...
    function onSucceed(result) {
        try {
            ...
            setPrintItemListParam(result[1][0],"", result[1][1],1);
    ...
    function setPrintItemListParam(backPrintItemList, Model,Carton,Qty) {
        ...
        valueCollection[1] = generateArray(Carton);
        keyCollection[2] = "@Qty";
        valueCollection[2] = generateArray(parseInt(Qty));
        ...
        setPrintParam(lstPrtItem, backPrintItemList.LabelType, keyCollection, valueCollection);
