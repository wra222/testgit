...
public partial class Query_FA_ProductStatement: IMESQueryBasePage
{
    ...
    public string[] GvQueryColumnName = { "No", "ProductID", "Family", "CUSTSN", "Desc", "Model", "SKU" , "Station", "Status", "Line", "Editor", "Udt","LOC" };
    public int[] GvQueryColumnNameWidth = { 50, 80, 100, 80, 60, 90, 90, 150, 80, 80, 120, 150 ,50};
