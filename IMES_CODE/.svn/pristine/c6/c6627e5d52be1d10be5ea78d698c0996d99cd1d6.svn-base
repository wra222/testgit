...
* Description:Combine Pack For Docking
* Update: 
* Date        Name                  Reason 
* ==========  ===================== =====================================
* 2012-5-28   Song Hai-Yan           Create   
* Known issues:
* TODO：
* 
*/
...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CombinePack.aspx.cs" Inherits="CombinePack" %>
...
<bgsound  src="" autostart="true" id="bsoundInModal" loop="1"></bgsound>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        <Services>
			<asp:ServiceReference Path="~/Docking/Service/WebServiceCombinePack.asmx" />
        </Services>
    </asp:ScriptManager>
            ...
            <fieldset style="width: 100%">
                ...
                <table width="100%" border="0" style="table-layout: fixed;">
                    ...
                    <tr>
                        ...
                        <td style="width:10%">
                            <asp:Label ID="lblPAQC" runat="server" CssClass="iMes_label_13pt"></asp:Label>
                        </td>
                        <td  style="width: 35%;">
                            <asp:UpdatePanel runat="server" ID="UpdatePanel4" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:Label ID="txtPAQC" runat="server" CssClass="iMes_label_13pt"  Font-Bold="True" ForeColor="Red" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                         </td>
                    </tr>
    ...
    <script type="text/javascript">
                    ...
                    if (document.getElementById("<%=txtProdId.ClientID%>").innerText == "") {
                        ...
                        else if (tmpdata == "prodIdnull")
                        {
                            ...
                            if (inputData == "getbomnull") {
                                ...
                                WebServiceCombinePack.save(document.getElementById("<%=txtProdId.ClientID%>").innerText, onSaveSucceed, onSaveFail);
                       ...
                       if (codetype == "ProdId" || codetype == "CustSN") {
                        ...
                        if (tempdata == "WrongCode" && tmpno == "WrongCode")
                        {
                            ...
                            if (hidMBSn == "WrongCode") {
                                ...
                                WebServiceCombinePack.inputMBSn(document.getElementById("<%=txtProdId.ClientID%>").innerText, hidMBSn, onSucceed, onFail);
                            }
                        }
                    }  
        ...
        function onSucceed(result) {
            ...
            //WebServiceCombinePack.SetDataCodeValue(document.getElementById("<%=txtModel.ClientID %>").innerText, customer, setSucc, setFail);
            ...
            //WebServiceCombinePack.save(document.getElementById("<%=txtProdId.ClientID%>").innerText, lstPrintItem, onSaveSucceed, onSaveFail);
        ...
        function onSaveSucceed(result) {
            ...
            try {
                ...
                if (result == null) {
                    ...
                    var ispaqc = document.getElementById("<%=txtPAQC.ClientID%>").innerText;
                    reset();
                    ...
                    callNextInput();
                     if (ispaqc == "PAQC")
                    {
                      //ShowSuccessfulInfo(true, "[" + tmpid + "] " + msgSuccess + '<%=this.GetLocalResourceObject(Pre + "_msgPAQCDispaly").ToString() %>');
                      
                       ShowInfo("[" + tmpid + "] " + msgSuccess+'<%=this.GetLocalResourceObject(Pre + "_msgPAQCDispaly").ToString() %>', "red");
                       PlaySoundPIA();
                    }
                    else
                    {
        ...
        function reset() {
            try {
                ...
                document.getElementById("<%=txtPAQC.ClientID%>").innerText = "";
                mbSNo = "";
                clearTable();
        ...
        function ExitPage() {
            if (document.getElementById("<%=txtProdId.ClientID%>").innerText != "") {
                ...
                WebServiceCombinePack.Cancel(document.getElementById("<%=txtProdId.ClientID%>").innerText, document.getElementById("<%=station.ClientID%>").value, onClearSucceeded, onClearFailed);
