...
<%@ Page Language="C#" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="FamilyInfoMaintain.aspx.cs" Inherits="ModelInfoMaintain" Title="" %>
   ...
   function clkDelete()
   {
    ...
    function SaveComplete(id){
        ...
        if(row != null)
        {
            ...
            document.getElementById("<%=valItem.ClientID%>").innerText = row.cells[1].innerText.trim();
