...
namespace IMES.Docking.Implementation
{
    ...
    public class ICTInput : MarshalByRefObject, IICTInput
    {
        ...
        public void InputMBSno(string MBSno, string ecr, int warrantyID, string editor, string line, string station, string customer)
        {
            ...
            try
            {
                ...
                if (currentSession == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(station, "ICTInputDocking.xoml", "ICTInputDocking.rules", out wfName, out rlName);
        ...
        /// <returns></returns>
        public ArrayList Save(string MBSno, string aoi, IList<string> defectList, IList<PrintItem> printItems)
        {
        ...
        public IList<PrintItem> EcrReprint(string mbSno, string reason, string editor, string line, string station, string customer, IList<PrintItem> printItems)
        {
            ...
            try
            {
                ...
                if (session == null)
                {
                    ...
                    string wfName, rlName;
                    RouteManagementUtils.GetWorkflow(station, "ECRReprintDocking.xoml", string.Empty, out wfName, out rlName);
                    WorkflowInstance instance = WorkflowRuntimeManager.getInstance.CreateXomlFisWorkflow(wfName, rlName, wfArguments);
        ...
        public void MBReinputSave(string mbSno, string editor, string line, string station, string customer)
        {
            ...
            try
            {
                ...
                if (session == null)
                {
                    ...
                    string wfName, rlName;
                    RouteManagementUtils.GetWorkflow(station, "MBReinputDocking.xoml", string.Empty, out wfName, out rlName);
                    WorkflowInstance instance = WorkflowRuntimeManager.getInstance.CreateXomlFisWorkflow(wfName, rlName, wfArguments);
                    session.SetInstance(instance);
