...
namespace IMES.Station.Interface.StationIntf
{
    ...
    public interface IPizzaKitting
    {
        ...
        /// <param name="customer"></param>
        /// <returns></returns>
        ArrayList InputPizzaID(string productID, string pizzaID, string line, string curStation, string model,
        ...
        IMES.DataModel.MatchedPartOrCheckItem TryPartMatchCheck(string sessionKey, string checkValue,string resetLevel);
        ...
        /// <param name="customer"></param>
        /// <returns></returns>
        ArrayList InputPizzaCheckSN(string custSN, string line, string curStation,
                                                string editor, string station, string customer);


        /// <summary>
        /// for PAK Review Sorting
        /// </summary>
        /// <param name="custSN"></param>
        /// <param name="line"></param>
        /// <param name="curStation"></param>
        ...
        /// <param name="customer"></param>
        /// <returns></returns>
        ArrayList InputPizzaCheckSNforSorting(string custSN, string line, string curStation,
                                                string editor, string station, string customer);
        List<string> UploadSnForSorting(List<string> snList, string station, string editor, string line, string customer);
        #endregion
