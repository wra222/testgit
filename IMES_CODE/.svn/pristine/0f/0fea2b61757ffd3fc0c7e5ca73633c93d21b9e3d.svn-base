...
namespace IMES.Station.Interface.StationIntf
{
    ...
    public interface IPodLabelCheck
    {
        ...
        ArrayList InputCustSnForCQ(string custsn, string pdLine, string editor, string station, string customer);
        ...
        ProductModel InputCustSnOnCooLabel(string custsn, string pdLine, string editor, string station, string customer, out string custpn, out MRPLabelDef MRP,out string BoxID);
        ...
        /// <param name="customer">customer</param>
        /// <returns></returns>
        string InputCustPnOnPodLabel(string productIdValue, string custSnOnCooValue, string custPnOnPodValue, string pdLine, string editor, string station, string customer, out string Loc);
