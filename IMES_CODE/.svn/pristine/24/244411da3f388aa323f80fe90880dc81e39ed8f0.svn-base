...
public partial class Query_PAK_PAQCSortingQuery : IMESQueryBasePage
{
   ...
   // IMES.Query.Interface.QueryIntf.IFamily Family = ServiceAgent.getInstance().GetObjectByName<IMES.Query.Interface.QueryIntf.IFamily>(WebConstant.IFamilyBObject);
    ...
    IPAK_PAQCSortingQuery PAK_PAQCSortingQuery = ServiceAgent.getInstance().GetObjectByName<IPAK_PAQCSortingQuery>(WebConstant.IPAK_PAQCSortingQuery);

    public string[] GvQueryColumnName = { "PAQCSortingID","CUSTSN","Status","Editor","Cdt" };
    public int[] GvQueryColumnNameWidth = { 80, 80, 80, 80, 80 };
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //int sum = 0;
            dt = PAK_PAQCSortingQuery.GetPAQCSortingQueryResult(DBConnection, CUSTSN);
