    ...
    function onSucceed(result) 
    {
        ...
        try {
            if (result == null) 
            {
                ...
                setPrintItemListParam(result[1], result[2],result[5]);   
...
//test，2011-10-18，需放开==========* /
                    ...
                    WebServiceOnlineGenerateAST.reprint(dataEntry, "", station, "<%=UserId%>", "<%=Customer%>", reason, lstPrintItem, onSucceed, onFail);
//test，2011-10-18，需放开==========
                }
            }
        } catch (e) {
    ...
    <div>
        ...
        <table width="95%" style="height:200px; vertical-align:middle" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td colspan ="9" align="left" class="style1">
                    <textarea id="lblReasonInfo" style="width: 98%; height: 45px" 
                        onkeypress="setMaxLength(this,80);" onpaste="limitPaste(this, 80)"></textarea>
                </td>
            </tr>
