...
namespace IMES.Docking.Interface.DockingIntf
{
    ...
    /// </summary>
    public interface IGenSMTMODocking
    {
        /// <summary>
        ...
        string GenerateSMTMO(string model, int quantity, string ModelType, string remark, string editor, string stationId, string customerId);
        ...
        /// </summary>
        /// <returns></returns>
        IList<MbCodeAndMdlInfo> GetMBCodeAndPCB();
        /// <summary>
        /// 
        /// </summary>
        /// <param name="mbCode"></param>
        /// <returns></returns>
        IList<string> GetModelByMBCode(string mbCode);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="pno"></param>
        /// <returns></returns>
        MbCodeAndMdlInfo GetMBMDLByPno(string pno);
    }
}
