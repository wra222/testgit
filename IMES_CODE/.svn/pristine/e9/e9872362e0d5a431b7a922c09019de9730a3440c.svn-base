<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SpecialOrderUploadDlg.aspx.cs" Inherits="DataMaintain_SpecialOrderUploadDlg" %>
...
<head id="Head1" runat="server">
    <title>Special Order Upload</title>
