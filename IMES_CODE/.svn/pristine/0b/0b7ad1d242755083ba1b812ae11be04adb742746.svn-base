<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UPH_SMT_Daily.aspx.cs" Inherits="webroot_aspx_UPH_SMT_Daily" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SMT每日生产效率排行榜</title>
  <style type="text/css">         
                ...
                function drawseries(option, ChartItem) {
                   ...
                   // option.title.subtext = ChartItem.Title;
                    ...
                    for (var i = 0; i < seriesArray.length; i++) {
                        ...
                        var item2 = {
                            name: seriesArray[i].Name2,
                            type: "line",
                            data: seriesArray[i].SeriesValues2,
                             yAxisIndex: 1
                        }
                      ...
                      //  option.series.push(item2);
                        ...
                        //  legendlist.push(seriesArray[i].Name2);
                        if (i > 3) {
