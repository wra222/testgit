									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-weight="normal" line-height="7pt" table-layout="fixed" width="100%">
										...
										<fo:table-body font-weight="normal" start-indent="0pt">
											<fo:table-row border-collapse="collapse" width="100%">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" text-align="left">
													<fo:block>
														<fo:block/>
													...
													<fo:block>
														...
														<xsl:for-each select="PACK_ID">
															...
															<xsl:choose>
																...
																<xsl:otherwise>
																	<fo:inline font-weight="bold" line-height="11pt">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:inline>
																</xsl:otherwise>
															</xsl:choose>
											...
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="3pt" display-align="text-top" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1">
													<fo:block>
														<fo:inline font-family="Free 3 of 9 Extended" font-size="30pt">
															<xsl:text>*</xsl:text>
														</fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" line-height="5.5pt" display-align="text-top" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1">
													<fo:block/>
												</fo:table-cell>
											</fo:table-row>
										</fo:table-body>
												...
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-weight="normal" line-height="0.5pt" margin="none" padding="none" display-align="text-top" height="1" text-align="right">
													<fo:block>
														<fo:inline font-family="Arial" font-size="5pt" font-weight="bold">
															<xsl:text>EMEAOBOX120510</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
