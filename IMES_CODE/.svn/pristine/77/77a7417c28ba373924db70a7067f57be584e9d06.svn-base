 ...
 <table border="0" width="100%"  >                    
   ...
   <fieldset id="grpCarton" style="border: thin solid #000000; width: 98%;">           
    ...
    <fieldset id="Fieldset2" style="border: thin solid #000000; width: 98%; height: 300px;">
        ...
        <fieldset id="Fieldset13" style="border: thin solid #000000; width: 98%; height: 300px;">
        <legend align="left" style="height: 20px">
            <asp:Label ID="Label13" runat="server" CssClass="iMes_label_13pt" Text="Hold History"></asp:Label></legend>
        <asp:UpdatePanel ID="UpdatePanel14" runat="server" UpdateMode="Conditional" RenderMode="Inline">
            <ContentTemplate>
                <iMES:GridViewExt ID="gvHoldHistory" runat="server" AutoGenerateColumns="true" Width="98%"
                    GvExtWidth="100%" GvExtHeight="260px" Height="1px" 
    ...
    <a name="ProductPartunpack"></a>    
     <fieldset id="Fieldset11" style="border: thin solid #000000; width: 98%; height: 180px;">
        <legend align="left" style="height: 20px">
            <asp:Label ID="Label11" runat="server" CssClass="iMes_label_13pt" Text="Product_Part Unpack"></asp:Label></legend>
        <asp:UpdatePanel ID="UpdatePanel12" runat="server" UpdateMode="Conditional" RenderMode="Inline">
            <ContentTemplate>
                <iMES:GridViewExt ID="gvProductPartUnpack" runat="server" AutoGenerateColumns="true" Width="98%"
                    GvExtWidth="100%" GvExtHeight="150px" Height="1px" 
                    style="top: 26px; left: -1px">
                </iMES:GridViewExt>
            </ContentTemplate>
    ...
    <a name="PizzaPartunpack"></a>    
     <fieldset id="Fieldset12" style="border: thin solid #000000; width: 98%; height: 180px;">
        <legend align="left" style="height: 20px">
            <asp:Label ID="Label12" runat="server" CssClass="iMes_label_13pt" Text="Pizza_Part Unpack"></asp:Label></legend>
        <asp:UpdatePanel ID="UpdatePanel13" runat="server" UpdateMode="Conditional" RenderMode="Inline">
            <ContentTemplate>
                <iMES:GridViewExt ID="gvPizzaPartUnpack" runat="server" AutoGenerateColumns="true" Width="98%"
                    GvExtWidth="100%" GvExtHeight="150px" Height="1px" 
                    style="top: 26px; left: -1px">
                </iMES:GridViewExt>
            </ContentTemplate>
...
<script  language="javascript">
    ...
    var HoldHistory_DEFAULT_ROWS = 1;
    ...
    var ProductPartUnpack_DEFAULT_ROWS = 1;
    var PizzaPartUnpack_DEFAULT_ROWS = 1; 
    ...
    function ResetPage() {
        ...
        ClearGvExtTable(document.getElementById("<%=gvHoldHistory.ClientID %>"), ProductHistory_DEFAULT_ROWS);
        ...
        ClearGvExtTable(document.getElementById("<%=gvProductPartUnpack.ClientID %>"), ProductPartUnpack_DEFAULT_ROWS);
        ClearGvExtTable(document.getElementById("<%=gvPizzaPartUnpack.ClientID %>"), PizzaPartUnpack_DEFAULT_ROWS);
