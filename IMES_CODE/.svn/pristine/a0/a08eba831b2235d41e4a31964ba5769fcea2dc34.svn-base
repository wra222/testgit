...
{
    /// <summary>
    /// IOQCRepairForDocking接口的实现类
    /// </summary>
    public class OQCRepairForDockingImpl : MarshalByRefObject, IOQCRepairForDocking 
    {
        private ILog logger = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        private const Session.SessionType ProductSessionType = Session.SessionType.Product;

        #region IOQCRepair members
        ...
        {
            logger.Debug("(OQCRepairImpl)InputProdId start, [pdLine]:" + pdLine
                + " [prodId]: " + prodId
                + " [editor]:" + editor
                + " [station]:" + stationId
                + " [customer]:" + customer);
            ...
            try
            {
                ...
                if (session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(stationId, "OQCRepairForDocking.xoml", "OQCRepairForDocking.rules", out wfName, out rlName);
            ...
            {
                logger.Debug("(OQCRepairImpl)InputProdId end, [pdLine]:" + pdLine
                    + " [prodId]: " + prodId
                    + " [editor]:" + editor
                    + " [station]:" + stationId
                    + " [customer]:" + customer);
        ...
        {
            logger.Debug("(OQCRepairImpl)Edit start, [prodId]:" + prodId
                + " [rll]: " + rll);   
            FisException ex;
            List<string> erpara = new List<string>();
            string sessionKey = prodId;
            ...
            {
                logger.Debug("(OQCRepairImpl)Edit end, [prodId]:" + prodId
                    + " [rll]: " + rll);               
            }
        }
        ...
        {
            logger.Debug("(OQCRepairImpl)Save start, [prodId]:" + prodId);
            FisException ex;
            List<string> erpara = new List<string>();
            string sessionKey = prodId;
            ...
            {
                logger.Debug("(OQCRepairImpl)Save end, [prodId]:" + prodId);            
            }
        }
        */
        ...
        */
        ...
        {
            logger.Debug("(OQCRepairImpl)Cancel start, [prodId]:" + prodId);
            FisException ex;
            List<string> erpara = new List<string>();
            string sessionKey = prodId;
            ...
            {
                logger.Debug("(OQCRepairImpl)Cancel end, [prodId]:" + prodId);
            }
        }
