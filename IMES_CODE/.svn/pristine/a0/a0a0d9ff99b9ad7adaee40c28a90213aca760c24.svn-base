<%@ Page Title="PCBLotQuery" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="PCBLotQuery.aspx.cs" Inherits="Query_SA_PCBLotQuery" EnableEventValidation="false" %>
...
<center>
 <fieldset id="grpCarton" style="border: thin solid #000000;">
    <legend align ="left" style ="height :20px" >
       <asp:Label ID="lblTitle" runat="server" Text="PCBLotQuery" 
         ...
         <table border="0" width="100%" style="font-family: Tahoma">                    
            ...
            <tr>
               <td class="style2" rowspan="2">
                   <asp:RadioButtonList ID="rdbutPCBLot" runat="server" Width="100px">
                       <asp:ListItem Selected="True" Value="LotNo">LotNo：</asp:ListItem>
                       <asp:ListItem Value="PCBNo">PCBNo：</asp:ListItem>
                   </asp:RadioButtonList>
               </td>
               <td class="style3">
                   <asp:TextBox ID="txtLotNo" runat="server" Width="300px">
                   </asp:TextBox>
                   <input id="BtnBrowseLotNo" type="button" value="Browse"  onclick="UploadLotNoList()" /></td>            
            </tr>
            <tr>
               <td class="style3" >                   
                   <asp:TextBox ID="txtPCBNo" runat="server" Width="300px">
                   </asp:TextBox>
                   <input id="BtnBrowsePCBNo" type="button" value="Browse"  onclick="UploadPCBNoList()" />
               </td>            
            </tr>
         </table>
</fieldset> 
