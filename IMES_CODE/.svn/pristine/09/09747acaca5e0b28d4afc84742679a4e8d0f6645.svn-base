...
//    var strPdLine="";
    ...
    function displayFun()
    {
        ...
        if (!regx.test(strDataEntry)) {
            alert("The input data is not legitimate!!");
        ...
        */
        if ((strMBDisplay == "") && (strDataEntry.substring(5, 6) == 'M' || strDataEntry.substring(5, 6) == 'B') && (strDataEntry.length == 11)) {
            MBSNoSFC();
            return;
        }
        ...
        else if ((strMBDisplay == "") && (strDataEntry.length == 10) && (strDataEntry.substring(4, 5) != 'M' && strDataEntry.substring(4, 5) != 'B')) {
            isMBSN = false;
        }
        else if ((strMBDisplay == "") && (strDataEntry.length == 11) && (strDataEntry.substring(4, 5) != 'M' && strDataEntry.substring(4, 5) != 'B') && (strDataEntry.substring(5, 6) != 'M' && strDataEntry.substring(5, 6) != 'B')) {
            isMBSN = false;
        }
        ...
        {
            if ((strDataEntry.length == 13) || (strDataEntry.length == 14))
    		{
