...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class DeleteCartonSSCC: BaseActivity
	{

        public DeleteCartonSSCC()
		{
			InitializeComponent();
		}
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            CartonSSCC cartonSSCC = cartonSSCCRepository.Find(currentCarton);
            cartonSSCCRepository.Remove(cartonSSCC, CurrentSession.UnitOfWork);
