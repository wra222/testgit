...
*/
 --%>
<%@ WebService Language="C#" Class="PAQCRepairService" %>
...
public class PAQCRepairService : System.Web.Services.WebService
{
    private IPAQCRepairForDocking iPAQCRepair = ServiceAgent.getInstance().GetObjectByName<IPAQCRepairForDocking>(WebConstant.PAQCRepairForDockingObject);
    ...
    public void update(string productId, RepairInfo defect, string editor, string station, string customer)
    {
        try
        {
            iPAQCRepair.Edit(productId, defect);
        }
    ...
    public void add(string productId, RepairInfo defect, string editor, string station, string customer)
    {
        try
        {
            iPAQCRepair.Add(productId, defect);
        }
        catch (FisException ex)
        {
            throw new Exception(ex.mErrmsg);
    ...
    */
    ...
    public ArrayList save(string prodId)
    {
        ...
        try
        {
            retLst = iPAQCRepair.Save(prodId);
    ...
    */
    public ArrayList save(string prodId, string returnStation, string returnStationText)
    {
        ...
        try
        {
            retLst = iPAQCRepair.Save(prodId, returnStation, returnStationText);
