...
//test，2011-10-18，测试流程是否通，需去掉========*/
        ...
        public IList<PrintItem> Print(string custsn, string pdLine, string stationId, string editor, string customerId, IList<PrintItem> printItems)
        {
...
//test，2011-10-18，测试流程是否通，需放开======== * /               
        ...
        public IList<PrintItem> RePrint(string custsn, string pdLine, string stationId, string editor, string customerId, string reason, IList<PrintItem> printItems, out string ErrorFlag, out string imageURL)
        {
