...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link sps xbrldi xbrli xlink xs xsi">
	...
	<xsl:param name="aVersion_Name" select="'LABRBOX150515'"/>
	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.2cm" margin-right="0.2cm" page-height="55mm" page-width="127mm" margin-top="0.0in" margin-bottom="0.0in">
				<fo:region-body margin-top="0.05cm" margin-bottom="-0.50cm" column-count="1" column-gap="0.50in"/>
						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-bottom="0.5pt" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" line-height="6pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row border-bottom="0.5pt" border-collapse="collapse" height="0.01in" line-height="7pt" width="100%">
													...
													<fo:table-cell number-rows-spanned="2" border="none" border-left-style="none" font-family="Arial" font-size="5.5pt" font-weight="bold" line-height="5.5pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="before">
														<fo:block-container overflow="hidden">
															<fo:block text-align="center">
																<fo:block>
																	<fo:leader leader-pattern="space"/>
																</fo:block>
																<fo:inline font-size="5.5pt" line-height="6pt" alignment-baseline="before-edge">
																	<xsl:text>IMPORTADO E DISTRIBUIDO NO BRASIL POR:</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>HP Brasil Industria e Comercio de Equipamentos Eletrônicos LTDA</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>Av. Jose Luiz Mazzali, 360 – Galpão B, Parte 6</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																...
																<fo:block/>
																<fo:inline>
																	<xsl:text>CNPJ: 22.086.683/0003-46</xsl:text>
																</fo:inline>
																<fo:block/>
															</fo:block>
														</fo:block-container>
												...
												<fo:table-row border-collapse="collapse" height="0.50in" width="100%">
													<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" line-height="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
														<fo:block-container overflow="hidden">
										...
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row height="0.01in">
													<fo:table-cell number-columns-spanned="2" border="none" font-family="Arial" font-size="7pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-family="Free 3 of 9 Extended" font-size="24pt" alignment-baseline="before-edge">
																	<xsl:text>*</xsl:text>
																</fo:inline>
																<xsl:for-each select="CUST_PO">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_7),'&#x200B;')">
																			<fo:block font-family="Free 3 of 9 Extended" font-size="24pt" alignment-baseline="before-edge">
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										<fo:table-column column-width="0.729in"/>
										<fo:table-column column-width="proportional-column-width(1)"/>
										<xsl:variable name="altova:CurrContextGrid_10" select="."/>
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row height="0.04in" margin="none" padding="none">
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" line-height="6pt" margin="none" padding="none" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																...
																<fo:block font-size="6pt" margin-right="100% - 100%" white-space="pre" white-space-collapse="false" margin="0pt">
																	<xsl:for-each select="UDF_HEADER">
																		<xsl:if test="./KEY = &apos;ODM_TEXT1&apos; and string-length(./VALUE)&gt;0">
																			<fo:inline font-family="Arial" font-size="6pt" font-weight="bold" alignment-baseline="before-edge">
													...
													<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="5pt" font-weight="bold" line-height="6pt" margin="none" padding="none" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="right">
