...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EPIAOutputForDocking.aspx.cs" Inherits="Docking_EPIAOutput" Title="无标题页" %>
<%@ Import Namespace="com.inventec.iMESWEB" %>
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" Runat="Server">
    <script type="text/javascript" src="../CommonControl/JS/iMESCommonUse.js"></script>
    <asp:ScriptManager ID="ScriptManager1" runat="server" >
        <Services>
            <asp:ServiceReference Path="~/Docking/Service/WebServiceEPIAOutputForDocking.asmx" />
        </Services>
    </asp:ScriptManager>
            ...
            else
            {
                if (data != "9999" && data != "7777")
                {
                    ...
                    if (custsn == '0') {
                        ...
                        WebServicePIAOutput.input("", custsn, editor, stationId, customer, inputSucc, inputFail);
                    } 
                }
                else
                {
