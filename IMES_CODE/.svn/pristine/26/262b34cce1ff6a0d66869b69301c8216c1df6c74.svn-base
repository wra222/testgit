...
//                    newNode.ImageUrl = "./Images/" + ImageUrl;
                    NavigateUrl += "&UserId=" + userInfo.UserId + "&Customer=" + userInfo.Customer + "&UserName=" + HttpUtility.UrlEncode(userInfo.UserName) + "&AccountId=" + userInfo.AccountId + "&Login=" + userInfo.Login;
