<%@ Page Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="SAMBRepair.aspx.cs" Inherits="Query_MBRepair" %>
    ...
    <div>
        <fieldset style="border: solid #000000">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:DropDownList ID="ddlStation" runat="server" SelectionMode="Multiple" Width="150px" Visible=false>                     
                    </asp:DropDownList>
