<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FA_OUT_Boss.aspx.cs" Inherits="webroot_aspx_FA_OUT_Boss" %>
        ...
        function DrawEChartFAPieOut(ec) {
            ...
            pieoption = {
               ...
               calculable: true,
                ...
                WebServiceEchart.GetData_OutPut("FA", inputSucc, inputFail);
