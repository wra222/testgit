...
{
    IFATestStation iFATestStation = ServiceAgent.getInstance().GetObjectByName<IFATestStation>(WebConstant.FATestStationDocking);
    ...
    public ArrayList inputProdId(string pdLine, string testStation, string prodId, string editor, string customer)
    {
        ...
        try
        {
            //strRuninrtn = iFATestStation.InputProdId(pdLine, testStation, prodId, editor, customer);
            infoList = iFATestStation.InputProdId(pdLine, testStation, prodId, editor, customer);
            var currentProdID = infoList[1];
            ProductInfo productInfo = iProduct.GetProductInfo(currentProdID);
            model = productInfo.modelId;
    ...
    [WebMethod]
    public ArrayList savePage(string prodId, List<string> defectList,string thisTestTool,bool isNeedPrint2D, IList<PrintItem> printItemLst)
    {
        ///return ArrayList
        ///No1:return WebConstant.SUCCESSRET
        ...
        try
        {
            ...
            string qcMethod = "";
            IList<PrintItem> retLst = iFATestStation.InputDefectCodeList(prodId, iList,thisTestTool,isNeedPrint2D,printItemLst, out qcMethod);
