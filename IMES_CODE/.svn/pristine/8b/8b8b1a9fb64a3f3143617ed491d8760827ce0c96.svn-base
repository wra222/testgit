							...
							<xsl:for-each select="BOXES">
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" height="10pt" line-height="10pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row font-family="Arial" font-size="10pt" font-style="normal">
												<fo:table-cell border="none" font-family="Arial" font-size="9pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" font-weight="bold" number-rows-spanned="7" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
											...
											<fo:table-row font-family="Arial" font-size="12pt">
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" font-weight="normal" number-columns-spanned="2" padding="2pt" display-align="center">
													<fo:block/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row font-family="Arial" font-size="12pt">
												<fo:table-cell border="none" font-family="Free 3 of 9 Extended" font-size="30pt" font-weight="normal" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>*</xsl:text>
														</fo:inline>
											...
											<fo:table-row font-family="Arial" font-size="10pt" height="10pt">
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" font-weight="normal" number-columns-spanned="2" padding="2pt" display-align="before">
													<fo:block/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row font-family="Arial" font-size="10pt" height="10pt">
												<fo:table-cell border="none" font-family="Arial" font-size="9pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="before">
													<fo:block>
														<fo:inline>
											...
											<fo:table-row font-family="Free 3 of 9 Extended" font-size="30pt">
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" font-weight="normal" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="after">
													<fo:block/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row font-family="Free 3 of 9 Extended" font-size="30pt">
												<fo:table-cell border="none" font-family="Free 3 of 9 Extended" font-size="30pt" font-weight="normal" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" display-align="after">
													<fo:block>
														<fo:inline>
															<xsl:text>*</xsl:text>
														</fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" line-height="10pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row line-height="20pt">
												<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="7pt" number-columns-spanned="4" padding="2pt" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
														...
														<fo:block margin-left="100% - 100%" margin="0pt">
															<fo:block>
																<fo:inline>
																	<xsl:text>LGLARBOX100201</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block>
													</fo:block>
