...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="ProdIdRePrint.aspx.cs" Inherits="ProdIdRePrint" %>
...
<div>
    <asp:ScriptManager ID="ScriptManager1" runat="server" >
        <Services>
            <asp:ServiceReference Path="Service/WebServiceProdIdRePrint.asmx" />
        </Services>
    </asp:ScriptManager>
    <center>
...
<script type="text/javascript">
        ...
        try {
            ...
            if (!errorFlag) {
                ...
                try {
                    ...
                    WebServiceProdIdRePrint.Reprint(inpuProdid, reason, editor, station, customer, pCode, lstPrintItem, onSucceed, onFail);                    
                }
                catch (e1) {
    ...
    function setPrintItemListParam1(backPrintItemList, pdline, beginProid)
    {
        ...
        valueCollection[1] = generateArray("");


        setPrintParam(lstPrtItem, "DK_Travel_Card", keyCollection, valueCollection);
    }
