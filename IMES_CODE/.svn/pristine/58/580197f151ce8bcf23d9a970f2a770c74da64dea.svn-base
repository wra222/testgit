...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
	public partial class CheckPalletForPalletVerify: BaseActivity
	{
        /// <summary>
        /// constructor
        /// </summary>
        public CheckPalletForPalletVerify()
		{
			InitializeComponent();
		}
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            if (cartonSn == "" || cartonSn == null)
            {
                erpara.Add(currentProduct.ProId);
                ex = new FisException("CHK883", erpara);
                throw ex;
            }
