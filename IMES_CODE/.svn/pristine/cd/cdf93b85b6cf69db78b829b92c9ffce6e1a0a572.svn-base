...
namespace IMES.Activity
{
	...
	public partial class GenerateCustomerSn: BaseActivity
	{
        ...
        /// <summary>
        ///  Need add PrintLog param
        /// </summary>
        public static DependencyProperty IsNeedPrintlogParamProperty = DependencyProperty.Register("IsNeedPrintlogParam", typeof(bool), typeof(GenerateCustomerSn), new PropertyMetadata(true));
        /// <summary>
        ///  分配新的Delivery
        /// </summary>
        [DescriptionAttribute("IsNeedPrintlogParam")]
        [CategoryAttribute("IsNeedPrintlogParam")]
        [BrowsableAttribute(true)]
        [DesignerSerializationVisibilityAttribute(DesignerSerializationVisibility.Visible)]
        public bool IsNeedPrintlogParam
        {
            get
            {
                return ((bool)(base.GetValue(GenerateCustomerSn.IsNeedPrintlogParamProperty)));
            }
            set
            {
                base.SetValue(GenerateCustomerSn.IsNeedPrintlogParamProperty, value);
            }
        }
        private string GetSN(string maxnum)
        {
            //36进制改为31进制
