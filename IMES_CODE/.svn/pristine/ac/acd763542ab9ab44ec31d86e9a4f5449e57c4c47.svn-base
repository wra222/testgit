<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CmbMaintainPartNodeType.ascx.cs" Inherits="CommonControl_DataMaintain_CmbMaintainPartNodeType" %>
...
<script type="text/javascript" language="javascript">
    ...
    function getMaintainPartNodeTypeCmbObj()
    {    
         return document.getElementById("<%=drpMaintainPartNodeType.ClientID %>");   
    }
    
    function getMaintainPartNodeTypeCmbText()
    { 
