<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="QueryPalletType.aspx.cs" Inherits="Query_PAK_QueryPalletType"  EnableEventValidation="false"  uiculture="auto"%>
         ...
         <table border="0" width="100%" style="font-family: Tahoma">                    
            <tr>
                ...
                <td width ="10%" align="right">
                    <asp:RadioButton ID="rad1" runat="server" Checked="True" GroupName="radGr" />
                 <asp:Label ID="lblDate" runat="server" Text="Ship Date:" CssClass="iMes_label_13pt"  ></asp:Label>
                </td>       
                <td width ="10%" align="left">
                   <asp:TextBox ID="txtShipDate" runat="server" Width="156px" Height="20px" ></asp:TextBox>                                                         
                                               
                </td> 
                <td width ="25%" align="left">
                    <asp:RadioButton ID="radDN" runat="server" GroupName="radGr" />
                 <asp:Label ID="Label1" runat="server" Text="DN No:" CssClass="iMes_label_13pt"  ></asp:Label>
                    
                    <asp:TextBox ID="txtDN" runat="server" Width="170px"></asp:TextBox>
                </td>
                <td>
...
<script type="text/javascript">    //<![CDATA[
    ...
    function CheckInput() {
        ...
        var obj = document.getElementById(ConvertID("radDN"));
        if (obj.checked) {

            var input = document.getElementById(ConvertID("txtDN")).value.trim();
            if (input == "") {
