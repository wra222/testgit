...
public partial class DataMaintain_ConstValueMaintainDlg : System.Web.UI.Page
{
    ...
    protected void btnSave_ServerClick(Object sender, EventArgs e)
    {
        try
        {
            ...
            //IList<string> typeLst = iConstValueType.GetConstValueTypeList();
            ...
            //ConstValueTypeInfo newTypeInfo = new ConstValueTypeInfo();
            ...
            //iConstValueType.InsertConstValueType(newTypeInfo);
