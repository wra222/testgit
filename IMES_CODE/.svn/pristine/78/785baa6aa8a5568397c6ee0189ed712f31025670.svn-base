...
namespace IMES.Dashboard
{
    ...
    public class InOutInfo : System.Web.Services.WebService
    {
       ...
       /// <returns></returns>
        [WebMethod]
        public SumInputOutputQty GetInOutInSumfo()
        {
            ...
            try
            {
                ...
                string sqlText = @"select top 1 Period_Date, TargetInput,InputQty, NonInput, TargetOutput, OutputQty, NonOutput, Exec_Time
                                             from PSG_IMES_InputOutputQty_Sum
