					...
					<fo:block>
						...
						<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" padding="0pt" table-layout="fixed" width="100%">
							...
							<fo:table-body start-indent="0pt">
								<fo:table-row>
									<fo:table-cell background-color="gray" border="none" color="white" font-weight="bold" padding="2pt" text-align="center" display-align="center">
										<fo:block>
											<fo:inline>
						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="HOUSE_WAYBILLS">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="none" padding="2pt" text-align="center" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Total Unity Qty:</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											...
											<fo:table-row>
												...
												<fo:table-cell border="none" padding="2pt" display-align="center">
													<fo:block>
														<xsl:for-each select="HAWB_BOX_QTY">
															<xsl:variable name="value-of-template">
																<xsl:apply-templates/>
															</xsl:variable>
															<xsl:choose>
											...
											<fo:table-row>
												<fo:table-cell border="none" padding="2pt" text-align="center" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Total Pallet Qty:</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" padding="2pt" display-align="center">
						...
						<fo:table-row>
							...
							<fo:table-cell border="none" font-family="Arial" font-size="12pt" font-style="normal" font-variant="normal" font-weight="bold" padding="2pt" text-align="left" display-align="center">
								<fo:block>
									...
									<fo:block margin="0pt">
										<fo:block>
											<fo:inline>
												<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; PACKING LIST SUMMARY</xsl:text>
											</fo:inline>
										</fo:block>
									</fo:block>
								</fo:block>
							...
							<fo:table-cell border="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="left" display-align="center">
								<fo:block>
									...
									<fo:inline>
										<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/CURRENT_DATE"/>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
						<fo:table-row>
							<fo:table-cell border="none" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt">
								<fo:block>
									<fo:block/>
									<fo:inline>
										<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_FROM_NAME"/>
									</fo:inline>
									<fo:block/>
									<fo:inline>
										<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_FROM_NAME_2"/>
									</fo:inline>
									<fo:inline-container>
										<fo:block>
											<xsl:text>&#x2029;</xsl:text>
									...
									<fo:block margin="0pt">
										<fo:block>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_FROM_STREET"/>
											</fo:inline>
										</fo:block>
									</fo:block>
									<fo:inline-container>
									...
									<fo:block margin="0pt">
										<fo:block>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_FROM_STREET_2"/>
											</fo:inline>
											<fo:inline>
												<xsl:text>&#160;</xsl:text>
											</fo:inline>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_FROM_CITY"/>
											</fo:inline>
											<fo:inline>
												<xsl:text>&#160;</xsl:text>
											</fo:inline>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_FROM_STATE"/>
											</fo:inline>
											<fo:inline>
												<xsl:text>&#160;</xsl:text>
											</fo:inline>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_FROM_ZIP"/>
											</fo:inline>
											<fo:inline>
												<xsl:text>&#160;</xsl:text>
											</fo:inline>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_FROM_COUNTRY_NAME"/>
											</fo:inline>
										</fo:block>
									</fo:block>
									<fo:inline-container>
									...
									<fo:block margin="0pt">
										<fo:block>
											...
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_TO_ID"/>
											</fo:inline>
										</fo:block>
									</fo:block>
									<fo:inline-container>
									...
									<fo:block margin="0pt">
										<fo:block>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_TO_NAME"/>
											</fo:inline>
										</fo:block>
									</fo:block>
									<fo:inline-container>
									...
									<fo:block margin="0pt">
										<fo:block>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_TO_NAME_2"/>
											</fo:inline>
										</fo:block>
									</fo:block>
									<fo:inline-container>
									...
									<fo:block margin="0pt">
										<fo:block>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_TO_NAME_3"/>
											</fo:inline>
										</fo:block>
									</fo:block>
									<fo:inline-container>
									...
									<fo:block margin="0pt">
										<fo:block>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_TO_STREET"/>
											</fo:inline>
										</fo:block>
									</fo:block>
									<fo:inline-container>
									...
									<fo:block margin="0pt">
										<fo:block>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_TO_STREET_2"/>
											</fo:inline>
										</fo:block>
									</fo:block>
									<fo:inline-container>
									...
									<fo:block margin="0pt">
										<fo:block>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_TO_CITY"/>
											</fo:inline>
											<fo:inline>
												<xsl:text>&#160;</xsl:text>
											</fo:inline>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_TO_STATE"/>
											</fo:inline>
										</fo:block>
									</fo:block>
									<fo:inline-container>
									...
									<fo:block margin="0pt">
										<fo:block>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_TO_ZIP"/>
											</fo:inline>
											<fo:inline>
												<xsl:text>&#160;</xsl:text>
											</fo:inline>
											<fo:inline>
												<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_TO_COUNTRY_NAME"/>
											</fo:inline>
										</fo:block>
									</fo:block>
								</fo:block>
							...
							<fo:table-cell border="none" display-align="before" padding="2pt">
								<fo:block>
									...
									<fo:block/>
									<fo:inline>
										<xsl:text>INTERNATIONAL CARRIER </xsl:text>
									</fo:inline>
									<fo:block/>
									<fo:inline>
							...
							<fo:table-cell border="none" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt">
								<fo:block>
									...
									<fo:inline>
										<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/WAYBILL_NUMBER"/>
									</fo:inline>
									<fo:block/>
									<fo:inline>
										<xsl:text>: </xsl:text>
									...
									<fo:inline>
										<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/INTL_CARRIER"/>
									</fo:inline>
									<fo:block/>
									<fo:inline>
										<xsl:text>: </xsl:text>
									...
									<fo:inline>
										<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/SHIP_MODE"/>
									</fo:inline>
									<fo:block/>
									<fo:inline>
										<xsl:text>: </xsl:text>
									...
									<fo:inline>
										<xsl:value-of select="$XML/HOUSE_WAYBILLS/HOUSE_WAYBILL/ACTUAL_SHIPDATE"/>
									</fo:inline>
									<fo:inline>
										<xsl:text>&#160;</xsl:text>
									</fo:inline>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>BSAMLT20130115</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
