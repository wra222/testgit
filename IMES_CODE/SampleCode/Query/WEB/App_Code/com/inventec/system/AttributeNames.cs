...
namespace com.inventec.system {
    public class AttributeNames {
        ...
        // add by itc98079
        public const string USER_NAME = "portal_userName";
        public const string USER_CODE = "portal_code";
        public const string E_MAIL = "portal_email";
        public const string DEPARTMENT = "portal_department";
        public const string MANAGER = "portal_manager";
        public const string DOMAIN = "portal_domain";
        public const string COMPANY = "portal_company";
        public const string AUTHOR_OBJ = "portal_authority_obj";
        public const string TOKEN = "portal_token";

        public const string PERMISSION_INFO = "portal_permission_info";
