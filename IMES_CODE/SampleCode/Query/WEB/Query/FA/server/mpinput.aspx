...
<%        
    try
    {
        ...
        string[] GvQueryDetailColumnName = { "No", "ProductID", "CUSTSN", "PCBID", "Family", "Model", "PalletNo", "ShipDate", "Station", "Status", "Descr", "Line", "Cdt", "Udt", "Editor" };
        int[] GvQueryDetailColumnNameWidth = { 50, 90, 100, 100, 100, 100, 80, 80, 50, 50, 200, 50, 200, 200, 100 };
        ...
        {        
            case "GET_SUMMARY":
                ...
                DataTable dt = MPInput.GetQueryResult(DBConnection, DateTime.Parse(txtFromDate), DateTime.Parse(txtToDate),
                ...
                break;
            case "GET_DETAIL":
                DataTable dt2 = MPInput.GetSelectDetail(DBConnection, DateTime.Parse(txtFromDate), DateTime.Parse(txtToDate), lstPdLine, family,
            ...
            case "GET_EXCEL":
                ...
                if (Session["dt"] == null)
                {
                    outdt1 = MPInput.GetQueryResult(DBConnection, DateTime.Parse(txtFromDate), DateTime.Parse(txtToDate), lstPdLine, family, lstModel, StationList, bool.Parse(lineshift), inputstation, bool.Parse(grpmodel), modelCategory);
                }
                else
                {
                ...
                //if (Session["dt2"] == null)
                //{
                outdt2 = MPInput.GetSelectDetail(DBConnection, DateTime.Parse(txtFromDate), DateTime.Parse(txtToDate), lstPdLine, family, lstModel, line, station, bool.Parse(lineshift), inputstation, StationList);
                //}
                //else
                //{
