<%@ Page Title="ProductDistribute" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="ProductImageDownTimeout.aspx.cs" Inherits="Query_FA_ProductImageDownTimeout" EnableEventValidation="false" %>
...
<center>
 <fieldset id="grpCarton" style="border: thin solid #000000;">
    <legend align ="left" style ="height :20px" >
       <asp:Label ID="lblTitle" runat="server" Text="2PPTimeOutQuery" 
         ...
         <table border="0" width="100%" style="font-family: Tahoma">                    
            ...
            <tr>
               <td class="style1" >
                    <asp:Label ID="lblPCBNo" runat="server" Text="Line：" 
