...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
 ...
 <center>
        ...
        <fieldset style="border: solid #000000">
            ...
            <tr>
                <td width ="10%">
                        <asp:Label ID="lblDB" runat="server" Text="DBName:" CssClass="iMes_label_13pt" style="float:right"></asp:Label>
                    </td>
                    <td width="60%">
            ...
            <tr>
                <td width="10%">
                    <asp:Label ID="lblFrom" runat="server" Text="ShipDate:" CssClass="iMes_label_13pt" style="float:right"></asp:Label>    
                </td>
                <td width="60%">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="PdLine:" CssClass="iMes_label_13pt" style="float:right"></asp:Label>
                </td>
                <td>
<%--                    <asp:DropDownList ID="lboxPdLine" runat="server" CssClass="CheckBoxList" 
                        Height="95%" Width="250px"></asp:DropDownList>--%>
