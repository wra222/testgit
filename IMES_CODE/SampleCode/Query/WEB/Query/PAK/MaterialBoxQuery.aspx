<%@ Page Title="MaterialBoxQuery" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="MaterialBoxQuery.aspx.cs" Inherits="Query_PAK_MaterialBoxQuery" EnableEventValidation="false" %>
...
<fieldset id="grpCarton" style="border: thin solid #000000;">
    <legend align ="left" style ="height :20px" >
       <asp:Label ID="lblTitle" runat="server" Text="MaterailBox" CssClass="iMes_label_13pt"></asp:Label></legend> 
