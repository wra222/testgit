<%@ Page Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="eSOPQuery.aspx.cs" Inherits="Query_eSOPQuery" %>
 ...
 <center>
        <fieldset style="border: solid #000000">
            ...
            <tr>                                    
                ...
                <div style="float:left; padding: 10px 0 0 10px; margin: 0 auto;">   
                     ...
                     <ContentTemplate>                                          
                         ...
                         &nbsp;&nbsp;&nbsp;&nbsp;
                         <asp:Label ID="lblSn" runat="server" Text="ProID\CustSN:" Width="100px" CssClass="iMes_label_13pt"></asp:Label>                  
                         <asp:TextBox ID="tbProID" runat="server"></asp:TextBox>   
                     <br />                     
