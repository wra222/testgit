<%@ Page Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="BsamLocationQuery.aspx.cs" Inherits="Query_PAK_BsamLocationQuery" %>
...
<center>
    <fieldset id="grpCarton" style="border: thin solid #000000;">
        <legend align ="left" style ="height :20px" >
            <asp:Label ID="lblTitle" runat="server" Text="Bsam Location Query" CssClass="iMes_label_13pt"></asp:Label>
        </legend> 
            <table border="0" width="100%" style="font-family: Tahoma"> 
                <tr>
                    ...
                    <td width ="10%">
                        <asp:Label ID="lblReport" runat="server" Text="Report:" CssClass="iMes_label_13pt"></asp:Label>
                    </td>
                    <td width ="20%">
