<%@ page language="C#" autoeventwireup="true" inherits="webroot_aspx_datasource_addDataServerAndDatabase, App_Web_adddataserveranddatabase.aspx.af99fe74" theme="MainTheme" %>
...
<body style="margin:5px" class="dialogBody">
    ...
    <table width="100%">
        <tr>
            ...
            <td><input id="servername" type="text" style ="width:100%" onblur="fBlur('servername')"/></td>
        </tr>
         <tr>
            <td><b>User name:</b></td>
        ...
        function fBlur(obj)
        {
            ...
            switch (obj)
            {
                case 'servername' :
                    ...
                    {
//                        if (!isRegulationLoginName(info))
//                        {
//                            
//                            alert("The type of input don't  ");
//                        }
        ...
        {
            var _dataserverId = serverId;
            com.inventec.template.manager.DataSourceManager.GetDataSourceConnectInfo(_dataserverId, serverCallback);
        }
        ...
        function serverCallback(response)
        {
            ...
            if(sources != null && typeof(sources) == "object")
            {
                ...
                document.getElementById("username").value = changeNullNotTrim(sources.getValue("<%=AttributeNames.DATA_SERVER_USERNAME %>"));
        ...
        {
            var obj = webroot_aspx_datasource_addDataServerAndDatabase.GetEmptyDataBaseList();
            if (obj.error != null)
            {
        ...
        function getDataSource()
        {
            ...
            var obj = com.inventec.template.manager.DataSourceManager.GetSourceSettingDatabaseList(serverInfo,"");
