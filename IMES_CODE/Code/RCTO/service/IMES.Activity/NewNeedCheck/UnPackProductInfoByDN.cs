...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class UnPackProductInfoByDN : BaseActivity
	{
        /// <summary>
        /// 构造函数
        /// </summary>
        public UnPackProductInfoByDN()
		{
			InitializeComponent();
		}
        ...
        /// </summary>
        public static DependencyProperty InfoTypeProperty = DependencyProperty.Register("InfoType", typeof(string), typeof(UnPackProductInfoByDN));

        /// <summary>
        /// InfoType of ProductInfo to delete
        /// </summary>
        [DescriptionAttribute("InfoType")]
        [CategoryAttribute("InArguments Of UnPackProductInfoByDN")]
        ...
        public string InfoType
        {
            get
            {
                return ((string)(base.GetValue(UnPackProductInfoByDN.InfoTypeProperty)));
            }
            set
            {
                base.SetValue(UnPackProductInfoByDN.InfoTypeProperty, value);
            }
        }
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            productRepository.BackUpProductInfo(currentProduct.ProId, this.Editor, InfoType);
