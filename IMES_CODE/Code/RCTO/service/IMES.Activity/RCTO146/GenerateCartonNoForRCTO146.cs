...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class GenerateCartonNoForRCTO146 : BaseActivity
	{
        /// <summary>
        /// 构造函数
        /// </summary>
        public GenerateCartonNoForRCTO146()
		{
			InitializeComponent();
		}
        ...
        //    IProductRepository productRep = RepositoryFactory.GetInstance().GetRepository<IProductRepository, IProduct>();
            ...
            try
            {
              ...
              //  sinfo.cartonNo = product.CartonSN;
                ...
                CurrentSession.AddValue(Session.SessionKeys.CartonSN, CartonNO);
