...
namespace IMES.Activity
{
    ...
    public partial class AcquireChildMBSn : BaseActivity
    {
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            int qty = (int)CurrentSession.GetValue(Session.SessionKeys.MultiQty);
            ...
            for (int i = 1; i <= qty; i++)
            {
                string childMBSn = PreMBSn + i.ToString() + endMBSn;
                childMBSnList.Add(childMBSn);
            }
            CurrentSession.AddValue(Session.SessionKeys.MBNOList, childMBSnList);
            CurrentSession.AddValue(Session.SessionKeys.PrintLogBegNo, childMBSnList[0]);
            CurrentSession.AddValue(Session.SessionKeys.PrintLogEndNo, childMBSnList[qty-1]);
