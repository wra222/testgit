...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class AcquireMACList : BaseActivity
    {
        /// <summary>
        /// 
        /// </summary>
        public AcquireMACList()
        {
            InitializeComponent();
        }
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            if (macValue == "T")
            {
                ...
                IList<string> macList = new List<string>();
                ...
                CurrentSession.AddValue(Session.SessionKeys.MACList, macList);
