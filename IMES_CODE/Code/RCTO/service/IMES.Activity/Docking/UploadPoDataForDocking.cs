    ...
    public partial class UploadPoDataForDocking : BaseActivity
    {
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            foreach (Pallet ele in palletList)
            {
                ...
                {
                    /*
                    * Answer to: ITC-1414-0175
                    * Description: Removed related Delivery_Pallet records.
                    */
                    deliveryRepository.DeleteDeliveryPalletByPalletNoDefered(CurrentSession.UnitOfWork, ele.PalletNo);
                    palletRepository.Remove(ele, CurrentSession.UnitOfWork);
                }
            ...
            //<UC:2.20>本次导入的Model 以'PO'开头的Delivery，需要同步上传信息到整机数据库，如果在整机的数据库中的Delivery/DeliveryInfo/Delivery_Pallet/Pallet 表中存在，则需要将整机的数据库中的Delivery/DeliveryInfo/Delivery_Pallet/Pallet 表中的对应记录删除后再上传
