...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class CheckStatusForDocking : BaseActivity
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public CheckStatusForDocking()
        {
            InitializeComponent();
        }
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
             ...
             string qcStatus = (lstQCStatus != null && lstQCStatus.Count != 0) ? lstQCStatus[0].Status : string.Empty;
             ProductStatus Status	= currentProduct.Status;

             if (qcStatus == "7" || qcStatus == "4" || Status.Status == 0)
             {
                 //errpara.Add("已经不良，请先修护");
                 errpara.Add(currentProduct.ProId);
                 throw new FisException("CHK871", errpara);
             }
