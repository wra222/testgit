...
namespace IMES.Activity
{
    ...
    /// <para>
    /// 应用场景：
    ///         应用于052VirtualPallet.xoml
    /// </para>
    /// <para>
    /// 实现逻辑：
    ///         1.获取Virtual Pallet Number最大值;
    ///         2.产生指定机型的Virtual Pallet Number;
    ///         3.更新Virtual Pallet Number最大值;
    ///</para> 
    /// <para> 
    /// 异常类型：
    ///         1.系统异常：
    ...
    /// </para> 
    /// </remarks>
    public partial class AcquireVirtualPalletSection : BaseAcquireActivity
	{
        private static object _syncRoot_GetSeq = new object();

        public AcquireVirtualPalletSection()
		{
			InitializeComponent();
		}
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            //this.AddTemplatesOfAType("VirtualPallet", new IConverter[] {    new YearConverterNormal(2,'0',Session.SessionKeys.presentTime),
            //                                                                new MonthConverter(2,'0',Session.SessionKeys.presentTime),
            //                                                                new DayConverterNormal(2,'0',Session.SessionKeys.presentTime),
            //                                                                new SequenceConverterNormal("0123456789",3,"999","000",'0')
            //                                                            });
            ...
            CurrentSession.AddValue(Session.SessionKeys.VirtualPalletNoList, this.GetAllNumbersInRange(snrs, seqCvt, qty, preSeqStr));
        ...
        {
            return GeneratesConstants.VirtualPallet;
        }
