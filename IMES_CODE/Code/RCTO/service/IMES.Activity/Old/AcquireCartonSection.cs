...
namespace IMES.Activity
{
    ...
    /// <para>
    /// 应用场景：
    ///         应用于053CombinePOInCarton.xoml
    /// </para>
    /// <para>
    /// 实现逻辑：
    ///         1.获取Carton Number最大值;
    ///         2.产生指定机型的Carton Number;
    ///         3.更新Carton Number最大值;
    ///</para> 
    /// <para> 
    /// 异常类型：
    ///         1.系统异常：
    ...
    /// </para> 
    /// </remarks>
    public partial class AcquireCartonSection : BaseAcquireActivity
	{
        private static object _syncRoot_GetSeq = new object();

        public AcquireCartonSection()
		{
			InitializeComponent();
		}
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            //this.AddTemplatesOfAType("Carton", new IConverter[] {   new CommonConverter(2,'0',Session.SessionKeys.CN),
            ...
            //this.AddTemplatesOfAType("Carton", new IConverter[] {   new CommonConverter(3,'0',Session.SessionKeys.AXH),
            //                                                        new YearConverterNormal(1,'0',Session.SessionKeys.presentTime),
            ...
            CurrentSession.AddValue(Session.SessionKeys.AXH, "AXH");
            ...
            CurrentSession.AddValue(Session.SessionKeys.CartonNoList, this.GetAllNumbersInRange(snrs, seqCvt, qty, preSeqStr));
        ...
        {
            return GeneratesConstants.Carton;
        }
