...
namespace IMES.Station.Interface.StationIntf
{
    ...
    public interface ICombinePOInCarton
    {
        ...
        /// <returns>返回ProductModel</returns>
        ProductModel ScanSN(string productID, string uutSN);
        ...
        /// <param name="customer"></param>
        /// <returns></returns>
        void Save(IList<string> NewScanedProductIDList, IList<string> NewScanedModelList,IList<string> custSNList,string line, string editor, string station, string customer);
