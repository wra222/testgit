...
namespace IMES.Station.Interface.StationIntf
{
    public interface IAssetTagLabelPrint
    {
        ...
        IList<PrintItem> Print(string custsn, string pdLine, string stationId, string editor, string customerId, IList<PrintItem> printItems);
        ...
        IList<PrintItem> RePrint(string custsn, string pdLine, string stationId, string editor, string customerId, string reason, IList<PrintItem> printItems, out string ErrorFlag, out string imageURL);
