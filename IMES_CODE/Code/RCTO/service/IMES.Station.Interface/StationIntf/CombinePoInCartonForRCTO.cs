...
namespace IMES.Station.Interface.StationIntf
{
    ...
    /// </summary>
    public interface ICombinePoInCartonForRCTO
    {
        ...
        /// <returns></returns>
        ArrayList InputSN(string inputSN, string model, string firstProID, string line, string editor, string station, string customer);
