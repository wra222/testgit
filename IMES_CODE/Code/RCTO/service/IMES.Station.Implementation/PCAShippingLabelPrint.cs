...
namespace IMES.Station.Implementation
{
    ...
    public class PCAShippingLabelPrint : MarshalByRefObject, IPCAShippingLabelPrint 
    {
        ...
        /// <returns></returns>
        public IList InputMBSNo(string pdLine, string MBSNo, string checkPCMBRCTOMB, string station, string editor, string customerId, string model)
        {
            logger.Debug("(PCAShippingLabelPrint)InputMBSNo start, pdLine:" + pdLine + " MBSNo:" + MBSNo + " editor:" + editor + " station:" + station + " customerId:" + customerId + " Modle:" + model);
            ...
            try
            {
                ...
                ret.Add(mb.Family == null ? "" : mb.Family);
                ret.Add(mb.PCBModelID == null ? "" : mb.PCBModelID);
                ret.Add(mb.MAC);
                ret.Add(mb.IECVER);
                ret.Add(mb.ECR);
            ...
            {
                logger.Debug("(PCAShippingLabelPrint)InputMBSNo end, pdLine:" + pdLine + " MBSNo:" + MBSNo + " editor:" + editor + " station:" + station + " customerId:" + customerId + " Modle:" + model);
            }
        }
        ...
        /// <returns></returns>
        public ArrayList save(string MBno, string dcode, string region, IList<PrintItem> printItems)
        {
            logger.Debug("(PCAShippingLabelPrint)save start, MBno:" + MBno + "dcode:" + dcode);
            ...
            {
                logger.Debug("(PCAShippingLabelPrint)save end, MBno:" + MBno + "dcode:" + dcode);
            }
        }
