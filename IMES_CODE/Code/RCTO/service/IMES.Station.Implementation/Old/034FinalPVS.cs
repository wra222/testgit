...
// Description:  FinalPVS bll
//                         
// Update: 
// Date         Name                         Reason 
// ==========   =======================      ============
// 2010-03-10   Yuan XiaoWei                 create
// 2010-04-16   Yuan XiaoWei                 ITC-1155-0047
// Known issues:
using System;
...
{
    /// <summary>
    /// 实现IFinalPVS接口，Final PVS BLL实现类,实现Final PVS站检料功能
    /// </summary>
    public class FinalPVS : MarshalByRefObject, IFinalPVS
    {
        private ILog logger = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        private const Session.SessionType currentSessionType = Session.SessionType.Product;

        #region IFinalPVS Members
        ...
        /// <returns></returns>
        IMES.DataModel.ProductModel IFinalPVS.InputUUT(string custSN, string line, string editor, string station, string customer)
        {
            ...
            try
            {
                ...
                if (currentSession == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(station, "034FinalPVS.xoml", "034FinalPVS.rules", out wfName, out rlName);
        ...
        /// <returns></returns>
        IList<MatchedPartOrCheckItem> IFinalPVS.CheckPartAndItem(string productID, string checkValue)
        {
        ...
        /// <returns></returns>
        IList<IMES.DataModel.PrintItem> IFinalPVS.Save(string productID, IList<IMES.DataModel.PrintItem> printItems)
        {
        ...
        void IFinalPVS.Cancel(string sessionKey)
        {
            try
            {
        ...
        /// <param name="productID"></param>
        /// <returns></returns>
        IList<IMES.DataModel.BomItemInfo> IFinalPVS.GetNeedCheckPartAndItem(string productID)
        {
            logger.Debug("GetNeedCheckPartAndItem start, ProductID:" + productID);
