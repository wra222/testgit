 ...
 * Description: Final parts collection interface implement
 *             
 * Update: 
 * Date       Name                  Reason 
 * ========== ===================== =====================================
 * 2009-10-20  Zhao Meili(EB)        Create 
 * 200910-201005  itc207013          ITC-1122-0158,ITC-1122-0166
 *                                   ITC-1122-0174,ITC-1122-0229
 *                                   ITC-1122-0265,ITC-1122-0267
 *                                   ITC-1122-0275,ITC-1122-0315
 *                                   ITC-1122-0318
 *                                   
 * Known issues:
 */
...
{
    public class FinalPartsCollection:MarshalByRefObject, IFinalPartsCollection
    {
        private static readonly Session.SessionType theType = Session.SessionType.Product;
        private const string WFfile = "018FinalPartsCollection.xoml";
        private const string Rulesfile = "018FinalPartsCollection.rules";
        ...
        {
            logger.Debug("(FinalPartsCollection)InputProdId start,"
                          + " [prodId]:" + prodId
                          + " [pdLine]:" + pdLine
                          + " [editor]:" + editor
                          + " [station]:" + stationId
            ...
            {
                logger.Debug("(FinalPartsCollection)InputProdId End,"
                                          + " [prodId]:" + prodId
                                          + " [pdLine]:" + pdLine
                                          + " [editor]:" + editor
                                          + " [station]:" + stationId
        ...
        public IList<MatchedPartOrCheckItem> InputPPID(
            ...
            string ppid)
        {
            logger.Debug("(FinalPartsCollection)InputPPID start,"
               + " [prodId]: " + prodId
               + " [ppid]:" + ppid);
            FisException ex;
            List<string> erpara = new List<string>();
            ...
            {
                logger.Debug("(FinalPartsCollection)InputPPID  End,"
                               + " [prodId]: " + prodId
                               + " [ppid]:" + ppid);
            }
        }
        ...
        {
            logger.Debug("(FinalPartsCollection)Save start,"
               + " [prodId]: " + prodId);
            FisException ex;
            List<string> erpara = new List<string>();
            try
            ...
            {
                logger.Debug("(FinalPartsCollection)Save  End,"
                               + " [prodId]: " + prodId);
            }
        }
