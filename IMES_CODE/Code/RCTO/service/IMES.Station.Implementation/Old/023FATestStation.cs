...
{
    public class _FATestStation: MarshalByRefObject, IFATestStation 
    {
        ...
        public string InputCustsn(out string pdLine, string testStation, string custsn, string editor, string customerId, out string defectStation, out bool isAllowPass, out string LastStation)
        {
           ...
           string descr = "";
            ...
            logger.Debug("(_FATestStation)InputProdId start, pdLine:" + pdLine + " testStation:" + testStation + " custsn:" + custsn + " editor:" + editor + " customerId:" + customerId);
            ...
            try
            {
                ...
                if (_Session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(testStation, "023FATestStation.xoml", "023FATestStation.rules", out wfName, out rlName);
            ...
            {
                logger.Debug("(_FATestStation)InputProdId end, pdLine:" + pdLine + " testStation:" + testStation + " custsn:" + custsn + " editor:" + editor + " customerId:" + customerId);
            }
        ...
        {
            logger.Debug("(_FATestStation)InputProdId start, pdLine:" + pdLine + " testStation:" + testStation + " prodId:" + prodId + " editor:" + editor + " customerId:" + customerId);
            ...
            {
                logger.Debug("(_FATestStation)InputProdId end, pdLine:" + pdLine + " testStation:" + testStation + " prodId:" + prodId + " editor:" + editor + " customerId:" + customerId);
            }
        }
        ...
        {
            logger.Debug("(_FATestStation)InputDefectCodeList start, prodId:" + prodId );
            ...
            {
                logger.Debug("(_FATestStation)InputDefectCodeList end, prodId:" + prodId);
