 ...
 * Description: PCARepairOutputImpl
 * Update: 
 * Date         Name              Reason 
 * ==========   ================= =====================================
...
{
    /// <summary>
    /// IPCARepairOutput接口的实现类
    /// </summary>
    public class PCARepairOutputImpl : MarshalByRefObject, IPCARepairOutput
    {
        ...
        public void PCARepairOutput(string pdLine, string MB_SNo, string editor, string stationId, string customer)
        {
            logger.Debug("(PCARepairOutputImpl)PCARepairOutput start, MB_SNo:" + MB_SNo);
            FisException ex;
            ...
            try
            {
                ...
                if (session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(stationId, "PCARepairOutput.xoml", string.Empty, out wfName, out rlName);
            ...
            {
                logger.Debug("(PCARepairOutputImpl)PCARepairOutput end, MB_SNo:" + MB_SNo);
            }  
        }
