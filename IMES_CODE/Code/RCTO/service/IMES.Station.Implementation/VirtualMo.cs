...
// Description: PAK Virtual MO Interface
// UI:CI-MES12-SPEC-PAK-UI Virtual MO.docx
// UC:CI-MES12-SPEC-PAK-UC Virtual MOt.docx                           
// Update: 
// Date         Name                         Reason 
// ==========   =======================      ============
// 2011-12-09   Chen Xu itc208014            create
// 
// UC Revision:6789
// Known issues:
...
namespace IMES.Station.Implementation
{
    ...
    /// </summary> 
    public class VirtualMo : MarshalByRefObject, IVirtualMo, IModel
    {
        ...
        /// <param name="stationId">stationId</param>
        /// <param name="customerId">customerId</param>
        public void CreateNewVirtualMo(string model, int qty, string pCode, string startDate, string editor, string pdLine, string stationId, string customerId, string MOPrefix)
        {
            logger.Debug("(VirtualMo)CreateNewVirtualMo start, model:" + model + "qty:" + qty + " editor:" + editor + " stationId:" + stationId + " customerId:" + customerId + " MOPrefix:" + MOPrefix);
            ...
            try
            {
                ...
                if (Session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(stationId, "102VirtualMo.xoml", "102VirtualMo.rules", out wfName, out rlName);
                    ...
                    Session.AddValue(Session.SessionKeys.VirtualMOIdentifier, MOPrefix);
            ...
            {
                logger.Debug("(VirtualMo)CreateNewVirtualMo end, model:" + model + "qty:" + qty + " editor:" + editor + " stationId:" + stationId + " customerId:" + customerId + " MOPrefix:" + MOPrefix);
            }
        }
