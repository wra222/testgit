...
namespace IMES.Station.Implementation
{
    ...
    public partial class TravelCardPrint2012 : MarshalByRefObject, ITravelCardPrint2012, IMO
    {
        ...
        public string GetProductID(string LCMCT)
        {
            ...
            try
            {
                logger.Debug("(TravelCardPrint)GetProductID start, LCMCT:"+LCMCT);

                string strSql = @"select ProductID 
                                    from Product_Part
                                    where CheckItemType='LCM' 
                                    and PartSn =@CT ";
                SqlParameter paraName = new SqlParameter("@CT", SqlDbType.VarChar, 32);
                paraName.Direction = ParameterDirection.Input;
                paraName.Value = LCMCT;
                DataTable dt = SqlHelper.ExecuteDataFill(SqlHelper.ConnectionString_GetData,
                ...
                {
                    throw new Exception("錯誤的LCM CT:"+ LCMCT + "請洽IE人員...");
                }
            ...
            {
                logger.Debug("(TravelCardPrint)GetProductID end, LCMCT:" + LCMCT);
