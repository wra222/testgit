 ...
 * 2012-04-12   Li.Ming-Jun       ITC-1360-1677
 * 
 * 
...
namespace IMES.Station.Implementation
{
    ...
    /// VGALabelPrint
    /// </summary>
    public class VGALabelPrint : MarshalByRefObject, IVGALabelPrint, ISMTMO
    {
        ...
        {
            logger.Debug("(VGALabelPrint)Print start, pdLine:" + pdLine + " isNextMonth:" + isNextMonth.ToString() + " mo:" + mo + " qty:" +qty.ToString()+" dateCode:"+dateCode+ " editor:" + editor +" stationId:"+stationId+ " customerId:" + customerId);
            ...
            try
            {
                ...
                if (Session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(stationId, "VGALabelPrint.xoml",  string.Empty, out wfName, out rlName);
                    ...
                    Session.AddValue(Session.SessionKeys.PrintLogName, "VB");
                ...
                MBNOList = (IList)Session.GetValue(Session.SessionKeys.MBNOList);

                IList<string> mbList = new List<string>();

                foreach (string mbSno in MBNOList)
                {
                    mbList.Add(mbSno);
                }
                startProdIdAndEndProdId = mbList;
            ...
            {
                logger.Debug("(VGALabelPrint)Print end, pdLine:" + pdLine + " isNextMonth:" + isNextMonth.ToString() + " mo:" + mo + " qty:" + qty.ToString() + " dateCode:" + dateCode + " editor:" + editor + " stationId:" + stationId + " customerId:" + customerId);
        ...
        {
            logger.Debug("(VGALabelReprint)Reprint start, MBSno:" + mbSno + " Reason:" + reason + " editor:" + editor + " station:" + stationId + " customerId:" + customerId);
            FisException ex;
            List<string> erpara = new List<string>();
            ...
            try
            {
                ...
                if (Session == null)
                {
                    ...
                    string wfName, rlName;
                    RouteManagementUtils.GetWorkflow(stationId, "VGALabelReprint.xoml", string.Empty, out wfName, out rlName);
                    WorkflowInstance instance = WorkflowRuntimeManager.getInstance.CreateXomlFisWorkflow(wfName, rlName, wfArguments);
                    //WorkflowInstance instance = WorkflowRuntimeManager.getInstance.CreateXomlFisWorkflow("002VGALabelReprint.xoml", null, wfArguments);
                    Session.AddValue(Session.SessionKeys.MBMONO, mbSno);
                    Session.AddValue(Session.SessionKeys.MBSN, mbSno);
                    Session.AddValue(Session.SessionKeys.PrintItems, printItems);
                    Session.AddValue(Session.SessionKeys.PrintLogName, "VGALabel");
            ...
            {
                logger.Debug("(VGALabelReprint)Reprint end, MBSno:" + mbSno + " Reason:" + reason + " editor:" + editor + " customerId:" + customerId);
            }
        }
