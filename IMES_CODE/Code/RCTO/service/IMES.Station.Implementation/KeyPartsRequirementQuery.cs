...
namespace IMES.Station.Implementation
{
    ...
    /// 
    /// </summary>
    public partial class KeyPartsRequirementQuery : MarshalByRefObject, IKeyPartsRequirementQuery
    {
        private ILog logger = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        //private static readonly Session.SessionType theType = Session.SessionType.Common;


        #region IKeyPartsRequirementQuery Members
        /// <summary>
        /// 
        /// </summary>
        ...
        public DataTable KeyPartQuery(string models, out string outputmodels)
        {
            ...
            dt = productRepository.ExecSpForQuery(SqlHelper.ConnectionString_FA, "op_FAKitting_KPRequirement", paramsArray);
