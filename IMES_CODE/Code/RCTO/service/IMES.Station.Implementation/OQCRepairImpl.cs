...
namespace IMES.Station.Implementation
{
    ...
    /// IOQCRepair接口的实现类
    /// </summary>
    public class OQCRepairImpl : MarshalByRefObject, IOQCRepair 
    {
        ...
        public IList<RepairInfo> InputProdId(string pdLine, string prodId, string editor, string stationId, string customer)
        {
            ...
            try
            {
                ...
                if (session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(stationId, "OQCRepair.xoml", "OQCRepair.rules", out wfName, out rlName);
