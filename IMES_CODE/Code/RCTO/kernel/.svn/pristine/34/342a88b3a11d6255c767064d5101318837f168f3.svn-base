...
namespace IMES.CheckItemModule.JSGraphicCard.Filter
{
    [Export(typeof(IFilterModule))]
    [ExportMetadata("ProgramName", "IMES.CheckItemModule.JSGraphicCard.Filter.dll")]
    public class Filter : IFilterModule, ITreeTraversal
    {
        private const string part_check_type = "JSGraphicCard";
...
//                                                    }
        ...
        public bool CheckCondition(object node)
        {
            ...
            return ((BOMNode)node).Part.Descr.Trim().StartsWith("GraphicCard");
