...
namespace IMES.CheckItemModule.WWAN.Filter
{
    ...
    class MatchModule : IMatchModule
    {
        public object Match(string subject, object bomItem, string station)
        {
            ...
            // 二维码CT: GERMP552E7HOUR MEID: 35933905006484 IMEI: 359339050064848 
           
            if (subject.Contains("CT ") && subject.Length >= 18)
                {
                    vendor_code = subject.Substring(subject.IndexOf("CT ") + 3, 14);
                }
