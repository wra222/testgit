...
namespace IMES.CheckItemModule.CQ.CheckSlateBase.Filter
{
    ...
    {
        private int qty = 1;
        private string part_check_type = "CheckSlateBase";
        ...
        public object FilterBOM(object hierarchical_bom, string station, object main_object)
        {
            ...
            try
            {
                  IProduct product = GetProduct(main_object);
                   string virtualPN = "CheckSlateBase" + "/" ;
                    string descr = "CheckSlateBase";
                    IPart part = new Part()
                    {
                    ...
                    flat_bom_item.ValueType = product.ProId; //存放Part match時檢查的值
