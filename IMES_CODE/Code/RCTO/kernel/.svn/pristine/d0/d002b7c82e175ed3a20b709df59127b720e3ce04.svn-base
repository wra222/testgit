...
namespace IMES.CheckItemModule.Frame.Filter
{
    [Export(typeof(ISaveModule))]
    [ExportMetadata("ProgramName", "IMES.CheckItemModule.Frame.Filter.dll")]
    class SaveModule : ISaveModule
    {
        public void Save(object part_unit, object part_owner, string station, string key)
        {
            ...
            ////else
            ////{
            ////    throw new FisException("CHK174", new string[] { "IMES.CheckItemModule.Frame.Filter.SaveModule.Save" });
            ////}
        }
    }
}
