...
namespace IMES.CheckItemModule.BirchLCM.Filter
{
    [Export(typeof(IFilterModule))]
    [ExportMetadata("ProgramName", "IMES.CheckItemModule.BirchLCM.Filter.dll")]
    public class Filter : IFilterModule, ITreeTraversal
    {
        private const string part_check_type = "BirchLCM";
...
//                                                    }
        ...
        public bool CheckCondition(object node)
        {
            ...
            return true;
            return ((BOMNode)node).Part.Descr.Trim().StartsWith("Tablet LCM");
