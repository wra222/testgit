...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"  ContentType="text/html;Charset=UTF-8" EnableEventValidation = "false" AutoEventWireup="true" CodeFile="GenerateSMTMO.aspx.cs" Inherits="SA_GenerateSMTMO" Title="Untitled Page" %>
...
<div>
    ...
    <tr>
        ...
        <td style="width:35%" align="left"><iMES:CmbMBCodeSMTMO ID="CmbMBCode" runat="server" Width="100" IsPercentage="true"/></td> 
        <td style="width:5%">&nbsp;</td>       
