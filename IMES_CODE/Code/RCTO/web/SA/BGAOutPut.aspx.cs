...
public partial class FA_BGAOutput : IMESBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!this.IsPostBack)
            {
                ...
                this.CmbStation.PalletType = "ReworkStation";
                this.CmbStation.OrderBy = "ID";
                setFocus();
            }
        }
    ...
    private void initLabel()
    {
        ...
        this.btnAddNew.InnerText = this.GetLocalResourceObject(Pre + "_btnAddNew").ToString();
