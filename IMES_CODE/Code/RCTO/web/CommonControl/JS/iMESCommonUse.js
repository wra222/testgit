...
//        }
        //bat print
        PrintService.getBatContent(printItem, MasterPCode, getBatContentForSerialSuccCallBack, getBatContentForSerialFailCallBack);
    }
...
//        }
        //bat print
        PrintService.getBatContent(printItem, MasterPCode,getBatContentForConcurrentSuccCallBack, getBatContentForConcurrentFailCallBack);
    }
    else if (printMode == 1 || printMode == 4) 
    {
        //template print
                    ...
                    case ("MB"):
                        {
                            ...
                            if ((sn.length == 11) && (sn.substr(4, 1) == "M" || sn.substr(4, 1) == "B")) {
                                return sn.substring(0, 10);
                            }
                            else if ((sn.length == 10) && (sn.substr(4, 1) == "M" || sn.substr(4, 1) == "B")) {
                                return sn.substring(0, 10);
                            }
                            else if ((sn.length == 11) && (sn.substr(5, 1) == "M" || sn.substr(5, 1) == "B")) {
...
function CheckCustomerSN(sn) {
	...
	if(sn.length==11 && sn.substr(0,1)=='S')
		sn = sn.substr(1,10);
return (regxSH.test(sn) || regxSH7cd.test(sn) || regxCQ.test(sn) || regxCQ2.test(sn) || regxCQ8cn.test(sn));
}
function CheckCustomerSNinPizza(sn) {
    ...
    return (regxSH.test(sn) || regxSH7cd.test(sn) || regxCQ8cn.test(sn))
}
