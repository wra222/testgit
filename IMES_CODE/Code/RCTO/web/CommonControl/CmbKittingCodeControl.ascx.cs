...
//Date         Name                Reason 
//==========   ==================  =====================================    
//2010-04-15   Lucy.Liu(EB1)  create
...
public partial class CommonControl_CmbKittingCodeControl : System.Web.UI.UserControl
{
    //combobox宽度
    ...
    IKittingCode iKittingCode = ServiceAgent.getInstance().GetObjectByName<IKittingCode>(WebConstant.CommonObject);
    ...
    protected void initDropReason()
    {
        ...
        if (iKittingCode != null)
        {
            IList<KittingCodeInfo> lst = iKittingCode.GetKittingCodeList();
    ...
    private void initControl(IList<KittingCodeInfo> lst)
    {


        foreach (KittingCodeInfo temp in lst)
        {
            this.DropDownList1.Items.Add(new ListItem(temp.friendlyName, temp.id));
        }
    }
