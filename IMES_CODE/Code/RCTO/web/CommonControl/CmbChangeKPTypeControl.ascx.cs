//Description: Key part type DropdownList
//Update: 
//Date         Name                Reason 
//==========   ==================  =====================================    
...
public partial class CommonControl_CmbChangeKPTypeControl : System.Web.UI.UserControl
{
    //combobox宽度
    ...
    IChangeKPType iChangeKPType = ServiceAgent.getInstance().GetObjectByName<IChangeKPType>(WebConstant.CommonObject);
    ...
    protected void initDropReason()
    {
        ...
        if (iChangeKPType != null)
        {
            IList<ConstValueInfo> lst = iChangeKPType.GetChangeKPTypeList();
    ...
    private void initControl(IList<ConstValueInfo> lst)
    {
        ...
        {
            this.DropDownList1.Items.Add(new ListItem(temp.name, temp.value));
        }
    }
