...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"  ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="TravelCardPrint_CR.aspx.cs" Inherits="TravelCardPrint_CR" %>
...
<div>
    <asp:ScriptManager ID="ScriptManager1" runat="server" >
        <Services>
            <asp:ServiceReference Path="Service/WebServiceTravelCard_CR.asmx" />
        </Services>
    </asp:ScriptManager>
    <center>
        ...
        {            
            ...
            ShowInfo(content);          
             ...
             if (result[3].length > 1) {
                 beginProid = result[3][0];
                 endProid = result[3][result[3].length -1];
             }
             else {
                 beginProid = result[3][0];
                 endProid = beginProid
