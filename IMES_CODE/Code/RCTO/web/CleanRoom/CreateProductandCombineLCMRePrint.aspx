...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="CreateProductandCombineLCMRePrint.aspx.cs" Inherits="CreateProductandCombineLCMRePrint" %>
            ...
            if (!errorFlag) {
                ...
                try {
                    ...
                    if (lstPrintItem == null)                 //判断 若PrintItem==null, 不继续打印，等待客户维护PrintSetting页面后，再刷入打印
                    {
                        ...
                        WebServiceCreateProductandCombineLCM.RePrint(inpuProdid, reason, line, editor, station, customer, pCode, lstPrintItem, onSucceed, onFail);
                    }
                }
                catch (e1) {
