<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReprintTouchGlass.aspx.cs" Inherits="CleanRoom_ReprintTouchGlass" Title="Untitled Page" %>
...
<div>
    ...
    <TR>
	    <TD style="width:15%" align="left"><asp:Label ID="lblProdID" runat="server" Text="CT:" CssClass="iMes_label_13pt"></asp:Label></TD>
...
<script type="text/javascript">
    ...
    function onSucceed(result) {
        try {
            ...
            setPrintItemListParam(result[0], result[1]);
