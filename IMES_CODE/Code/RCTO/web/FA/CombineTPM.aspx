...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8"
    AutoEventWireup="true" CodeFile="CombineTPM.aspx.cs" Inherits="FA_CombineTPM" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        <Services>
            <asp:ServiceReference Path="~/FA/Service/WebServiceCombineTPM.asmx" />
        </Services>
    </asp:ScriptManager>
    ...
    <script type="text/javascript">
        ...
        function inputCustomSNorProdId(inputData) 
        {
            ...
            else 
            {
                ...
                WebServiceCombineTPM.inputSN(customerSN, line, stationId, editor, stationId, customer, onCustSNSucc, onCustSNFail);
            }
        }
...
//              if (inputData.length == 14) {
                ...
                beginWaitingCoverDiv();
                WebServiceCombineTPM.inputVenderCT(productID, inputData.trim(), onVenderCTSucc, onVenderCTFail);
...
//            }
            ...
            //setScroll(matchDataItem[1], matchDataItem[2]);//1--PN;2--CT
             try {
                    ...
                    if (subFindFlag) 
                    {
                        ...
                        {
                            beginWaitingCoverDiv();
                            WebServiceCombineTPM.save(productID, onSaveSuccess, onSaveFail);
                        }
                    }
                    else 
                    {
        ...
        function OnCancel() {
            if (productID != "") {
                ...
                WebServiceCombineTPM.Cancel(productID);
            }
        }
