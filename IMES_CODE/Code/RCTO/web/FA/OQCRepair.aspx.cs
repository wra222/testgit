...
public partial class FA_OQCRepair : IMESBasePage 
{
    ...
    private IOQCRepair iOQCRepair;
    private string commBllName = WebConstant.CommonObject;
    private string repairBllName = WebConstant.OQCRepairObject;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            repairServiceObj = ServiceAgent.getInstance().GetObjectByName<IOQCRepair>(repairBllName);
            commServiceObj = ServiceAgent.getInstance().GetObjectByName<IRepair>(commBllName);

            iOQCRepair = (IOQCRepair)repairServiceObj;
    ...
    protected void hidbtnforexcel_ServerClick(Object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            HSSFCell cell = sheet.CreateRow(4).CreateCell(0);
