 ...
 * Date       Name                  Reason 
 * ========== ===================== =====================================
 * 2012-06-15 Kerwin                Create      
 * Known issues:
 */
 --%>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ChangeModel.aspx.cs" Inherits="FA_ChangeModel" %>

<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        <Services>
            <asp:ServiceReference Path="~/FA/Service/ChangeModelWebService.asmx" />
        </Services>
    </asp:ScriptManager>
            ...
            switch (InputDataLength) {
                case 12:
                    if (document.getElementById("InputModel1").innerText == "") {
                        ...
                        ChangeModelWebService.InputModel1(InputData, editor, line, station, customer, InputModel1Succeed);
