...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8"
    AutoEventWireup="true" CodeFile="LCMRepair.aspx.cs" Inherits="FA_LCMRepair" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:UpdatePanel runat="server" ID="UpdatePanel3" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Label ID="txtStation" runat="server" CssClass="iMes_label_13pt" />
                            </ContentTemplate>
                        </asp:UpdatePanel>                      
                    </td>
                    <td />
                    ...
                    <td align="left">
                        <asp:UpdatePanel runat="server" ID="UpdatePanel4" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Label ID="txtLine" runat="server" CssClass="iMes_label_13pt" />
                            </ContentTemplate>
                        </asp:UpdatePanel>                      
                    </td>
                </tr>      
    ...
    <script type="text/javascript">        
        ...
        var url = "LCMRepairLogAddEdit.aspx?Customer=<%=Customer %>";
        var status;
        var editor = "<%=UserId %>";
        ...
        function finishRepair() {
            ...
            LCMRepairService.save(globalID, saveSucc, saveFail);
        }
        ...
        function clearSession() {
            if (globalID != "") {
                LCMRepairService.cancel(globalID);
            }
        }
