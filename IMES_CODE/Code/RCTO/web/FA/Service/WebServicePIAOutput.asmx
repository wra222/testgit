...
{
    private PIAOutput iPIAOutput;
    private Object oqcOutputServiceObj;
    private string commBllName = WebConstant.CommonObject;
    private string PiaOutputBllName = WebConstant.PIAOutputObject;
    ...
    public IList input(string pdLine, string prodId, string editor, string station, string customer)
    {
        ...
        try
        {
            oqcOutputServiceObj = ServiceAgent.getInstance().GetObjectByName<PIAOutput>(PiaOutputBllName);
            custsn = prodId;
            iPIAOutput = (PIAOutput)oqcOutputServiceObj;
    ...
    [WebMethod]
    public IList MVunpack(string RetStation, string CustSN, string editor, string station, string customer)
    {
        IList ret = new ArrayList();
        string outQCStatus = string.Empty;
        string preStation = string.Empty;
        ...
        try
        {
            ...
            List<string> para = iPIAOutput.MVunpack(RetStation, CustSN, editor, station, customer);
            string prodId = para[0];
