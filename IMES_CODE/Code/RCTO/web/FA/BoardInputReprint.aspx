...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="BoardInputReprint.aspx.cs" Inherits="FA_FACombineKeyPartsReprint" %>
...
<div>
    <asp:ScriptManager ID="ScriptManager1" runat="server" >
        <Services>
            <asp:ServiceReference Path="~/FA/Service/WebServiceBoardInput.asmx" />
        </Services>
    </asp:ScriptManager>
    <center>
...
<script type="text/javascript">
            ...
            if (!errorFlag) {
                ...
                try {
                    ...
                    if (lstPrintItem == null)                 //判断 若PrintItem==null, 不继续打印，等待客户维护PrintSetting页面后，再刷入打印
                    {
                        ...
                        WebServiceBoardInput.RePrint(inpuProdid, reason, line, editor, station, customer, pCode, lstPrintItem, onSucceed, onFail);
                    }
                }
                catch (e1) {
    ...
    function onSucceed(result) {
        try {
            ...
            if (result == null) {
                ...
                if (result[1][0] == "0") {
                    setPrintItemListParam1(result[1][1], result[1][2], result[1][3]);
    ...
    function setPrintItemListParam1(beginmbsn , dcode,backPrintItemList) 
    {
        ...
        valueCollection[0] = generateArray(beginmbsn);

        keyCollection[1] = "@DCode";
        valueCollection[1] = generateArray(dcode);
        
        for (var ii = 0; ii < backPrintItemList.length; ii++) {
