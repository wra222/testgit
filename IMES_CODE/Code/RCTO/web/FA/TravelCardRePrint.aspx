...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="TravelCardRePrint.aspx.cs" Inherits="TravelCardReprint" %>
...
<div>
    <asp:ScriptManager ID="ScriptManager1" runat="server" >
        <Services>
            <asp:ServiceReference Path="~/FA/Service/WebServiceTravelCardRePrint.asmx" />
        </Services>
    </asp:ScriptManager>
    <center>
