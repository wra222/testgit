...
public partial class PAK_OfflinePizzaKittingForRCTO : IMESBasePage 
{
 ...
 //   public string pcode;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       //     this.cmbModel1.InnerDropDownList.SelectedIndexChanged +=new EventHandler(cmbModel1_Selected);
            this.cmbConstValueType1.InnerDropDownList.Attributes.Add("onChange", "RemoveAllPart()");

            this.cmbModel1.InnerDropDownList.Attributes.Add("onChange", "onModelChange()");
            this.cmbPdLine.InnerDropDownList.Attributes.Add("onChange", "onLineChange()");
    ...
    private void initTableColumnHeader()
    {
        ...
        this.gd.HeaderRow.Cells[0].Width = Unit.Percentage(5);
