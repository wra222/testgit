 ...
 */
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PalletDataVerifyReprintForRCTO.aspx.cs" Inherits="PalletVerifyReprintForRCTO"  %>
         ...
         {       
          ...
          if (inputSNControl.value != "") {
             if (checkReprintReason()) {
                 ...
                 //printItemlist[0].LabelType = "DK_Travel_Card";
                 beginWaitingCoverDiv();
                 palletNo = inputSNControl.value.trim();
                 WebServicePalletVerifyForRCTO.reprint(palletNo, strReason, line, editor, station, customer, printItemlist, onSucceed, onFailed);
             }
             else {
                 getAvailableData("processDataEntry");
             }
