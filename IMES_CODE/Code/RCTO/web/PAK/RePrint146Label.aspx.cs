...
public partial class PAK_RePrint146Label : System.Web.UI.Page
{
    ...
    public static ArrayList RePrint(string ct,string reason,string editor,string station,string customer, IList<PrintItem> printItemLst)
    {
        try
        {

           ICombineCartonAndDNfor146 combine146Obj = ServiceAgent.getInstance().GetObjectByName<ICombineCartonAndDNfor146>(WebConstant.CombineCartonAndDNfor146);
           ArrayList arr= combine146Obj.RePrint(ct, reason, printItemLst,editor, station, customer);
           return arr;
        }
