...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8"
    AutoEventWireup="true" CodeFile="RePrintCombineCartonPalletFor146.aspx.cs" Inherits="PAK_RePrintCombineCartonPalletFor146"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
    ...
    <div id="container" style="width: 95%; border: solid 0px red; margin: 0 auto;">
        <div id="div1">
            <table width="100%" border="0" style="table-layout: fixed;">
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblDataEntry" runat="server" CssClass="iMes_DataEntryLabel" Text="Carton SN:"></asp:Label>
                    </td>
                    <td colspan="3">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function clkReprint() {
			...
			cartonSN = inputData;
            WebServiceCombineCartonPalletFor146.RePrint(inputData, reason, "", editor, station, customer, lstPrintItem, onPrintSucceed, onPrintFail);       
        }

        function setPrintItemListParam(backPrintItemList, palletNo, cartonSN, category) {
        ...
        function onPrintSucceed(result) {
            ...
            try {
                if (result == null) {
					...
					setPrintItemListParam(lstPrintItem, palletNo, cartonSN, category);
					printLabels(lstPrintItem, false);

                    ShowSuccessfulInfoFormat(true, "PalletNo", palletNo); // Print 成功，带成功提示音！
                }
                else {
                    ResetPage();
                    ShowMessage(result);
