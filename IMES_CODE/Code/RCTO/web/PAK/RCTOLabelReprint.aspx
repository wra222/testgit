...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="RCTOLabelReprint.aspx.cs" Inherits="RCTOLabelReprint" %>
...
<div>
    <asp:ScriptManager ID="ScriptManager1" runat="server" >
        <Services>
            <asp:ServiceReference Path="Service/RCTOLabelReprint.asmx" />
        </Services>
    </asp:ScriptManager>
    <center>
        ...
        try {
            ...
            if (!errorFlag) {
                ...
                try {
                    ...
                    RCTOLabelReprint.Reprint(inpuProdid, reason, editor, station, customer, pCode, lstPrintItem, onSucceed, onFail);                    
                }
                catch (e1) {
