...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScaningList_Upload.aspx.cs" Inherits="PAK_ScaningList_Upload" %>
...
function clientUpload() {
    document.getElementById("<%=hidFlag.ClientID %>").value = window.parent.getDocTypeCmbValue() ;
