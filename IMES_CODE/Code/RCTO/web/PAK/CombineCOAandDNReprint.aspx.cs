...
public partial class PAK_CombineCOAandDNReprint : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!this.IsPostBack)
            {
                ...
                this.Hstation.Value = Request["Station"];
                this.HpCode.Value = Request["PCode"];
                this.HCOO.Value = Request["COO"];
            }
        }
