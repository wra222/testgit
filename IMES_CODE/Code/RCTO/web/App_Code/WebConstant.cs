...
namespace com.inventec.iMESWEB
{
    ...
    public partial class WebConstant
    {
        ...
        public const string PCARepairInputObject = "IMESService._PCARepairInput";
        ...
        public const string CombineCarton_CR = "IMESService.CombineCarton_CR";
        public const string UnpackCarton_CR = "IMESService.UnpackCarton_CR";
        public const string SKULabelPrintObject = "IMESService.SKULabelPrintObject";
        public const string PNOPLabelPrintObject = "IMESService.PNOPLabelPrint";
        public const string OfflineCommonPartsLabelPrint = "IMESService.OfflineCommonPartsLabelPrint";
        //
        public const string CombineCartonAndDNfor146 = "IMESService.CombineCartonAndDNfor146";
        public const string TouchGlassChecktime = "IMESService.TouchGlassChecktime";
        #endregion
		...
		public const string CheckCartonCTForRCTOObject = "IMESService.CheckCartonCTForRCTO";
		public const string MBCTCheckObject = "IMESService.MBCTCheck";
		
		public const string RemoveKPCT = "IMESService.RemoveKPCT";
		public const string CombineOfflinePizzaForRCTO = "IMESService.CombineOfflinePizzaForRCTO";
		
		public const string OfflineLcdCtPrint = "IMESService.OfflineLcdCtPrint";
        public const string PCAOQCCollection = "IMESService.PCAOQCCollection";

        public const string OfflinePizzaKittingForRCTO = "IMESService.OfflinePizzaKittingForRCTO";
        //add by viclin
        public const string CreateProductandCombineLCM = "IMESService.CreateProductandCombineLCM";
        public const string CombineCartonandDNfor146_CommonPartsObject = "IMESService.CombineCartonandDNfor146_CommonParts";
        public const string FRULabelPrintObject = "IMESService.IFRULabelPrint";
        public const string RULabelPrintObject = "IMESService.IRULabelPrint";

        
		public const string CombineCartonDNfor146MB = "IMESService.CombineCartonDNfor146MB";
		public const string CombineCartonPalletFor146 = "IMESService.CombineCartonPalletFor146";
		
		public const string CombinePalletWithoutCartonForFRU = "IMESService.CombinePalletWithoutCartonForFRU";
		
		public const string SeaReturn = "IMESService.SeaReturn";
