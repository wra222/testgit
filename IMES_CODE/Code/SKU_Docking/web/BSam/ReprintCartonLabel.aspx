...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="ReprintCartonLabel.aspx.cs" Inherits="ReprintCartonLabel" %>
...
function input() {
    ...
    WebServiceCombineCartonInDN.ReprintCartonLabel(inpuProdid, editor, station, customer,reason, printItemlist, onSucceed, onFail)
}
...
function PrintShipto(printItem) {
    ...
    for (var p in printItem) {
        if (printItem[p].LabelType == "BSAM SHIP TO LABEL") {
            ShipLabel = printItem[p];
        }
    }
    printlist[0] = ShipLabel;
    printLabels(printlist, false);
