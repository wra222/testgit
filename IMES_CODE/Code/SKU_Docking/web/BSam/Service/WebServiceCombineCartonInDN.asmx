<%@ WebService Language="C#" Class="WebServiceCombineCartonInDN" %>
...
public class WebServiceCombineCartonInDN : System.Web.Services.WebService
{
    private ICombineCartonInDN iCombineCartonInDN = null;
    ...
    public ArrayList InputCustSn(string firstSN, string custsn, IList<PrintItem> items)
    {
        ...
        {
            if (ex.mErrcode == "CHK982")
            { throw new Exception(ex.mErrmsg+"NOTSAMEMODEL"); }
            else
