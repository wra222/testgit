...
function loadParams()
{
    if(window.dialogArguments != null)
    {
		...
		// BUG FIX: Mantis No.558 - iMES trial run @ 2012/03/23
        window.document.getElementById("form1").OK.focus() ;   
    }  
}
            ...
            <table  id="table1" border="0"   runat="server">
                <tr>
                    <td  align="center" >   
                        ...
                        <button id="OK" onclick="OK_onClick()" onkeydown="OK_onKeydown();" style="height:25px;width:75px;">
                        <span>
