...
public partial class FA_FACombineKeyParts : IMESBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
			...
			if (!Page.IsPostBack)
            {
                ...
                this.cmbsubStation.Type = StationType;
    ...
    private void cmbsubStation_Selected(object sender, System.EventArgs e)
    {
        ...
        this.cmbsubStation.refreshByPdline(this.cmbPdLine.InnerDropDownList.SelectedValue, this.StationType); //"FACombine"
