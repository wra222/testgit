...
public partial class FA_BoardInput : IMESBasePage 
{
          ...
          
        {
         ...
         //       this.cmbPdLine.InnerDropDownList+= new EventHandler(cmbPdLine_Selected);
           //    GetQty();
                ...
                SpeedLimit = iBoardInput.GetSpeedLimit(Request["Station"]) + ",";
            }
        }
    ...
    private void InitLabel()
    {
        ...
        this.lbSpeedNow.Text = this.GetLocalResourceObject(Pre + "_lblSpeedNow").ToString();
        this.lbSpeedSum.Text = this.GetLocalResourceObject(Pre + "_lblSpeedSum").ToString();
        this.lbSecond.Text = this.lbSecond2.Text = this.GetLocalResourceObject(Pre + "_lblSecond").ToString();
