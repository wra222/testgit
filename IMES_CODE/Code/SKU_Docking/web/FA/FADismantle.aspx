    ...
    <tr>
        ...
        <td align="right">
            <asp:UpdatePanel ID="updatePanelAll" runat="server" RenderMode="Inline">
				<ContentTemplate>
					<input id="btnDismantle" type="button"  onclick="btnDismantleClick()" class="iMes_button" runat="server" onmouseover="this.className='iMes_button_onmouseover'" onmouseout="this.className='iMes_button_onmouseout'" />
				</ContentTemplate>
			</asp:UpdatePanel>
        </td>
    </tr>
...
document.body.onload = function() {
    try {
        ...
        station = '<%=Station%>';
        Pcode = '<%=pCode%>';
        allowdismantletypelist = '<%=Request["DismantleType"] %>';
        //alert(editor);
...
// exit page
 ...
 function checkdismantletype(dismantletype) {
     ...
     if (allowdismantletypelist.indexOf(checkitem)>=0)
     //if ((checkitem == "PRODUCT") || (checkitem == "KP") || (checkitem == "IMEI") || (checkitem == "AST") || (checkitem == "WM") || (checkitem == "WIN8KEY"))
      {
         return true;
     }
     else {
 ...
 function btnDismantleClick() 
 {
     ...
     if (ischecktype == false) {
         //errDismantletype
         ShowMessage(errDismantletype + " Or You do not have the  permissions for this Page");
         ShowInfo(errDismantletype + " Or You do not have the  permissions for this Page");
         getCommonInputObject().focus();
         getAvailableData("processDataEntry");
         return;
     }
    ...
    else 
    {
        ...
        if(confirm(msgConfirmDismantle))
        {
            ...
            beginWaitingCoverDiv();
            WebServiceFADismantle.Dismantle(strProdIDorSN, dismantletype, keypartsvalue, returnstationvalue, "", Pcode, editor, station, customer, onDismantleReturn, onDismantleReturnFail);
...
function onDismantleReturnFail(error) {
    V_endWaitingCoverDiv();
    strProdIDorSN = "";
