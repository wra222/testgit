...
<script type="text/javascript">
    ...
    function print() {
        try {
            ...
            inpuProdid= Get2DCodeCustSN(inpuProdid);
            //don't do check
    ...
    function onSucceed(result) {
        try {
            ...
            if (result == null) {
                ...
                keyCollection[0] = "@ProductID";
                valueCollection[0] = result[2];
                setPrintParam(result[1], "Master Label", keyCollection, valueCollection);
            // setPrintItemListParam1(result[1][2], result[1][0], result[1][1]);
                ...
                ShowSuccessfulInfoFormat(true, "Product ID", result[2]);  //inpuProdid); // Print 成功，带成功提示音！
