...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
        ...
        <center>
            <table width="95%">
                ...
                <tr>
                    ...
                    <td align="right">
                        <button type="button" style ="width:110px; height:24px; display: none" id="btnEdit" onclick="clickEdit()">
                            <%=this.GetLocalResourceObject(Pre + "_btnEdit").ToString()%>
                        </button>
                        <button type="button" style ="width:110px; height:24px;" id="btnMark" onclick="clickMark()" >Mark</button>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
            ...
            <button id="btnMarkData" runat="server" type="button" onserverclick="btnMark_ServerClick" style="display: none" />   
    ...
    <script type="text/javascript">
        ...
        function clickMark() {
            ...
            document.getElementById('<%=btnMarkData.ClientID%>').click();
        }
