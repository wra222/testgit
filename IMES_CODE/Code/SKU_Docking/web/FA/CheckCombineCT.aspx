...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8"
    AutoEventWireup="true" CodeFile="CheckCombineCT.aspx.cs" Inherits="FA_CheckCombineCT" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
    ...
    <div>
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Services>
                <asp:ServiceReference Path="Service/WebServiceCheckCombineCT.asmx" />
            </Services>
        </asp:ScriptManager>
        <center>
         ...
         <table border="0" width="95%">   
             ...
             <tr>
                    ...
                    <td colspan="5" align="right">
		                    <input id="btnPrintSet" type="button"  runat="server"  class="iMes_button" onclick="showPrintSettingDialog()" style="display:none" />
		                    <input id="btnReprint" type="button"  runat="server"  class="iMes_button" onclick="reprint()" style="display:none"/>
           ...
           if (document.getElementById("<%=txtProdId.ClientID%>").innerText == "") {
               ...
               if (SeltmpStation == '3B') {
                   ...
                   if (inputData == "getbomnull") {
                       ...
                       WebServiceCheckCombineCT.save(document.getElementById("<%=txtProdId.ClientID%>").innerText, flag, flag_39, onSaveSucceed, onSaveFail);
                       ...
                       if (inputData == "7777") {
                           ...
                           WebServiceCheckCombineCT.ClearPart(document.getElementById("<%=txtProdId.ClientID%>").innerText, onClearSucceeded, onClearFailed);
                           
                       }
                       else {
                           WebServiceCheckCombineCT.inputPPID(document.getElementById("<%=txtProdId.ClientID%>").innerText, inputData, onSucceed, onFail);
                       }
                   }
    ...
    try {
        ...
        if (row != null) {
            ...
            if (scanQty == parseInt(qty, 10)) {
                ...
                ResetPage();
                WebServiceCheckCombineCT.save(document.getElementById("<%=txtProdId.ClientID%>").innerText, onSaveSucceed, onSaveFail);
            }
...
function ExitPage()
{
    if(document.getElementById("<%=txtProdId.ClientID%>").innerText != "")
    {
        WebServiceCheckCombineCT.Cancel(document.getElementById("<%=txtProdId.ClientID%>").innerText, getReturnStationCmbValue(), onClearSucceeded, onClearFailed);
    } 
}
