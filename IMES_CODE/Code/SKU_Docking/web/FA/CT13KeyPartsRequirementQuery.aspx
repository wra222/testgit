...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" AsyncTimeout="3000" CodeFile="CT13KeyPartsRequirementQuery.aspx.cs" Inherits="PAK_CT13KeyPartsRequirementQuery" Title="Untitled Page" %>
   ...
   <center>
    ...
    <tr>
        ...
        <td style="width:95%" colspan="4">
            <iframe name="action" id="action" src="CT13KeyPartsRequirementQuery_Upload.aspx"  scrolling="no"  frameborder="0" width="100%" height="30px"></iframe>
        </td>
    </tr>
