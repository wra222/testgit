...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReturnUsedKeys_Upload.aspx.cs" Inherits="PAK_ReturnUsedKeys_Upload" %>
...
function clientUpload() {
    document.getElementById("<%=hidFlag.ClientID %>").value = "";  
