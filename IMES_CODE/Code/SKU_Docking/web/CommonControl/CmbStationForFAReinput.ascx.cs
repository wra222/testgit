...
public partial class CommonControl_CmbStationForFAReiput : System.Web.UI.UserControl
{
    ...
    private IStationReinput iStation;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            iStation = ServiceAgent.getInstance().GetObjectByName<IStationReinput>(WebConstant.CommonObject);
            ...
            if (!this.IsPostBack)
            {
                if (isPercentage)
                {
                    ...
                    {
                        drpStationFAReinput.Width = Unit.Percentage(100);
                    }
                    else
                    {
                        drpStationFAReinput.Width = Unit.Percentage(Convert.ToDouble(width));
                    }
                }
                else
                {
                    drpStationFAReinput.Width = Unit.Parse(width);
                }

                this.drpStationFAReinput.CssClass = cssClass;
                this.drpStationFAReinput.Enabled = enabled;
                ...
                {
                    this.drpStationFAReinput.Items.Add(new ListItem("", ""));
                }
            }
        }
    ...
    public void initStationList()
    {
        if (iStation != null)
        {
            ...
            lstStation = iStation.GetStationReinputList();
    ...
    {
        this.drpStationFAReinput.Items.Clear();
        drpStationFAReinput.Items.Add(new ListItem("", ""));
        up.Update();
    }
    ...
    private void initControl(IList<StationInfo> lstStation)
    {
        ...
        this.drpStationFAReinput.Items.Clear();
        this.drpStationFAReinput.Items.Add(string.Empty);
        ...
        if (lstStation != null)
        {
            ...
            foreach (StationInfo temp in newList)
            {
                ...
                this.drpStationFAReinput.Items.Add(item);
            }
        }
    ...
    {
        this.drpStationFAReinput.SelectedIndex = index;
        up.Update();
    }
    ...
    public DropDownList InnerDropDownList
    {
        get
        {
            return this.drpStationFAReinput;
        }
