...
public partial class CommonControl_ModelControl : System.Web.UI.UserControl
{
 ...
 //   IProIdPrint iProIdPrint = (IProIdPrint)ServiceAgent.getInstance().GetObjectByName(WebConstant.IProIdPrint_SERVICE);
    ...
    public void refreshDropContent(String family)
    {
        ...
        {
            iModel = ServiceAgent.getInstance().GetObjectByName<IModel>(WebConstant.VirtualMoObject);
        }
    ...
    public void refreshDropContentForTravelCardExcel(String line, String family)
    {
        //首先清空combobox内容
        DropDownList1.Items.Clear();
        DropDownList1.Items.Add(new ListItem("", ""));
        ...
        if (iTravelCardPrint != null)
        {
            IList<ModelInfo> lstModel = iTravelCardPrint.GetModelListForTravelCard(line, family);
