...
public partial class CommonControl_CmbMBCodeSMTMODocking : System.Web.UI.UserControl
{
    private string cssClass;
    private string width;
    private IGenSMTMODocking iGenSMTMO = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            iGenSMTMO = ServiceAgent.getInstance().GetObjectByName<IGenSMTMODocking>(WebConstant.GenSMTMODocking);
