...
public partial class CommonControl_CmbFamilyForMaintain : System.Web.UI.UserControl
{
    ...
    protected void initFamily()
    {
        ...
        IFamily2 iFamily = (IFamily2)ServiceAgent.getInstance().GetMaintainObjectByName<IFamily2>(WebConstant.MaintainCommonObject);
        ...
        if (iFamily != null)
        {
            ...
            if (lstFamily != null)
            {
                ...
                {
                    DropDownList1.Items.Add(new ListItem(family.Family, family.Family));
                }
            }
