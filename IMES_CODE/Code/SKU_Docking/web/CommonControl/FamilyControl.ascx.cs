...
public partial class CommonControl_FamilyControl : System.Web.UI.UserControl
{
    ...
    private FamilyInfoDef familyInfoDefObj;
    ...
    public FamilyInfoDef FamilyInfoDefObj
    {
        get
        {
            return familyInfoDefObj;
        }
        set
        {
            familyInfoDefObj = value;
        }
    }
   ...
   /// </summary>
    ...
    protected void initDropReason()
    {
        ...
        else if (_service == "016") //
        {
            iFamily = ServiceAgent.getInstance().GetObjectByName<IFamily>(WebConstant.CommonObject);
            if (iFamily != null)
            {
               IList<string> lstFamily = iFamily.GetFamilyByFamilyInfo(familyInfoDefObj);
                if (lstFamily != null)
                {
