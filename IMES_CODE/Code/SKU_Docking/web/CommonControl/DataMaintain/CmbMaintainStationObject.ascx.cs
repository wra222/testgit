...
public partial class CommonControl_DataMaintain_CmbMaintainStationObject : System.Web.UI.UserControl
{
    ...
    public CommonControl_DataMaintain_CmbMaintainStationObject()
    {
        ...
        try
        {
            ...
            if (!this.IsPostBack)
            {
                if (isPercentage)
                {
                    ...
                    {
                        drpMaintainStationObject.Width = Unit.Percentage(100);
                    }
                    else
                    {
                        drpMaintainStationObject.Width = Unit.Percentage(Convert.ToDouble(width));
                    }
                }
                else
                {
                    drpMaintainStationObject.Width = Unit.Parse(width);
                }

                this.drpMaintainStationObject.CssClass = cssClass;
                this.drpMaintainStationObject.Enabled = enabled;

                if (enabled)
                {
                    initMaintainStationObject();
                }
                else
                {
                    this.drpMaintainStationObject.Items.Add(new ListItem("", ""));
                }
            }
        }
    ...
    public void initMaintainStationObject()
    {

        ListItem item = null;

        this.drpMaintainStationObject.Items.Clear();
        ...
        for (int i = 0; i < this.selectValues.Count; i++)
        {
            ...
            this.drpMaintainStationObject.Items.Add(item);
        }
    }
    ...
    {
        this.drpMaintainStationObject.Items.Clear();
        drpMaintainStationObject.Items.Add(new ListItem("", ""));
        up.Update();
    }
    ...
    {
        this.drpMaintainStationObject.SelectedIndex = index;
        up.Update();
    }
    ...
    public DropDownList InnerDropDownList
    {
        get
        {
            return this.drpMaintainStationObject;
        }
