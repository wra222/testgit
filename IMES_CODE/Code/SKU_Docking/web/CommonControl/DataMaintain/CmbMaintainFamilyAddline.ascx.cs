...
public partial class CommonControl_CmbMaintainFamilyAddline : System.Web.UI.UserControl
{
    ...
    public void initMaintainFamily()
    {
        ...
        if (iSelectData != null && customer!=null)
        {
            ...
            lstMaintainFamily = iSelectData.GetCustomerFamilyListAddline(customer);
    ...
    private void initControl(IList<SelectInfoDef> lstMaintainFamily)
    {
        ...
        //第一项是customer
        item = new ListItem(customer, customer);
