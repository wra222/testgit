...
public partial class CommonControl_CmbFloor : System.Web.UI.UserControl
{
    private string cssClass;
    private string width;
    private IFloor iFloor;
    ...
    public void initFloor()
    {
        if (iFloor != null)
        {
            IList<FloorInfo> lstFloor = iFloor.GetFloorList();
    ...
    private void initControl(IList<FloorInfo> lstFloor)
    {
        ListItem item = null;
        ...
        foreach (FloorInfo temp in lstFloor)
        {
