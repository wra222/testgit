<%@ Page Language="C#" AutoEventWireup="true"  ContentType="text/html;Charset=UTF-8" CodeFile="MaterialProcessRelation.aspx.cs" Inherits="MaterialProcessRelation" ValidateRequest="false"  %>
   <style type ="text/css" >
        .bStyle {font-size:12pt;font-family:Verdana; font-weight:bold;}    
   </style>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>iMES-Material Process Rule Setting</title>
                            ...
                            <td>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <Columns >  
                                            ...
                                            <asp:BoundField DataField="MaterialType"/>
                                        </Columns>
                                        </iMES:GridViewExt>
                                    </ContentTemplate>   
                                    </asp:UpdatePanel>                         
