...
public partial class DataMaintain_PAKKittingUploadDlg : System.Web.UI.Page
{
    ...
    protected void btnOK_ServerClick(Object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (dFileUpload.HasFile)
            {
                ...
                DataTable getData=iLightNo.UploadModelForWipBufferPAK(pdLine);

                string dataString="";
                DataTableToXmlString(getData, ref dataString);
    ...
    private bool DataTableToXmlString(DataTable dataInfo, ref string dataString)
    {
