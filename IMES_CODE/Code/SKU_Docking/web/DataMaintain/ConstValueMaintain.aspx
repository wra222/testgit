...
<%@ Page Language="C#" MasterPageFile="~/MasterPageMaintain.master" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="ConstValueMaintain.aspx.cs" Inherits="DataMaintain_ConstValue" ValidateRequest="false" %>
...
<script type="text/javascript" src="../UserManager/commoncontrol/function/commonFunction.js"></script>
             ...
             <table width="100%" class="iMes_div_MainTainEdit" >             
                <tr >
                    ...
                    <td style="width:30%" align ="left" >
                        ...
                        <ContentTemplate>                    
                            <iMESMaintain:CmbConstValueType runat="server" ID="cmbConstValueType" Width="100%"  IsSelectFirstNotNull="true"></iMESMaintain:CmbConstValueType>
                        </ContentTemplate>
                        </asp:UpdatePanel>                            
                    </td>
        ...
        <div id="div3">
            <table width="100%" class="iMes_div_MainTainEdit" >
                    <tr>    
                        ...
                        <td style="width:80%">
                            <asp:TextBox ID="dName" runat="server" MaxLength="20" Width="98%" SkinId="textBoxSkin" style='ime-mode:disabled;'></asp:TextBox>
                        </td> 
                    ...
                    <tr>
                        ...
                        <td width="30%">
                            <asp:TextBox ID="dValue" runat="server"   MaxLength="3000" Width="98%" SkinId="textBoxSkin" ></asp:TextBox>
                        </td>
                        <td></td>
                    </tr>
                    <tr>
       ...
       switch(event.srcElement.id)
       {
           ...
           case "<%=btnDelete.ClientID %>":
            ...
            case "<%=btnAddType.ClientID %>":
                ...
                var dlgReturn = window.showModalDialog("ConstValueMaintainDlg.aspx?userName=" + editor, window, dlgFeature);
                if (dlgReturn == "OK") {
    ...
    function ConstValueTypeSelectOnChange() {
        ...
        if (getConstValueTypeCmbValue() == "SYS" || getConstValueTypeCmbValue() == null || getConstValueTypeCmbValue() == "") {
            document.getElementById("<%=lblName.ClientID %>").innerText = "Name:";
        }
        else {
            var lblName = getConstValueTypeCmbValue() + ":";
            document.getElementById("<%=lblName.ClientID %>").innerText = lblName;
        }
   ...
   function check()
   {
    ...
    function ShowRowEditInfo(con)
    {
         ...
         document.getElementById("<%=dValue.ClientID %>").value = con.cells[2].innerText.trim();
         document.getElementById("<%=dDescr.ClientID %>").value = con.cells[3].innerText.trim();
