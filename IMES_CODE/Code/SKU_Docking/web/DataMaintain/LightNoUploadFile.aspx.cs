...
public partial class DataMaintain_LightNoUploadFile : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {              
                ...
                string kittingTypeValue = Request.QueryString["KittingTypeValue"];
                kittingTypeValue = StringUtil.decode_URL(kittingTypeValue);
                this.hidKittingType.Value = kittingTypeValue;
