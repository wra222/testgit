<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignModelUploadFile.aspx.cs" Inherits="DataMaintain_AssignModelUploadFile" %>
...
<head id="Head1" runat="server">
    <title>iMES-Assign Model Upload File</title>
    ...
    <div style="width:100%; text-align :center">
         ...
         <table width="85%" border="0" >
            <tr style="height :55px">
              ...
              <td align="right">            
                  <button id="btnOK" runat="server"  class="iMes_button" onclick="if(clkButton())" onmouseover="this.className='iMes_button_onmouseover'" onmouseout="this.className='iMes_button_onmouseout'" onserverclick="btnOK_ServerClick" ></button>
              </td>
              <td align="right">            
                  <button id="btnCancel" runat="server"  class="iMes_button" onclick="return btnCancel_Click()" onmouseover="this.className='iMes_button_onmouseover'" onmouseout="this.className='iMes_button_onmouseout'" ></button>
              </td>
            </tr>            
         </table>       
    </div>
