...
<%@ Page Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="FRUMBVersionMaintain.aspx.cs" Inherits="DataMaintain_FRUMBVersionMaintain" Title="FRUMBVersionMaintain" %>
        ...
        <div id="div1" class="iMes_div_MainTainDiv1">
             <table width="100%" class="iMes_div_MainTainEdit">            
                <tr >
                    ...
                    <td width="10%">
                        <asp:Label ID="lblPartNoTop" runat="server" CssClass="iMes_label_13pt" Text="Part No:"></asp:Label>
                    </td>
                    <td width="15%">
                    ...
                    <td width="10%">
                        <asp:Label ID="lblPartNoInput" runat="server" CssClass="iMes_label_13pt" Text="Part No Select:"></asp:Label>
                    </td>
                    <td width="15%">
                ...
                <ContentTemplate>
                 <div id="div2">
                    ...
                    <iMES:GridViewExt ID="gd" runat="server" AutoGenerateColumns="true" 
                        ...
                        onrowdatabound="gd_RowDataBound" EnableViewState= "false" style="top: 0px; left: 27px"
                        >
                    </iMES:GridViewExt>
                    </div>
                 </ContentTemplate>
        ...
        <div id="div3">
            <table width="100%" class="iMes_div_MainTainEdit">
                    <tr >
                        ...
                        <td width="180px">
                            <asp:TextBox ID="ttPartNo" runat="server"   MaxLength="20"   Width="96%" SkinId="textBoxSkin" ></asp:TextBox>
                        </td>
                        
                         <td style="width: 110px;">
                            <asp:Label ID="lblMBCode" runat="server" CssClass="iMes_label_13pt" Text="MB Code:"></asp:Label>
                        </td>
                        <td width="180px">
                            <asp:TextBox ID="ttMBCode" runat="server"   MaxLength="20"   Width="96%"  
                               SkinId="textBoxSkin"  ></asp:TextBox>
                        </td>
                        
                        <td style="width: 110px;">
                            <asp:Label ID="lblVer" runat="server" CssClass="iMes_label_13pt" Text="Version:"></asp:Label>
                        </td>
                        <td width="180px">
                            <asp:TextBox ID="ttVer" runat="server"   MaxLength="20"   Width="96%" SkinId="textBoxSkin" ></asp:TextBox>
                        </td>
...
//        customerObj.onchange = addNew;
   ...
   function resetTableHeight()
    ...
    function clkDelete()
    {
        ...
        document.getElementById("<%=hidCode.ClientID %>").value = document.getElementById("<%=ttPartNo.ClientID %>").value;            
...
//         var ret = confirm("Do you really want to delete this item?");  //3
    ...
    function Check(pn, mb, ver) {

        if (pn.trim() == "" || mb.trim() == "" || ver.trim() == "") {
            alert("Part No and MB Code and Ver can not be empty!");
            return false;
        }
        if (pn.length > 12)
        { alert("The length pf PartNo can not be greater than 12!"); return false; }
        if (mb.length > 2 || ver.length > 5 )
        { alert("The length pf MB code or Version can not be greater than 2!"); return false; }
        return true;
    }
    ...
    function clkSave() {
        ...
        var p = document.getElementById("<%=ttPartNo.ClientID %>").value;
        var m = document.getElementById("<%=ttMBCode.ClientID %>").value;
        var v = document.getElementById("<%=ttVer.ClientID %>").value;
          if (Check(p,m,v))
          {
               document.getElementById("<%=hidCode.ClientID %>").value = p;
...
//        customerObj.onchange = addNew;
         ...
         if(con==null)
         {
            document.getElementById("<%=ttPartNo.ClientID %>").value =""; 
            document.getElementById("<%=ttMBCode.ClientID %>").value = "";  
            document.getElementById("<%=ttVer.ClientID %>").value = "";
         ...
         document.getElementById("<%=ttPartNo.ClientID %>").value =code ;
         document.getElementById("<%=ttMBCode.ClientID %>").value = con.cells[1].innerText.trim(); 
         document.getElementById("<%=ttVer.ClientID %>").value = con.cells[2].innerText.trim();
         document.getElementById("<%=ttRemark.ClientID %>").value = con.cells[3].innerText.trim();
...
//          document.getElementById("<%=dOldAssemblyCdt.ClientID %>").value = con.cells[7].innerText.trim();
          document.getElementById("<%=dOldId.ClientID %>").value=con.cells[7].innerText.trim();
          if (code == "") {
              document.getElementById("<%=btnSave.ClientID %>").disabled = true;
              document.getElementById("<%=btnDel.ClientID %>").disabled = true;
