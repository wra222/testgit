...
<%@ Page Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="SATestCheckRule.aspx.cs" Inherits="DataMaintain_SATestCheckRule" Title="无标题页" %>
...
.iMes_div_MainTainEdit
{
             ...
             <table width="100%" class="">            
                <tr >
                    <td class="iMes_div_MainTainListLable">
                        <asp:Label ID="lblPACTestCheckRuleList" runat="server" CssClass="iMes_label_13pt"></asp:Label>
                        
                    </td> 
                    <td>
                        <asp:TextBox ID="ttPCATestCheckRuleList" runat="server"   MaxLength="50"  Width="180px" 
        ...
        <div id="div3">
            <table width="100%" class="iMes_div_MainTainEdit" >
                    <tr >
                        ...
                        <td width="280px">
                            <asp:TextBox ID="ttCode" runat="server"   MaxLength="50"   Width="96%"  CssClass="iMes_textbox_input_Yellow"></asp:TextBox>
                        </td>
                        
                         <td style="width: 110px;">
                            <asp:CheckBox ID="MacCheck" runat="server" Text="MAC Check"/>
                        </td>
                       <td style="width:20px;">
                       
                       </td>
                        <td style="width: 110px;">
                            <asp:CheckBox ID="MBCTCheck" runat="server" Text="MBCT Check"/>
                        </td>
                       <td style="width:20px;">
                    ...
                    <tr >
                        <td style="width: 110px;">
                            <asp:Label ID="lblHDDV" runat="server" CssClass="iMes_label_13pt" ></asp:Label>
                        </td>
                        <td width="280px">
                            
                            <asp:TextBox ID="ttHDDV" runat="server"  MaxLength="50"  Width="96%"  CssClass="iMes_textbox_input_Yellow"></asp:TextBox>
                        </td>

                        <td style="width: 420px;" colspan="4">
                            <asp:Label ID="lblBIOS" runat="server" CssClass="iMes_label_13pt"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:TextBox ID="ttBIOS" runat="server"  MaxLength="50"  Width="70%"  CssClass="iMes_textbox_input_Yellow"></asp:TextBox>
                        </td>
    ...
    function OnKeyPress(obj)
    {
        ...
        if (key==13)//enter
        {     
            if(event.srcElement.id=="<%=ttPCATestCheckRuleList.ClientID %>")
            {
                var value=document.getElementById("<%=ttPCATestCheckRuleList.ClientID %>").value.trim().toUpperCase();
                if(value!="")
                {
...
//        customerObj.onchange = addNew;
         ...
         if(con==null)
         {
            ...
            document.getElementById("<%=ttHDDV.ClientID %>").value = "";  
            document.getElementById("<%=ttBIOS.ClientID %>").value = "";
            document.getElementById("<%=MacCheck.ClientID %>").checked = false;
            document.getElementById("<%=MBCTCheck.ClientID %>").checked = false;
         ...
         document.getElementById("<%=MacCheck.ClientID %>").checked = (con.cells[1].innerText.trim()=="Y"?true:false);
         document.getElementById("<%=MBCTCheck.ClientID %>").checked = (con.cells[2].innerText.trim()=="Y"?true:false);
         document.getElementById("<%=ttHDDV.ClientID %>").value = con.cells[3].innerText.trim();
         document.getElementById("<%=ttBIOS.ClientID %>").value = con.cells[4].innerText.trim();
