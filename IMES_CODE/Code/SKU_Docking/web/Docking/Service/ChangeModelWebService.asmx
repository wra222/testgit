...
public class ChangeModelWebService : System.Web.Services.WebService
{
    ...
    [WebMethod]
    public ArrayList InputModel1(string model1, string editor, string line, string station, string customer, string typeChangeModel)
    {
        // typeChangeModel 為 空值 或 FIC
        ArrayList result = new ArrayList();
        try
        {
            IChangeModel CurrentService = com.inventec.iMESWEB.ServiceAgent.getInstance().GetObjectByName<IChangeModel>(com.inventec.iMESWEB.WebConstant.ChangeModelDocking);
            List<StationDescrQty> stationList = CurrentService.InputModel1(model1, editor, line, station, customer, typeChangeModel);
