...
public partial class FA_FARepair : IMESBasePage
{
    ...
    private IFARepairForDocking iFARepair;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            repairServiceObj = ServiceAgent.getInstance().GetObjectByName<IFARepairForDocking>(WebConstant.FARepairForDocking);
            commServiceObj = ServiceAgent.getInstance().GetObjectByName<IRepair>(WebConstant.CommonObject);

            iFARepair = (IFARepairForDocking)repairServiceObj;
