...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"  ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="PCATestStationForLot.aspx.cs" Inherits="DOCKING_PCATestStation" %>
...
<div>
    ...
    <tr>
        ...
        <td  align="left" style="visibility: hidden">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox runat="server" ID="FruCheck"  AutoPostBack="false" 
