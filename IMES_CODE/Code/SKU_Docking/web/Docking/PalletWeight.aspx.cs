...
public partial class DOCK_PalletWeight : System.Web.UI.Page
{
    ...
    protected IPalletWeight palletweightManager = (IPalletWeight)ServiceAgent.getInstance().GetObjectByName<IPalletWeight>(WebConstant.PalletWeightForDocking);
