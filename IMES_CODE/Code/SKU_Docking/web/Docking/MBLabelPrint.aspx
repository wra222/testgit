...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"  ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="MBLabelPrint.aspx.cs" Inherits="DOCKING_MBLabelPrint"  Title="无标题页"%>
...
function reprint() {
    var url = "MBLabelReprint.aspx" + "?Station=" + stationId + "&PCode=" + pCode + "&UserId=" + editor + "&Customer=" + customer + "&AccountId=" + AccountId + "&Login=" + Login;
