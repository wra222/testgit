...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PalletWeight.aspx.cs" Inherits="DOCK_PalletWeight" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
    ...
    <asp:ScriptManager runat="server" ID="SM" EnablePartialRendering="true">
        <Services>
            <asp:ServiceReference Path="Service/WebServicePalletWeight.asmx" />
        </Services>
    </asp:ScriptManager>
    <div id="divl">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function processDataEntry(inputData)
        {
         ...
         {
            if (!((inputData.length == 10) ||(inputData.length == 12) || (inputData.length == 20))) 
            {
                ...
                PalletWeightWebService.InputPallet(inputData, actWeight,type,"", editor, station, customer,onPalletReturn);        
            }
        }
     ...
     {      
            ...
            {   
                ...
                beginWaitingCoverDiv();
                PalletWeightWebService.InputCustSN(customerSN, palletNo, onCustomReturn);
             }
    }
    ...
    function onSaveReturn(result)
    {
        ...
        if( result[0]==SUCCESSRET )     //length =5 result[0]:SUCCEED, [1]:printItem [2]:Pallet No [3]:Standard Weight [4]:Customer SN [5]:actual weight
        {
            ...
            var tmpinfo= palletNo;
            ResetPage();
            ShowSuccessfulInfoFormat(true,"Pallet No",tmpinfo);
        ...
        function setPrintItemListParam(backPrintItemList, plno,pltactWeight)
        {
            ...
            setPrintParam(lstPrtItem, "DK_Pallet_Weight", keyCollection, valueCollection);
        }
