...
public partial class DOCKING_GenerateSMTMO : IMESBasePage
{
    public string pre = WebCommonMethod.getConfiguration(WebConstant.LANGUAGE);
    private int fullRowCount = 6;
    IGenSMTMODocking iGenSMTMO = ServiceAgent.getInstance().GetObjectByName<IGenSMTMODocking>(WebConstant.GenSMTMODocking);
