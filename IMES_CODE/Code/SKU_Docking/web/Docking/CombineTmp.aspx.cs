...
public partial class CombineTmp : IMESBasePage
{
    ...
    private DataTable getBomDataTable(string prodId)
    {
        ...
        IList<BomItemInfo> list = iCombineTmp.InputProdIdorCustsn(prodId, Master.userInfo.UserId, this.station.Value, Master.userInfo.Customer, out realProdID, out strModel, out strCustSN);
