...
public partial class PAK_PalletVerify_BIRCH : System.Web.UI.Page
{
    ...
    IPalletVerify_BIRCH iPalletVerify = ServiceAgent.getInstance().GetObjectByName<IPalletVerify_BIRCH>(WebConstant.PalletVerifyObject);
