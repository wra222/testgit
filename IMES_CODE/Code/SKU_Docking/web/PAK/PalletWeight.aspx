        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td align="left" colspan="2">
                    <iMES:CmbPalletType ID="cmbPalletKind" runat="server" Width="50" IsPercentage="true" CssClass="iMes_DropDownList" />
                </td>
            </tr>
            <tr>
                <td style="width: 20%">
                ...
                <td  style="width: 60%">
                    <asp:TextBox ID="txtManual" runat="server" CssClass="iMes_textbox_input_Normal" Width="99%" onkeypress='OnKeyPress(this)'/>
                </td>
                <td style="width: 20%">
