...
public partial class PAK_PDPALabel02_CQ : IMESBasePage
{
    ...
    */
    ...
    private void bindTable(int defaultRow)
    {
        ...
        //dt.Columns.Add(this.GetLocalResourceObject(Pre + "_colScan").ToString());
        dt.Columns.Add("Tp");
        ...
        gd.Columns[0].HeaderText = "Tp";
        gd.Columns[1].HeaderText = "PartNo";
        gd.Columns[2].HeaderText = "Scan";
        gd.DataSource = dt;
        gd.DataBind();
    ...
    {
        //gd.HeaderRow.Height = Unit.Pixel(1);
        gd.HeaderRow.Cells[0].Height = Unit.Pixel(2);
        //Set column width 
        //================================= Add Code ======================================
