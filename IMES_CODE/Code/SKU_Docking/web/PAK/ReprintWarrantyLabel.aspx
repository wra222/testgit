...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8"
    AutoEventWireup="true" CodeFile="ReprintWarrantyLabel.aspx.cs" Inherits="SA_ReprintWarrantyLabel"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function clkReprint() {
			...
			if (cust.length == 11 && CheckCustomerSN(cust.substr(1,10)) ) {
                customerSN = cust.substring(1, 11);
            }
            //else if ((cust.length == 10) && (cust.substring(0, 2) == "CN")) {
			else if (cust.length == 10 && CheckCustomerSN(cust)) {
            ...
            */
            ...
            WebServicePrintContentWarranty.ReprintWarrantyLabel(customerSN, reason, lstPrintItem, "", editor, station, customer, onPrintSucceed, onPrintFail);
        ...
        function onPrintSucceed(result) {
            ...
            try {
                if (result == null) {
                    ...
                    setPrintItemListParam(result[1][index],customerSN, "Warranty Label");
