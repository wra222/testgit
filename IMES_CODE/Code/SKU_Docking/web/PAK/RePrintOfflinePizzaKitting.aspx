...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="RePrintOfflinePizzaKitting.aspx.cs" Inherits="PAK_RePrintOfflinePizzaKitting" %>
            ...
            if (!errorFlag) {
                ...
                try {
                   ...
                   //     RePrint(string sn, string reason, string line, string editor, string station, string customer, IList<PrintItem> printItems)
                        WebServiceOfflinePizzaKitting.RePrint(inpuProdid, reason, line, editor, station, customer, lstPrintItem, onSucceed, onFail);
                    }
                }
                catch (e1) {
