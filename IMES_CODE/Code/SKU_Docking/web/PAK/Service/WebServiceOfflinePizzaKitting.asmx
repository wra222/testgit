...
*/
 --%>
<%@ WebService Language="C#" Class="WebServiceOfflinePizzaKitting" %>
...
public class WebServiceOfflinePizzaKitting : System.Web.Services.WebService
{
    ...
    [WebMethod]
    public IList checkPart(string key, string part)
    {
        try
        {
            IList ret = new ArrayList();

            MatchedPartOrCheckItem item = offlinePizzaKitting.TryPartMatchCheck(key, part);
