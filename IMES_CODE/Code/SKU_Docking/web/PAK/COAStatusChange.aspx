...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" Runat="Server">
    ...
    var cn_txtTable = new Array(new Array("A0", "P0,16,01,02,05", "可放置Coa Center 或退給採購"),
                                new Array("P0", "D1,D2,A0", "可領至產線或退給物料"),
                                new Array("P1",	"D1,D2,A1",	"可退回產線中轉處"),
                                new Array("D1", "P0,P1", "可放置Coa Center"),
                                new Array("D2", "P0,P1", "可放置Coa Center"),
                                new Array("A1"	,　""	,"已結合!"),
    ...
    var msgWrongUser = '<%=this.GetLocalResourceObject(Pre + "_msgWrongUser").ToString() %>';
    ...
    function StatusCheck() {
        ...
        || inStatus == "16"
            ...
            if ((inStatus == "01" || inStatus == "16") && currentStatus == "RE") {
                statusWrong = msgWrongUser;
                return false;
            }
            else {
