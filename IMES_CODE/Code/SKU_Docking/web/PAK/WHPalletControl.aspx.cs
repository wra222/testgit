...
public partial class PAK_WHPalletControl : System.Web.UI.Page
{
    ...
    private DataTable initTable()
    {
        ...
        retTable.Columns.Add("ShipmentNO", Type.GetType("System.String"));
        retTable.Columns.Add("Model", Type.GetType("System.String"));
        retTable.Columns.Add("PalletNO", Type.GetType("System.String"));
        retTable.Columns.Add("CartonQty", Type.GetType("System.String"));
        ...
        retTable.Columns.Add("InWHCdt", Type.GetType("System.String"));
        return retTable;
    }
    private void initTableColumnHeader()
    {
        ...
        this.gridViewExt1.HeaderRow.Cells[1].Text = this.GetLocalResourceObject(Pre + "_titleShipmentNO").ToString();
        this.gridViewExt1.HeaderRow.Cells[2].Text = this.GetLocalResourceObject(Pre + "_titleModel").ToString();
        this.gridViewExt1.HeaderRow.Cells[3].Text = this.GetLocalResourceObject(Pre + "_titlePalletNO").ToString();
        this.gridViewExt1.HeaderRow.Cells[4].Text = this.GetLocalResourceObject(Pre + "_titleCartonQty").ToString();
        this.gridViewExt1.HeaderRow.Cells[5].Text = this.GetLocalResourceObject(Pre + "_titleQty").ToString();
        this.gridViewExt1.HeaderRow.Cells[6].Text = this.GetLocalResourceObject(Pre + "_titleForwarder").ToString();
        this.gridViewExt1.HeaderRow.Cells[7].Text = this.GetLocalResourceObject(Pre + "_titleHAWB").ToString();
        this.gridViewExt1.HeaderRow.Cells[8].Text = this.GetLocalResourceObject(Pre + "_titleSatus").ToString();
        this.gridViewExt1.HeaderRow.Cells[9].Text = this.GetLocalResourceObject(Pre + "_titleLOC").ToString();
        this.gridViewExt1.HeaderRow.Cells[10].Text = this.GetLocalResourceObject(Pre + "_titleInWHCdt").ToString();
        this.gridViewExt1.HeaderRow.Cells[0].Width = Unit.Pixel(75);
        this.gridViewExt1.HeaderRow.Cells[1].Width = Unit.Pixel(75);
        this.gridViewExt1.HeaderRow.Cells[2].Width = Unit.Pixel(60);
        this.gridViewExt1.HeaderRow.Cells[3].Width = Unit.Pixel(50);
        this.gridViewExt1.HeaderRow.Cells[4].Width = Unit.Pixel(40);
        this.gridViewExt1.HeaderRow.Cells[5].Width = Unit.Pixel(20);
        this.gridViewExt1.HeaderRow.Cells[6].Width = Unit.Pixel(45);
        this.gridViewExt1.HeaderRow.Cells[7].Width = Unit.Pixel(75);
        this.gridViewExt1.HeaderRow.Cells[8].Width = Unit.Pixel(45);
        this.gridViewExt1.HeaderRow.Cells[9].Width = Unit.Pixel(65);
        this.gridViewExt1.HeaderRow.Cells[10].Width = Unit.Pixel(80);
    ...
    protected void btnOnQueryIN_ServerClick(object sender, EventArgs e)
    {
        try
        {
           ...
           // IList<S_Table_Data> ret = currentWHPallet.GetDateFromTo(Convert.ToDateTime("2014-06-01"), Convert.ToDateTime("2014-10-01"));
           IList<S_Table_Data> ret = currentWHPallet.GetDateFromTo(dateF, dateT);
            ...
            foreach (S_Table_Data ele in ret)
            {
                ...
                newRow["ShipmentNO"] += ele.ShipmentNO;
                newRow["Model"] += ele.Model;
                newRow["PalletNO"] += ele.PalletNO;
                newRow["CartonQty"] += ele.CartonQty;
                newRow["Qty"] += ele.Qty;
