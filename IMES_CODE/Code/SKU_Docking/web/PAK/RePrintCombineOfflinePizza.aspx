...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="RePrintCombineOfflinePizza.aspx.cs" Inherits="PAK_RePrintCombineOfflinePizza" %>
...
<div>
    <asp:ScriptManager ID="ScriptManager1" runat="server" >
        <Services>
            <asp:ServiceReference Path="Service/WebServiceConbimeOfflinePizza.asmx" />
        </Services>
    </asp:ScriptManager>
    <center>
            ...
            if (!errorFlag) {
                ...
                try {
                   ...
                   //     RePrint(string sn, string reason, string line, string editor, string station, string customer, IList<PrintItem> printItems)
                        WebServiceConbimeOfflinePizza.RePrint(inpuProdid, reason, line, editor, station, customer, lstPrintItem, onSucceed, onFail);
                    }
                }
                catch (e1) {
