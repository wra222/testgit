...
public partial class PAK_CombineCOAandDNQuick : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!this.IsPostBack)
        {
            ...
            this.cmbPdLine.Customer = customer;//Master.userInfo.Customer;
    ...
    private void InitLabel()
    {
        ...
        this.lbBSAMLoc.Text = this.GetLocalResourceObject(Pre + "_lbBSAMLoc").ToString();
    }
    ...
    private bool CheckCOA()
    {
        bool re = false;
        string reStr = "";
        if (HSN.Value == "" || ((HDN.Value == "") && (HBSAM.Value == "")))
