        ...
        <tr style="height:10%">
            ...
            <td style="width:85%" align="left"  >
               <iMES:Input ID="TextBox1" runat="server" ProcessQuickInput="true" CanUseKeyboard="true"
                             ...
                             value="Input" />     
                              <asp:Label ID="lblCount" runat="server"  CssClass="iMes_label_13pt" Text="0 筆DN"   ></asp:Label>         
            </td>
...
function ResetPage()
{
    ...
    document.getElementById("<%=lblShipdateValue.ClientID%>").innerText = "";
    document.getElementById("<%=lblQtyValue.ClientID%>").innerText = "";
    document.getElementById("<%=lblCount.ClientID%>").innerText = "0筆DN";
...
function UploadCustsnList() {
    ...
    if (dlgReturn) {
        ...
        var arr = document.getElementById("<%=hidCustsnList.ClientID %>").value.split(',');
        inputCount = arr.length;
        document.getElementById("<%=lblCount.ClientID %>").innerHTML = inputCount + " 筆DN";
