...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PDPALabel01_CQ.aspx.cs" Inherits="PAK_PDPALabel01_CQ" Title="无标题页" %>
...
.maximizeStyle { height: auto; width: auto; position: fixed; border: 1px dotted black; left: 50px; top: 50px; }
    ...
    <div id="container" style="width: 99%; border: solid 0px red; margin: 0 auto;">
		...
		<tr><td width="85%">
            <table width="100%" border="0" style="table-layout: fixed;">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <iMES:CmbLocFloor id="CmbLocFloor" name='CmbFloor' runat="server" Width="100" IsPercentage="true" />
                    </td>
                </tr>
            </table>
            <hr />
            ...
            <ContentTemplate>
			<table border="0">
				<tr><td width="50%"><asp:Image ID="ShowImage0" runat="server" Width="154" Height="100"/></td>
				<td><asp:Image ID="ShowImage1" runat="server" Width="154" Height="100"/></td></tr>
				...
				<tr><td><asp:Image ID="ShowImage4" runat="server" Width="154" Height="100"/></td>
				<td><asp:Image ID="ShowImage5" runat="server" Width="154" Height="100"/></td>
				</tr>
				   <td><asp:Image ID="ShowImage6" runat="server" Width="154" Height="100"/></td>
				  <td><asp:Image ID="ShowImage7" runat="server" Width="154" Height="100"/></td>
				<tr>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function inputCustomerSN(inputData) {
          ...
          //  var floor = document.getElementById("CmbFloor")[document.getElementById("CmbFloor").selectedIndex].text; //getFloorCmbValue();
            ...
            WebServicePDPALabel01.input_CQ(QueryFlag, line, code, floor, customerSN, editor, stationId, customer, inputSucc, onFail);
            return;
        }
        ...
        function ClearJpg(){
			...
			document.getElementById("<%=ShowImage5.ClientID %>").src = '';
			document.getElementById("<%=ShowImage6.ClientID %>").src = '';
			document.getElementById("<%=ShowImage7.ClientID %>").src = '';
		}
		function SetJpg(cnt, partNo){
			...
			switch(cnt){
				...
				case 5:
				    document.getElementById("<%=ShowImage5.ClientID %>").src = file; break;
				case 6:
				    document.getElementById("<%=ShowImage6.ClientID %>").src = file; break;
				case 7:
				    document.getElementById("<%=ShowImage7.ClientID %>").src = file; break;
			}
		}
        ...
        function onPrintSucc(result) {
            ...
            var tmpList = new Array("WWAN ID Label", "Wimax Label",
                    ...
                    "LA NOM Label", "EnergyLabel", "Win8BoxLabel");
