...
{
    setday(showDataArea, showTop, showLeft);
}
...
function setday(showDataArea, showTop, showLeft) //主调函数
{
...
//	if (arguments.length == 0){alert("对不起！您没有传回本控件任何参数！");return;}
	...
	//add by lzy 
	var redundantWidth = (dads.posLeft + 160) - document.body.clientWidth;
	if (redundantWidth > 0)
	    dads.posLeft -= redundantWidth;
	
	var redundantHeight = (dads.posTop + 182) - document.body.clientHeight;
	if (redundantHeight > 0)
	    dads.posTop -= redundantHeight;
