...
<%@ Page Language="C#" ContentType="text/html;Charset=UTF-8" AutoEventWireup="true" CodeFile="FamilyInfoNameMaintain.aspx.cs" Inherits="ModelInfoNameMaintain" Title="" %>
                        ...
                        <td>
                            <table width=100% style="height:100%" border=0 cellpadding=0 cellspacing=0>
                                ...
                                <tr>
                                    ...
                                    <td><asp:TextBox id="txtDesc" MaxLength=80  runat="server" SkinId="textBoxSkin" Height="23px" Width="710"></asp:TextBox></td>
...
<script type="text/javascript">
   ...
   function clkSave()
   {
    ...
    function clickTable(row)
    {
        ...
        document.getElementById("<%=txtName.ClientID%>").value = row.cells[1].innerText.trim();

        document.getElementById("<%=txtDesc.ClientID%>").value = row.cells[2].innerText.trim();
        ...
        if(row.cells[1].innerText.trim() == ""){
            ...
            document.getElementById("<%=hidModelInfoNameId.ClientID%>").value = row.cells[1].innerText.trim();
        }
    ...
    function SaveComplete(id){
        ...
        if(row != null)
        {
            ...
            document.getElementById("<%=txtName.ClientID%>").innerText = row.cells[1].innerText.trim();
            document.getElementById("<%=txtDesc.ClientID%>").value = row.cells[2].innerText.trim();
            document.getElementById("<%=hidModelInfoNameId.ClientID%>").value = row.cells[1].innerText.trim();
