...
<%@ WebService Language="C#" Class="WebServicePCAOQCInput" %>
...
public class WebServicePCAOQCInput: System.Web.Services.WebService
{

    IPCAOQCInput iPCAOQCInput = ServiceAgent.getInstance().GetObjectByName<IPCAOQCInput>(WebConstant.PCAOQCInputObject);
...
[WebMethod]
    ...
    //InputMB
    [WebMethod]
public ArrayList InputMB(string Inputstring, string strType, string editor, string station, string customer)
    {
        ArrayList ret = new ArrayList();
        try
        {
            iPCAOQCInput.saveMB(Inputstring, editor, station, customer);
