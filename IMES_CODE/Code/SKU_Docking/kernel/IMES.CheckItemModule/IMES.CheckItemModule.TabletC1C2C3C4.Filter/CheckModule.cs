...
namespace IMES.CheckItemModule.TabletC1C2C3C4.Filter
{
    ...
    class CheckModule : ICheckModule
    {
        ...
        public void Check(object partUnit, object bomItem, string station)
        {
            ...
            {
                throw new FisException("CHK174", new string[] { "IMES.CheckItemModule.TabletC1C2C3C4.Filter.CheckModule.Check" });
        ...
        private void CheckRegxMatch(object partUnit,string station)
        {
            ...
            {
                throw new FisException("CHK174", new string[] { "IMES.CheckItemModule.TabletC1C2C3C4.Filter.Check" });
            }
