...
namespace IMES.CheckItemModule.TRIS.LCM.Filter
{
    [Export(typeof(IFilterModule))]
    [ExportMetadata("ProgramName", "IMES.CheckItemModule.TRIS.LCM.Filter.dll")]
    public class Filter : IFilterModule, ITreeTraversal
    {
        private int _qty;
        private const string part_check_type = "TRIS-LCM";
        private const string partType = "LCM";
