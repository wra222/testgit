...
namespace IMES.CheckItemModule.TRIS.HDD.Filter
{
    [Export(typeof(IFilterModule))]
    [ExportMetadata("ProgramName", "IMES.CheckItemModule.TRIS.HDD.Filter.dll")]
    public class Filter : IFilterModule, ITreeTraversal
    {
        private int _qty;
        private const string part_check_type = "TRIS-HDD";
        private const string partType = "HDD";
