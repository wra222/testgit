...
namespace IMES.Station.Interface.StationIntf
{
    ...
    /// 
    [Serializable]
    public class SerialNumberExcel
    {
    ...
    public interface ITravelCardPrintExcel
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <param name="remark"></param>
        /// <param name="exception"></param>
        /// <param name="pilotmo"></param>
        /// <param name="pilotmoremainqty"></param>
        /// <returns></returns>
        IList<PrintItem> PrintTCWithProductIDForBN(string pdLine, string model, string mo,
        ...
        IList<IMES.DataModel.ModelInfo> GetModelListForTravelCard(string line, string family);
        ...
        List<SerialNumberExcel> GetPrintLogProidList(string mo);
