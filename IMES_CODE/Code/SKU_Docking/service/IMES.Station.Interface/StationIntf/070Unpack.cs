...
namespace IMES.Station.Interface.StationIntf
{
    ...
    public interface IUnpack
    {
        ...
        /// <param name="station"></param>
        /// <param name="customer"></param>
        void UnpackAllByDN(string proid, string line, string editor, string station, string customer);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="dn"></param>
        /// <returns></returns>
        IList<string> CheckDNAndGetProductListByDN(string dn);
        ...
        void UnpackDNByCarton(string proid, string line, string editor, string station, string customer);
        #endregion
