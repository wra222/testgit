 ...
 * Date         Name                Reason 
 * ==========   =================   =====================================
 * 2011-11-07   Chen Xu (eB1-4)     create
 * Known issues:
 */
...
namespace IMES.Station.Interface.StationIntf
{
    ...
    /// </summary> 
    /// 
    public interface IPalletVerify_BIRCH
    {
        ...
        /// 返回ArrayList
        /// </summary>
        /// <param name="sCheckBoxId">firstSn</param>
        ...
        ArrayList InputFirstCustSn(string sCheckBoxId, string firstSn, string line, string editor, string station, string customer, out int index, out string labeltypeBranch);
        ...
        int InputCustSn(string firstSn, string custSn, out string curInfoBoxId, out string curShipBoxDetId);
        ...
        /// <returns></returns>
        IList<PrintItem> Save(string firstSn, IList<PrintItem> printItems, out ArrayList printparams1, out ArrayList printparams2);
        ...
        /// <param name="labeltypeBranch">labeltypeBranch</param>
        /// <param name="PDFPLLst">PDFPLst</param>
        /// <param name="modelList"></param>
        IList<PrintItem> rePrint(string palletNo, string reason, string line, string editor, string station, string customer, IList<PrintItem> printItems, out ArrayList printparams1, out string labeltypeBranch,out IList<string> PDFPLLst, out IList<string> modelList);

        #endregion
        /// <summary>
        /// GetCustsnListByBoxId
        /// </summary>
        /// <param name="sn">sn</param>
        ArrayList GetCustsnListByBoxId(string sn);
    }
}
