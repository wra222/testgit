...
namespace IMES.Station.Interface.CommonIntf
{
    ...
    public interface IMB_CODE
    {
        ...
        /// <param name="mdlPostfix"></param>
        /// <returns>MBCode信息列表</returns>
        IList<MB_CODEAndMDLInfo> GetMbCodeAndMdlInfoList(string bomNodeType, string partType, string mbType, string mdlType, string mdlPostfix);
    }
    ...
    {   
        ...
        List<string> GetFamilyByFamilyInfo(FamilyInfoDef familyDef);
        /// <summary>
    ...
    public interface IStationSorting
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>StationType信息列表</returns>
        IList<StationInfo> GetStationSortingList();
    }

    public interface IStationReinput
    {
        /// <summary>
        /// SELECT @PAQCSortingStation = Value FROM SysSetting NOLOCK
        /// WHERE Name = 'FAReturnStation'
        /// </summary>
        /// <returns>StationType信息列表</returns>
        IList<StationInfo> GetStationReinputList();
    }

    public interface ILocFloor
    {
        /// <summary>
        /// SELECT DISTINCT FL AS Floor FROM PAK_LocMas
        /// </summary>
        /// <returns></returns>
        IList<string> GetLocFloorList();
    }
