...
namespace IMES.Docking.Implementation
{
    ...
    /// MBLabelPrint
    /// </summary>
    public class FPCBoardLabelPrint : MarshalByRefObject, IFPCBoardLabelPrint, ISMTMO
    {
        ...
        #region IFPCBoardLabelPrint Members
        ...
        public IList<PrintItem> Print(
            ...
            out IList<string> startProdIdAndEndProdId,out int MultiQty, string _111, string factor, IList<PrintItem> printItems)
        {
            logger.Debug("(FPCBoardLabelPrint)Print start, pdLine:" + pdLine + " isNextMonth:" + isNextMonth.ToString() + " mo:" + mo + " qty:" + qty.ToString() + " dateCode:" + dateCode + " editor:" + editor + " stationId:" + stationId + " customerId:" + customerId);
            ...
            try
            {
                ...
                if (Session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(stationId, "FPCBoardLabelPrint.xoml", string.Empty, out wfName, out rlName);
                ...
                MultiQty = (int)Session.GetValue(Session.SessionKeys.MultiQty);
                MBNOList.Add(BegNo);
                MBNOList.Add(EndNo);
            ...
            {
                logger.Debug("(FPCBoardLabelPrint)Print end, pdLine:" + pdLine + " isNextMonth:" + isNextMonth.ToString() + " mo:" + mo + " qty:" + qty.ToString() + " dateCode:" + dateCode + " editor:" + editor + " stationId:" + stationId + " customerId:" + customerId);
        ...
        {
            logger.Debug("(FPCBoardLabelPrint)Reprint start, MBSno:" + mbSno + " Reason:" + reason + " editor:" + editor + " station:" + stationId + " customerId:" + customerId);
            FisException ex;
            List<string> erpara = new List<string>();
            ...
            {
                logger.Debug("(FPCBoardLabelPrint)Reprint end, MBSno:" + mbSno + " Reason:" + reason + " editor:" + editor + " customerId:" + customerId);
            }
        }
