...
{
    public class CheckCombineCT : MarshalByRefObject, ICheckCombineCT
    {
        ...
        #region ICheckCombineCT Members
        ...
        {
            logger.Debug("(ICheckCombineCT)InputProdId start, pdLine:" + pdLine + " input:" + input + " editor:" + editor + " stationId:" + stationId + " customerId:" + customerId);
            ...
            try
            {
                ...
                if (Session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(stationId, "CheckCombineCT.xoml", "CheckCombineCT.rules", out wfName, out rlName);
            ...
            {
                logger.Debug("(ICheckCombineCT)InputProdId end, pdLine:" + pdLine + " input:" + input + " editor:" + editor + " stationId:" + stationId + " customerId:" + customerId);
        ...
        public ArrayList Reprint(string prodid, string reason, string line, string editor, string station, string customer, string pCode, IList<PrintItem> printItems)
        {
           ...
           // string mo = "";
            try
            {
                logger.Debug("(ICheckCombineCT)Reprint start, ProdId:" + prodid + " line:" + line + " editor:" + editor + " customerId:" + customer);
            ...
            {
                logger.Debug("(ICheckCombineCT)Reprint end, ProdId:" + prodid + " line:" + line + " editor:" + editor + " customerId:" + customer);
            }
        }

        public ArrayList Save(string prodId, bool flag, bool flag_39)
        {
            logger.Debug("(ICheckCombineCT)Save start,"
               + " [prodId]: " + prodId);
            FisException ex;
            List<string> erpara = new List<string>();
            ArrayList retrunValue = new ArrayList();
            ...
            {
                logger.Debug("(ICheckCombineCT)Save  End,"
                               + " [prodId]: " + prodId);
            }
