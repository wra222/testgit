...
namespace IMES.Station.Implementation
{
    ...
    public class ChangeToEPIAPIAImpl : MarshalByRefObject, ChangeToEPIAPIA 
    {
        ...
        public List<string> InputProdId(string pdLine, string prodId, string editor, string stationId, string customer, bool isChangetoEpia, out string qcStatus)
        {
            ...
            try
            {
                ...
                if (session == null)
                {
                    ...
                    RouteManagementUtils.GetWorkflow(stationId, "ChangeToEPIAPIA.xoml", "ChangeToEPIAPIA.rules", out wfName, out rlName);
                    WorkflowInstance instance = WorkflowRuntimeManager.getInstance.CreateXomlFisWorkflow(wfName, rlName, wfArguments);

                    session.AddValue(Session.SessionKeys.HasDefect, isChangetoEpia);
