...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class CheckCOANoInputStandard : BaseActivity
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public CheckCOANoInputStandard()
        {
            InitializeComponent();
        }
        ...
        {
            /*
			 * Now for we does not know the coding standard, so here is empty. later will added!
			 */
