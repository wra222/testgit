...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class WriteProductAttrExt : BaseActivity
	{
        /// <summary>
        ///  AttributeName
        /// </summary>
        public static DependencyProperty AttributeNameProperty = DependencyProperty.Register("AttributeName", typeof(string), typeof(WriteProductAttrExt));
        ...
        /// </summary>
        public static DependencyProperty AttributeValueProperty = DependencyProperty.Register("AttributeValue", typeof(string), typeof(WriteProductAttrExt));
        ...
        /// </summary>
        public static DependencyProperty DescrOfProductAttrLogProperty = DependencyProperty.Register("DescrOfProductAttrLog", typeof(string), typeof(WriteProductAttrExt));
       ...
       //          attributeValueStr = CurrentSession.GetValue(Session.SessionKeys.AttributeValue) as string;
                if (CurrentSession.GetValue(AttributeName) != null)
                { attributeValueStr = CurrentSession.GetValue(AttributeName) as string; }
