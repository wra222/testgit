...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class UnPackPackingDataByDeliveryNo : BaseActivity
	{
        /// <summary>
        /// 构造函数
        /// </summary>
        public UnPackPackingDataByDeliveryNo()
		{
			InitializeComponent();
		}
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            currentRepository.UnPackPackingDataByDeliveryNoDefered(CurrentSession.UnitOfWork, CurrentDeliveryNo);
