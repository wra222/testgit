...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class AssignBoxUccForCQ : BaseActivity
    {
        /// <summary>
        /// constructor
        /// </summary>
        public AssignBoxUccForCQ()
        {
            InitializeComponent();
        }
        ...
        [CategoryAttribute("InArugment Of AssignBoxUccForCQ")]
        ...
        public int OverPalletLayer
        {
            get
            {
                return ((int)(base.GetValue(AssignBoxUccForCQ.OverPalletLayerProperty)));
            }
            set
            {
                base.SetValue(AssignBoxUccForCQ.OverPalletLayerProperty, value);
            }
        }
    }
