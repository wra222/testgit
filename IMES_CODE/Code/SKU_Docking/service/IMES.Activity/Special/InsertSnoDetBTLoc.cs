...
namespace IMES.Activity
{
    ...
    public partial class InsertSnoDetBTLoc : BaseActivity
    {
        ...
        ///  Tp
        /// </summary>
        public static DependencyProperty TpProperty = DependencyProperty.Register("Tp", typeof(string), typeof(InsertSnoDetBTLoc), new PropertyMetadata("BTLoc"));
       ...
       // [DefaultValue("BTLoc")]
        ...
        /// Status
        /// </summary>
        public static DependencyProperty StatusProperty = DependencyProperty.Register("Status", typeof(string), typeof(InsertSnoDetBTLoc), new PropertyMetadata("In"));
