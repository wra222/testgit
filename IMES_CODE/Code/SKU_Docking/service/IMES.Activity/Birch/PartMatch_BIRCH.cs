...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class PartMatch_BIRCH : BaseActivity
    {
        /// <summary>
        /// constructor
        /// </summary>
        public PartMatch_BIRCH()
        {
            InitializeComponent();
        }
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            if (bom == null)
            {
              ...
              //  FisException e = new FisException("MAT010", errpara);
                FisException e = new FisException("No BOM Data");
        ...
        private IPartOwner GetPartOwner(PartMatch.BindToEnum bindTo)
        {
            switch (bindTo)
            {
                ...
                case PartMatch.BindToEnum.Nothing:
                    return null;
                default:
        ...
        /// </summary>
        public static DependencyProperty SkipPartCheckProperty = DependencyProperty.Register("SkipPartCheck", typeof(bool), typeof(PartMatch_BIRCH));
        ...
        public bool SkipPartCheck
        {
            get
            {
                return ((bool)(base.GetValue(PartMatch_BIRCH.SkipPartCheckProperty)));
            }
            set
            {
                base.SetValue(PartMatch_BIRCH.SkipPartCheckProperty, value);
            }
        }
        ...
        /// </summary>
        public static DependencyProperty AllowReplaceMatchProperty = DependencyProperty.Register("AllowReplaceMatch", typeof(bool), typeof(PartMatch_BIRCH));
        ...
        public bool AllowReplaceMatch
        {
            get
            {
                return ((bool)(base.GetValue(PartMatch_BIRCH.AllowReplaceMatchProperty)));
            }
            set
            {
                base.SetValue(PartMatch_BIRCH.AllowReplaceMatchProperty, value);
            }
        }
        ...
        /// </summary>
        public static DependencyProperty BindToProperty = DependencyProperty.Register("BindTo", typeof(PartMatch.BindToEnum), typeof(PartMatch_BIRCH));
        ...
        public PartMatch.BindToEnum BindTo
        {
            get
            {
                return ((PartMatch.BindToEnum)(base.GetValue(PartMatch_BIRCH.BindToProperty)));
            }
            set
            {
                base.SetValue(PartMatch_BIRCH.BindToProperty, value);
            }
        }
