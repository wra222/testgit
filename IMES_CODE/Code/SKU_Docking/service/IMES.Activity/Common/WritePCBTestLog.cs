...
namespace IMES.Activity
{
    ...
    public partial class WritePCBTestLog : BaseActivity
    {
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            IList<string> defectList = (IList<string>)session.GetValue(Session.SessionKeys.DefectList);
            ...
            {                
                tItem = new TestLog(0, mb.Sn, line, fixid, this.Station, new List<TestLogDefect>(), TestLog.TestLogStatus.Pass, testLogJoinId,
            ...
            else
            {
                ...
                {
                    tItem = new TestLog(0, mb.Sn, line, fixid, DefectStation, defects, TestLog.TestLogStatus.Fail, testLogJoinId,
                        actionName, errorCode, descr, this.Editor, type, DateTime.Now);
                }
                else //Normal Flow
                {
                    tItem = new TestLog(0, mb.Sn, line, fixid, this.Station, defects, TestLog.TestLogStatus.Fail, testLogJoinId,
                                                   actionName, errorCode, descr, this.Editor, type, DateTime.Now);
                }
            }
