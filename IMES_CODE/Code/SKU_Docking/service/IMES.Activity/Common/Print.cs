...
namespace IMES.Activity
{
    ...
    public partial class Print : BaseActivity
    {
        ...
        private static string AllowNoPrintTemplateStation = "AllowNoPrintTemplateStation";
        /// <summary>
        /// 执行逻辑
        /// </summary>
        ...
        private bool checkExceptStation()
        {
            ActivityCommonImpl utl = ActivityCommonImpl.Instance;
            IList<ConstValueTypeInfo> infoList = null;
            return utl.TryConstValueType(AllowNoPrintTemplateStation, this.Station, out infoList);
        }
        /// <summary>
        /// IsReprint
        /// </summary>
