...
// Description:CI-MES12-SPEC-FA-UC REV Label Print For Docking.docx
//             获取DK类型的DCode            
// Update: 
// Date         Name                         Reason 
// ==========   =======================      ============
// 2012-6-13    Jessica Liu                  create
// Known issues:
//ITC-1414-0140, Jessica Liu,2012-6-13
...
namespace IMES.Activity
{
    ...
    /// <para>
    /// 应用场景：
    ///      应用于REV Label Print For Docking
    /// </para>
    /// <para>
    /// 实现逻辑：
    ///         获取DCode
    ...
    /// </para> 
    /// </remarks>
    public partial class GetDCodeForREVLabelPrint : BaseActivity
    {
        /// <summary>
        /// constructor
        /// </summary>
        public GetDCodeForREVLabelPrint()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            IList<Warranty> warrantys = wr.GetDCodeRuleListForDK(this.Customer);
            ...
            if (wrList.Count() > 0)
            {
                dCode = siteCode + year + month + wrList[0].WarrantyCode;
            }
            else
            {
                List<string> errpara = new List<string>();
                throw new FisException("CHK118", errpara);//DateCode数据丢失!
            }
