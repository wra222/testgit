...
namespace IMES.Activity
{
    ...
    /// </para> 
    /// </remarks>
    public partial class AcquireProdIdSectionForDocking : BaseAcquireActivity
    {
        private static object _syncRoot_GetSeq = new object();

        /// <summary>
        /// </summary>
        public AcquireProdIdSectionForDocking()
        {
            InitializeComponent();
        }
        ...
        protected internal override ActivityExecutionStatus DoExecute(ActivityExecutionContext executionContext)
        {
            ...
            {
                this.AddTemplatesOfAType("ProdId", new IConverter[] { new YearConverterNormal(1,'0',Session.SessionKeys.presentTime),
            ...
            values = partRep.GetValueFromSysSettingByName("HeadOfPrd");
            ...
            else
            {
                ...
                ex = new FisException("CHK848", erpara);
                throw ex;
            }


            preSeqStr = head + preSeqStr;
