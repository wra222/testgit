...
namespace IMES.Docking.Interface.DockingIntf
{
    ...
    /// 2.	实现生产订单追踪
    /// </summary>
    public interface IFPCBoardLabelPrint
    {
        /// <summary>
        /// Print
        /// </summary>
        ...
        /// <returns></returns>
        IList<PrintItem> Print(string pdLine,bool isNextMonth, string mbCode, string mo, int qty, string dateCode, string editor, string stationId, string customerId,
        ...
        /// <param name="printItems"></param>
        /// <returns></returns>
        IList<PrintItem> RePrint(string mbSno,string customerId,string reason,string editor, string stationId,IList<PrintItem> printItems);
