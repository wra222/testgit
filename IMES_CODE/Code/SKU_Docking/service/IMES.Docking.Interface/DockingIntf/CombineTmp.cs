...
namespace IMES.Docking.Interface.DockingIntf
{
    ...
    public interface ICombineTmp
    {
        ...
        IList<BomItemInfo> InputProdIdorCustsn(
            string input,　string editor, string stationId, string customerId, out string realProdID, out string model, out string CustomerSN);
