...
namespace IMES.Service
{
    public partial class IMESService : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            LoadProactiveCache();
            RemotingConfiguration.Configure(currentPath + "IMES.Service.Distribution.exe.config", false);
            RemotingConfiguration.CustomErrorsMode = CustomErrorsModes.Off;
            RemotingConfiguration.CustomErrorsEnabled(false);
            ILog logger = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
            logger.Info("IMES Distribution Service started.");
        }
        ...
        protected override void OnStop()
        {
            ...
            ILog logger = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
            logger.Info("IMES Distribution Service stopped.");
        }
