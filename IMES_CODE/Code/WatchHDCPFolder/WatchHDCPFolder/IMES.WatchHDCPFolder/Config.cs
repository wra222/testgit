...
namespace UTL
{
    public class AppConfig
    {
        ...
        public readonly string SuccessFileFolder;
        public readonly string FailFileFolder;
        ...
        public AppConfig()
        {
            ...
            FileFolder = get_config_value("FileFolder");
            SuccessFileFolder = get_config_value("SuccessFileFolder");
            FailFileFolder = get_config_value("FailFileFolder");
            SPName = get_config_value("SPName");
