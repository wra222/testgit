...
namespace Inventec.HPEDITS.XmlCreator
{
	...
	/// </summary>
	public class BoxLabelXmlCreator : XmlCreator
	{
        ...
        public void LoadBoxLabelDatabaseData(string id)
        {
            ...
            */
            ...
            logger.Debug("LoadBoxLabelDatabaseData v_PAKComn begin");
            DataTable packIDTable = EditsSqlProc.v_PAKComn__by__InternalID(internalID);
            logger.Debug("LoadBoxLabelDatabaseData v_PAKComn end");

            BOXES.BOXDataTable newTable = boxList.BOX;

            logger.Debug("LoadBoxLabelDatabaseData loop begin");
            ...
            foreach (DataRow readRow in packIDTable.Rows)
            {
                ...
                */
                ...
                logger.Debug("LoadBoxLabelDatabaseData PAK_PackkingData InternalID begin");
                DataTable boxTable = EditsSqlProc.PAK_PackkingData__by__InternalID__SERIAL_NUM(internalID, SerialNum);
                logger.Debug("LoadBoxLabelDatabaseData PAK_PackkingData InternalID end");

                //newRow.SERIAL_NUM = boxTable.Rows[0]["SERIAL_NUM"].ToString().Trim();  //removed 1019 for new version of 0923
				//get BoxID
                ChkRowNotNull("BoxLabelXmlCreator id=" + id + ", PAK_PackkingData internalID=" + internalID + ", SerialNum=" + SerialNum, boxTable);
                ...
                string whereBoxSEQUENCE = "WHERE ID<= (select ID from [PAK_PackkingData] where InternalID='" + internalID + "' and SERIAL_NUM='" + SerialNum + "') and left(InternalID,10)='" + internalID.Substring(0, 10) + "'";// and InternalID='" + internalID + "'";
                DataTable boxTableSEQUENCE = DBFactory.PopulateTempTable("[PAK_PackkingData]", whereBoxSEQUENCE, fieldsSEQUENCE);
                */

                logger.Debug("LoadBoxLabelDatabaseData PAK_PackkingData Cdt begin");
                ...
                logger.Debug("LoadBoxLabelDatabaseData PAK_PackkingData Cdt end");

                ChkRowNotNull("BoxLabelXmlCreator id=" + id + ", PAK_PackkingData internalID=" + internalID + ", SerialNum=" + SerialNum, boxTableSEQUENCE);
                ...
                */
                ...
                logger.Debug("LoadBoxLabelDatabaseData PAK_PackkingData SERIAL_NUM,BOX_ID begin");
                DataTable BoxTableUNITQTY = EditsSqlProc.count__PAK_PackkingData__by__BOX_ID(newRow.BOX_ID.ToString());
                logger.Debug("LoadBoxLabelDatabaseData PAK_PackkingData SERIAL_NUM,BOX_ID end");

                ChkRowNotNull("BoxLabelXmlCreator id=" + id + ", PAK_PackkingData BOX_ID=" + newRow.BOX_ID.ToString(), BoxTableUNITQTY);
                ...
                */
                ...
                logger.Debug("LoadBoxLabelDatabaseData PAK_PackkingData BOX_ID begin");
                DataTable SERIALTable = EditsSqlProc.PAK_PackkingData__by__BOX_ID(newRow.BOX_ID.ToString().Trim());
                logger.Debug("LoadBoxLabelDatabaseData PAK_PackkingData BOX_ID end");
                ...
                */
                ...
                ChkRowNotNull("BoxLabelXmlCreator id=" + id + ", PAKEDI_INSTR internalID=" + internalID, packIDTable);
                ...
                */
                ...
                //ChkRowNotNull("BoxLabelXmlCreator id=" + id + ", PAKODMSESSION", boxTable);
                ...
                /*
                //get BIG_DEAL_END_USER
                string whereLneItemClause_BIG = "WHERE PO_NUM='" + packIDTable.Rows[0]["PO_NUM"].ToString().Trim() + "' and FIELDS = 'LABEL_INSTR_HEAD'";
                DataTable lineItemTable_BIG = DBFactory.PopulateTempTable("[PAKEDI_INSTR]", whereLneItemClause_BIG, fields);
                foreach (DataRow readRow3 in lineItemTable_BIG.Rows) 
                {
                    LoadKeyValuePairs(boxList.UDF_HEADER,
                        readRow3,
                        "FIELDS",
                ...
                */
                //--------------add  by  Fan 20091119  -------------
                string whereTwoD = "'" + internalID + "', ''";

                logger.Debug("LoadBoxLabelDatabaseData op_TwoDCode_Solution_Box begin");
                DataTable TwoDTable = EditsSqlProc.sp__op_TwoDCode_Solution_Box(internalID, "");
                logger.Debug("LoadBoxLabelDatabaseData op_TwoDCode_Solution_Box end");

                ChkRowNotNull("BoxLabelXmlCreator id=" + id + ", PAKEDI_INSTR internalID=" + internalID, TwoDTable);
            ...
            logger.Debug("LoadBoxLabelDatabaseData loop end");
