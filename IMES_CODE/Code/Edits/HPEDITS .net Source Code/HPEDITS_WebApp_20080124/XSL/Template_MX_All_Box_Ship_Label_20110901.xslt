									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" line-height="8pt" table-layout="fixed" width="100%">
										...
										<fo:table-body line-height="8pt" start-indent="0pt">
											<fo:table-row border-collapse="collapse" line-height="6pt" width="100%">
												...
												<fo:table-cell border="none" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="0.5" border-collapse="collapse" font-family="Arial" font-size="6pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" text-align="left">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" line-height="6.5pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" number-rows-spanned="2" padding="2pt" height="1" text-align="center">
													<fo:block>
														...
														<fo:block/>
														<fo:inline>
															<xsl:text>HEWLETT PACKARD MEXICO, S. DE R.L. DE C.V.</xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row margin="none" padding="none">
												...
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" line-height="11pt" margin="none" padding="none" number-columns-spanned="4" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline font-size="7pt" font-weight="bold">
															<xsl:text>LAMXBOX110901</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
