									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row margin="none" padding="none">
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" line-height="8pt" margin="none" padding="none" height="1" text-align="left" display-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
												...
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" font-weight="bold" line-height="8pt" margin="none" padding="none" number-columns-spanned="5" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>LAARBOX110901</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
