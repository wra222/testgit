					...
					<fo:block>
						...
						<fo:table border="1pt" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="double" border-top-width="thick" font-family="Arial" font-size="8pt" font-style="normal" font-variant="normal" font-weight="normal" height="14pt" line-height="14pt" margin="0pt" table-layout="fixed" width="100%">
							...
							<fo:table-body start-indent="0pt">
								...
								<fo:table-row>
									<fo:table-cell border="none" line-height="8pt" number-columns-spanned="4" padding="2pt" height="12" display-align="center">
										<fo:block>
											<fo:inline>
								...
								<fo:table-row>
									<fo:table-cell border="none" line-height="10pt" number-columns-spanned="4" padding="2pt" display-align="center">
										<fo:block>
											<fo:inline>
								...
								<fo:table-row>
									...
									<fo:table-cell border="none" border-bottom-style="none" padding="2pt" display-align="center">
										<fo:block>
											<fo:inline>
												<xsl:text>___________________</xsl:text>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>EGLAWAY121127</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
						...
						<fo:table-row>
							<fo:table-cell border="none" font-size="smaller" padding="0" height="9" text-align="left" display-align="center">
								<fo:block/>
							</fo:table-cell>
							<fo:table-cell border="none" font-size="smaller" padding="0" height="9" text-align="right" display-align="center">
								<fo:block/>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
