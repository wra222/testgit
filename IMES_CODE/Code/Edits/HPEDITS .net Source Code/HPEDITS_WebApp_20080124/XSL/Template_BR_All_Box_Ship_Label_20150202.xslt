	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="default-page" page-height="55mm" page-width="127mm" margin-left="0.2cm" margin-right="0.2cm">
				<fo:region-body margin-top="0.05cm" margin-bottom="-0.5cm"/>
								...
								<xsl:for-each select="BOX">
									...
									<fo:table border="none" border-bottom="0.5pt" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" line-height="7pt" table-layout="fixed" width="100%">
										...
										<fo:table-body border-bottom="0.5pt" start-indent="0pt">
											<fo:table-row border-bottom="0.5pt" border-collapse="collapse" line-height="7pt" width="100%">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="5.5pt" font-weight="bold" line-height="5.5pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" number-rows-spanned="2" padding="2pt" height="1" text-align="center">
													<fo:block>
														...
														<fo:block/>
														<fo:inline>
															<xsl:text>HEWLETT PACKARD BRASIL LTDA (HP)</xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline>
															<xsl:text>AV. JOSÉ LUIZ MAZALI Nº 360 - GALPÃO B-PARTE 1-BAIRRO</xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline>
															<xsl:text> RESIDENCIAL BURCK - LOUVEIRA/SP - CEP: 13290-000</xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline>
															<xsl:text>CNPJ: 61.797.924/0007-40</xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline>
															<xsl:text>Inscr. Estadual: 421.078.076.114</xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline>
															<xsl:text>Inscr. Municipal: 5772-0</xsl:text>
														</fo:inline>
														<fo:inline font-size="5.5pt" line-height="6pt" display-align="before">
															<xsl:text>&#160;</xsl:text>
														</fo:inline>
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-size="7pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" height="1" display-align="center">
													<fo:block>
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="2pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="1" display-align="center">
													<fo:block>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="2pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" text-align="right" display-align="center">
													<fo:block>
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="2pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="1" text-align="left" display-align="center">
													<fo:block>
														<fo:inline font-weight="bold" line-height="5.5pt">
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row margin="none" padding="none">
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" margin="none" padding="none" height="4" display-align="center">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
															...
															<fo:block>
																<xsl:for-each select="UDF_HEADER">
																	<xsl:if test="./KEY = &apos;ODM_TEXT1&apos; and string-length(./VALUE)&gt;0">
																		<fo:inline font-family="Arial" font-size="6pt" font-weight="bold" display-align="before">
												...
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="5pt" font-weight="bold" margin="none" padding="none" number-columns-spanned="4" height="4" text-align="right" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>LABRBOX150202</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
