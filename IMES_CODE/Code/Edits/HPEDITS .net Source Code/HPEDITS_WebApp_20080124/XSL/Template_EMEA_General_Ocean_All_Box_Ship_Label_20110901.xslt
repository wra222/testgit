									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-weight="normal" line-height="7pt" table-layout="fixed" width="100%">
										...
										<fo:table-body font-weight="normal" start-indent="0pt">
											<fo:table-row border-collapse="collapse" width="100%">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="8pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="48" text-align="left">
													<fo:block>
														<fo:block/>
											...
											<fo:table-row border-collapse="collapse" width="100%">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-weight="normal" line-height="7pt" display-align="auto" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" height="6" text-align="right">
													<fo:block>
														<fo:inline>
															<xsl:text>&#160;</xsl:text>
														</fo:inline>
											...
											<fo:table-row border-collapse="collapse" font-weight="normal" width="100%">
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-weight="normal" line-height="10.5pt" display-align="text-bottom" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" number-rows-spanned="2" padding="2pt" height="48" text-align="right">
													<fo:block>
														<fo:inline font-family="Arial" font-size="8pt" font-weight="bold" line-height="10pt">
															<xsl:text>&#160; </xsl:text>
														</fo:inline>
														<fo:inline font-family="Arial" font-size="8pt" font-weight="bold" line-height="11pt">
															<xsl:text>PACK ID:&#160; </xsl:text>
														</fo:inline>
														<xsl:for-each select="PACK_ID">
															<xsl:variable name="value-of-template">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																	<fo:block font-size="8pt" font-weight="bold" line-height="11pt">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:block>
																</xsl:when>
																<xsl:otherwise>
																	<fo:inline font-size="8pt" font-weight="bold" line-height="11pt">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:inline>
																</xsl:otherwise>
															</xsl:choose>
														...
														<fo:block/>
														<fo:inline font-family="Free 3 of 9 Extended" font-size="24pt" line-height="10pt">
															<xsl:text>*</xsl:text>
														</fo:inline>
														<xsl:for-each select="CUST_PO">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																	<fo:block font-family="Free 3 of 9 Extended" font-size="24pt" line-height="10pt">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:block>
																</xsl:when>
																<xsl:otherwise>
											...
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" line-height="8pt" display-align="text-top" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1">
													<fo:block>
														<fo:inline font-family="Free 3 of 9 Extended" font-size="30pt">
															<xsl:text>*</xsl:text>
														</fo:inline>
														...
														<fo:inline font-family="Arial" font-size="8pt" font-weight="bold" display-align="auto">
															<xsl:text>BOX ID:</xsl:text>
														</fo:inline>
														<fo:inline font-family="Arial" font-size="7pt" font-weight="bold" display-align="auto">
															<xsl:text>&#160;</xsl:text>
														</fo:inline>
														<xsl:for-each select="BOX_ID">
															<xsl:variable name="value-of-template">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																	<fo:block font-size="8pt" font-weight="bold" display-align="auto">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:block>
																</xsl:when>
																<xsl:otherwise>
																	<fo:inline font-size="8pt" font-weight="bold" display-align="auto">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:inline>
																</xsl:otherwise>
															</xsl:choose>
									...
									<fo:table border="none" border-collapse="collapse" margin="none" padding="none" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row margin="none" padding="none">
												...
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-weight="normal" line-height="4pt" margin="none" padding="none" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline font-family="Arial" font-size="6pt" font-weight="bold">
															<xsl:text>EMEAOBOX110901</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
