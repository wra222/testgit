					...
					<fo:block>
						<xsl:for-each select="$XML">
									...
									<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" padding="0pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row background-color="#787878" color="white">
												<fo:table-cell border="none" padding="2pt" height="20" text-align="center" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" number-columns-spanned="2" padding="2pt" height="20" text-align="center" display-align="center">
													<fo:block>
														<fo:inline>
											...
											<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" padding="0pt" table-layout="fixed" width="100%">
												...
												<fo:table-body start-indent="0pt">
													<fo:table-row>
														...
														<fo:table-cell border="none" line-height="30pt" padding="2pt" text-align="center" display-align="center">
															<fo:block>
																<fo:inline>
							...
							<fo:table border="none" border-collapse="collapse" border-style="none" font-family="Arial" font-size="8pt" font-style="normal" font-variant="normal" font-weight="normal" padding="0pt" display-align="before" table-layout="fixed" width="100%">
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										<fo:table-cell border="none" border-style="none" padding="0pt" display-align="before" height="37">
											<fo:block/>
										</fo:table-cell>
										<fo:table-cell border="none" border-style="none" padding="0pt" height="37" text-align="right" display-align="center">
											<fo:block>
												<fo:inline-container>
													<fo:block>
														<xsl:text>&#x2029;</xsl:text>
										...
										<fo:table-cell border="none" border-style="none" padding="0pt" display-align="before" height="37" text-align="right">
											<fo:block/>
										</fo:table-cell>
										<fo:table-cell border="none" border-style="none" padding="0pt" display-align="before" height="37" text-align="right">
											<fo:block/>
		...
		<fo:static-content flow-name="xsl-region-before">
			<fo:block>
				...
				<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" font-style="normal" font-variant="normal" font-weight="normal" padding="0pt" table-layout="fixed" width="100%">
					...
					<fo:table-column column-width="153"/>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>EMEARAILPK140630</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
