								...
								<xsl:for-each select="BOX">
											...
											<fo:table-row border-collapse="collapse" line-height="7pt" width="100%">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" number-rows-spanned="2" padding="2pt" height="1" text-align="center">
													<fo:block>
														...
														<fo:block/>
														<fo:inline>
															<xsl:text>HEWLETT PACKARD ARGENTINA S.R.L.</xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline>
															<xsl:text>Montañeses 2150, 1428 - Capital Federal, </xsl:text>
														</fo:inline>
														<fo:block/>
														<fo:inline>
															<xsl:text>Buenos Aires, Argentina</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-size="7pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="8" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="8" text-align="right" display-align="center">
													<fo:block>
											...
											<fo:table-row>
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" line-height="3pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="6" display-align="center">
													<fo:block>
														<fo:inline>
												...
												<fo:table-cell border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="5pt" font-weight="bold" line-height="4pt" margin="none" padding="none" number-columns-spanned="5" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline font-size="5pt">
															<xsl:text>LAARBOX140217</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
