									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" font-family="Arial" font-size="6pt" line-height="7pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial" font-size="6pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="48" display-align="before">
													<fo:block>
												...
												<fo:table-cell border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial" font-size="7pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="48" text-align="right" display-align="before">
													<fo:block>
														...
														<fo:inline font-size="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed">
															<xsl:text>EMEAOBOX101210M</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="8pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="48" text-align="right">
													<fo:block>
														<fo:block/>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="10pt" font-weight="bold" display-align="center" padding="2pt" height="6" text-align="right">
													<fo:block>
														<fo:inline>
											...
											<fo:table-row border-collapse="collapse" width="100%">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="10pt" font-weight="normal" line-height="8pt" number-columns-spanned="2" padding="2pt" height="6" text-align="right" display-align="center">
													<fo:block>
														<fo:inline font-family="Arial" font-size="7pt">
											...
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="10pt" font-weight="normal" line-height="9pt" number-columns-spanned="2" padding="2pt" height="6" text-align="right" display-align="center">
													<fo:block>
											...
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="8pt" font-weight="bold" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-rows-spanned="2" padding="2pt" height="48" text-align="right">
													<fo:block>
														<fo:block/>
														<fo:inline font-family="Free 3 of 9 Extended" font-size="30pt">
															<xsl:text>*</xsl:text>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="10pt" font-weight="bold" display-align="center" number-rows-spanned="2" padding="2pt" height="6" text-align="right">
													<fo:block>
														<fo:inline>
															<xsl:value-of select="substring(SUB_REGION , 1 , $SUB_REGION_max)"/>
														</fo:inline>
											...
											<fo:table-row border-collapse="collapse" width="100%">
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" line-height="8pt" display-align="after" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="2" padding="2pt" height="1">
													<fo:block>
