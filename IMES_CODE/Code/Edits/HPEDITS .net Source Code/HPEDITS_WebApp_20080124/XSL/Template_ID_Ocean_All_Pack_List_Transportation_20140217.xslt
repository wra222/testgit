...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:param name="SHIP_FROM_COUNTRY_NAME_max" select="'25'"/>
							...
							<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="10pt" padding="0pt" table-layout="fixed" width="100%">
								...
								<fo:table-body start-indent="0pt">
									...
									<fo:table-row>
										...
										<fo:table-cell border="none" padding="0pt" padding-left="3pt" text-align="left" display-align="center">
											<fo:block>
												<fo:block/>
			...
			<fo:block>
				...
				<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" font-style="normal" font-variant="normal" font-weight="normal" padding="0pt" table-layout="fixed" width="100%">
					...
					<fo:table-body start-indent="0pt">
						...
						<fo:table-row>
							<fo:table-cell border="none" line-height="8pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="810">
								<fo:block>
									<fo:block/>
									<xsl:for-each select="$XML">
										<xsl:for-each select="PACK_ID">
							...
							<fo:table-cell border="none" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="810">
								<fo:block>
							...
							<fo:table-cell border="none" font-size="8pt" display-align="before" padding="2pt" height="810">
								<fo:block>
									<fo:inline>
							...
							<fo:table-cell border="none" font-size="8pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="810">
								<fo:block>
									<fo:inline>
										<xsl:text>: </xsl:text>
									</fo:inline>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
							<fo:table-cell border="none" padding="0" height="30" text-align="left" display-align="center">
								<fo:block>
									<fo:inline>
										<xsl:text>IDOPKT140217</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
						...
						<fo:table-row>
							<fo:table-cell border="none" font-size="smaller" padding="0" number-columns-spanned="2" text-align="left" display-align="center">
								<fo:block>
									<fo:inline font-weight="bold">
										<xsl:text>Document: C:\Documents and Settings\david_riffel\My Documents\AllmyESG2\Active Projects\Direct Ship Stuff\b-EDITS Docs in HVLS SP\Pack List\Template_WW_General_All_Pack_List_Transportation_20080416.sps</xsl:text>
									</fo:inline>
								</fo:block>
							</fo:table-cell>
