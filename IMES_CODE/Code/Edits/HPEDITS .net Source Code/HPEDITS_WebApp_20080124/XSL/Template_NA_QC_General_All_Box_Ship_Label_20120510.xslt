											...
											<fo:table-row border-collapse="collapse" width="100%">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="normal" line-height="6.5pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-rows-spanned="3" padding="2pt" display-align="before">
													<fo:block>
														...
														<fo:block/>
														<fo:inline font-size="6pt" font-weight="bold">
															<xsl:text>Customer SKU / SKU Client:</xsl:text>
														</fo:inline>
														<fo:inline font-size="6pt" font-weight="bold">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="6pt" font-weight="normal" line-height="6.5pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="right" display-align="before">
													<fo:block>
														<fo:inline font-size="6pt" font-weight="bold">
															<xsl:text>Carrier / Transporteur: </xsl:text>
														</fo:inline>
														<fo:inline font-size="6pt" font-weight="bold">
														...
														<fo:block/>
														<fo:inline font-size="6pt" font-weight="bold">
															<xsl:text>P/N / No Pièce:</xsl:text>
														</fo:inline>
														<fo:inline font-size="6pt" font-weight="bold">
									...
									<fo:table border="none" border-collapse="collapse" border-top-style="none" height="4pt" line-height="4pt" width="100%" table-layout="fixed">
										...
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row line-height="3pt">
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="7pt" font-weight="normal" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" display-align="before">
													<fo:block>
														<fo:inline font-family="Free 3 of 9 Extended" font-size="24pt">
															<xsl:text>*</xsl:text>
														</fo:inline>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" display-align="after" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="right">
													<fo:block>
														<fo:inline font-weight="bold">
											...
											<fo:table-row font-family="Free 3 of 9 Extended" font-size="20pt" line-height="2pt" width="100%">
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="4" padding="2pt" text-align="left" display-align="center">
													<fo:block>
														<fo:inline font-weight="bold">
												...
												<fo:table-cell border="none" font-family="Arial" font-size="6pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="right" display-align="center">
													<fo:block>
														<fo:inline font-weight="bold">
															<xsl:text>Qté Boites: 1 [Total / Boites : </xsl:text>
														</fo:inline>
														<xsl:for-each select="BOX_SEQUENCE">
															<xsl:variable name="value-of-template">
																<xsl:apply-templates/>
									...
									<fo:table border="none" border-collapse="collapse" line-height="8pt" table-layout="fixed" width="100%">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row line-height="2pt">
												...
												<fo:table-cell border="none" border-bottom-style="none" border-collapse="collapse" font-family="Arial" font-size="5pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" text-align="right" display-align="before">
													<fo:block>
														<fo:inline font-weight="bold">
															<xsl:text>NAQCBOX120510</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
