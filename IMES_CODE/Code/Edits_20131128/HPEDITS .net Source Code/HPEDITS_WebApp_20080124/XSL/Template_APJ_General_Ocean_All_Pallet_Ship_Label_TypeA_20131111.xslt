								...
								<xsl:for-each select="PALLET">
									...
									<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="10pt" font-weight="bold" line-height="7pt" table-layout="fixed" width="100%">
										...
										<fo:table-body border="none" start-indent="0pt">
											<fo:table-row border="none" height="5pt" line-height="5pt" width="100%">
									...
									<fo:table border="none" height="20pt" display-align="before" table-layout="fixed" width="100%" border-spacing="2pt">
										...
										<fo:table-body border="none" start-indent="0pt">
											<fo:table-row border="none" width="100%">
												<fo:table-cell border="none" display-align="before" padding="2pt" height="1" text-align="left">
													<fo:block>
														<fo:external-graphic border="none" border-collapse="separate" content-height="45pt" display-align="before" content-width="45pt">
												...
												<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="9pt" font-weight="bold" line-height="10pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1">
													<fo:block>
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" font-family="Arial" font-size="10pt" height="9pt" line-height="10pt" table-layout="fixed" width="100%">
										...
										<fo:table-body border="none" start-indent="0pt">
											<fo:table-row border="none" width="100%">
												<fo:table-cell border="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:inline border="none">
									...
									<fo:table border="none" border-collapse="collapse" font-size="10pt" line-height="14pt" table-layout="fixed" width="100%">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body border="none" start-indent="0pt">
											<fo:table-row border="none" font-family="Free 3 of 9 Extended" font-size="22pt">
												<fo:table-cell border="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" display-align="center">
													<fo:block>
														...
														<xsl:for-each select="CUST_PO">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																	<fo:block border="none" font-size="20pt">
									...
									<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="10pt" line-height="10pt" width="100%" table-layout="fixed">
										...
										<fo:table-body border="none" start-indent="0pt">
											<fo:table-row border="none">
												<fo:table-cell border="none" number-columns-spanned="11" padding="2pt" height="1" display-align="after">
													<fo:block>
											...
											<fo:table-row border="none">
												<fo:table-cell border="none" line-height="6pt" padding="2pt" height="1" text-align="left" display-align="center">
													<fo:block>
														<fo:inline border="none" font-size="10pt">
												...
												<fo:table-cell border="none" line-height="6pt" number-columns-spanned="6" padding="2pt" height="1" display-align="center">
													<fo:block>
												...
												<fo:table-cell border="none" line-height="6pt" padding="2pt" height="1" text-align="center" display-align="center">
													<fo:block>
														<fo:inline border="none">
												...
												<fo:table-cell border="none" line-height="10pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="1" text-align="left" display-align="center">
													<fo:block/>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row border="none">
												<fo:table-cell border="none" font-family="Free 3 of 9 Extended" font-size="20pt" line-height="20pt" padding="0pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="11" height="1" display-align="before">
													<fo:block>
														<fo:inline border="none" font-size="20pt">
															<xsl:text>*</xsl:text>
														</fo:inline>
											...
											<fo:table-row border="none" height="6pt">
												<fo:table-cell border="none" line-height="10pt" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:inline border="none" font-size="10pt">
												...
												<fo:table-cell border="none" padding="2pt" height="1" display-align="center">
													<fo:block>
														<xsl:for-each select="SHIP_REF">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																	<fo:block border="none" font-size="10pt">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:block>
																</xsl:when>
																<xsl:otherwise>
												...
												<fo:table-cell border="none" line-height="10pt" number-columns-spanned="9" padding="2pt" height="1" text-align="center" display-align="center">
													<fo:block>
														<fo:inline border="none" font-size="10pt">
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" line-height="14pt" table-layout="fixed" width="100%">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body border="none" start-indent="0pt">
											<fo:table-row border="none" border-top="1pt" border-top-color="black" border-top-style="solid" line-height="14pt">
												<fo:table-cell border="none" font-family="Arial" font-size="12pt" font-weight="bold" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:inline border="none">
											...
											<fo:table-row border="none" line-height="20pt">
												<fo:table-cell border="none" font-family="Free 3 of 9 Extended" font-size="24pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" display-align="before">
													<fo:block>
														...
														<xsl:for-each select="PACK_ID">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																	<fo:block border="none" font-size="24pt">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:block>
																</xsl:when>
																<xsl:otherwise>
											...
											<fo:table-row border="none" line-height="20pt">
												<fo:table-cell border="none" font-family="Free 3 of 9 Extended" font-size="24pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" height="1" display-align="center">
													<fo:block>
														<fo:inline border="none">
															<xsl:text>*</xsl:text>
														</fo:inline>
									...
									<fo:table border="none" border-bottom="1pt" border-bottom-color="black" border-bottom-style="solid" border-collapse="collapse" border-style="none" font-family="Arial" font-size="8pt" height="2pt" line-height="2pt" table-layout="fixed" width="100%">
										<fo:table-column column-width="30%"/>
										<fo:table-column column-width="70%"/>
										<fo:table-body border="none" start-indent="0pt">
											<fo:table-row border="none" line-height="10pt" width="100%">
												<fo:table-cell border="none" padding="2pt" height="1" display-align="before">
													<fo:block>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
												...
												<fo:table-cell border="none" font-family="Arial" font-size="4pt" line-height="3pt" padding="2pt" height="1" text-align="right" display-align="center">
													<fo:block>
														<fo:inline border="none">
															<xsl:text>GCAGLAPAOA131111</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
