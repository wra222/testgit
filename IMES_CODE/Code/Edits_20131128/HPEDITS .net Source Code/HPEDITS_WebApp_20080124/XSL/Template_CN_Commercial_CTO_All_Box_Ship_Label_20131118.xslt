										...
										<fo:table-body border="none" font-weight="normal" line-height="5pt" start-indent="0pt">
												...
												<fo:table-cell border="none" border-left-style="none" font-family="Arial" font-size="8pt" font-weight="normal" line-height="6.8pt" display-align="before" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-rows-spanned="3" padding="2pt" height="1" text-align="right">
													<fo:block>
														...
														<xsl:for-each select="SHIP_REF">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template),'&#x2029;')">
																	<fo:block border="none" font-size="6pt">
																		<xsl:copy-of select="$value-of-template"/>
																	</fo:block>
																</xsl:when>
																<xsl:otherwise>
											...
											<fo:table-row border="none" border-collapse="collapse" width="100%">
												<fo:table-cell border="none" border-collapse="collapse" font-family="Arial" font-size="8pt" font-weight="bold" line-height="7pt" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" number-columns-spanned="3" padding="2pt" height="1" display-align="before">
													<fo:block>
														<fo:inline border="none" font-family="微软雅黑" font-size="8pt" font-weight="normal">
															<xsl:text>收货方/运到 :</xsl:text>
														</fo:inline>
														<fo:inline border="none" font-family="Arial" font-size="6pt">
															<xsl:text>&#160;</xsl:text>
														</fo:inline>
														<fo:inline border="none" font-family="Arial" font-size="8pt" font-weight="normal" line-height="4pt">
															<xsl:value-of select="substring(SHIP_TO_ID , 1 , $SHIP_TO_ID_max )"/>
														</fo:inline>
														<fo:block/>
														<fo:inline border="none" font-family="微软雅黑" font-size="8pt" font-weight="normal" line-height="4pt">
