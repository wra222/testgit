						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="PALLETS">
								<xsl:for-each select="PALLET">
									...
									<fo:table border="none" font-size="24pt" height="14pt" line-height="14pt" table-layout="fixed" width="100%" border-spacing="2pt">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row border="none" font-family="Free 3 of 9 Extended" font-size="24pt" line-height="17pt">
												<fo:table-cell border="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>*</xsl:text>
									...
									<fo:table border="none" border-collapse="collapse" font-family="Arial" font-size="10pt" line-height="13pt" width="100%" table-layout="fixed">
										<fo:table-column column-width="35%"/>
										<fo:table-column column-width="65%"/>
										<fo:table-body start-indent="0pt">
											...
											<fo:table-row>
												<fo:table-cell border="none" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Box qty / Pallet</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
											...
											<fo:table-row>
												<fo:table-cell border="none" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Box qty / Pack ID </xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="none" white-space-collapse="true" linefeed-treatment="treat-as-space" wrap-option="no-wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
									...
									<fo:table border="none" border-collapse="collapse" border-top="1pt" border-top-color="black" border-top-style="solid" font-size="10pt" height="14pt" line-height="14pt" table-layout="fixed" width="100%">
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-body start-indent="0pt">
									...
									<fo:table border-bottom="1pt" border-bottom-color="black" border-bottom-style="solid" border-collapse="collapse" border-style="none" font-family="Arial" font-size="8pt" height="14pt" line-height="14pt" table-layout="fixed" width="100%" border="solid 1pt gray">
										<fo:table-column column-width="30%"/>
										<fo:table-column column-width="30%"/>
										<fo:table-column column-width="35%"/>
										<fo:table-body start-indent="0pt">
											<fo:table-row line-height="2pt" width="100%">
												<fo:table-cell border="none" number-columns-spanned="2" padding="2pt" display-align="before">
													<fo:block/>
												</fo:table-cell>
												<fo:table-cell border="none" font-family="Arial" font-size="7pt" display-align="center" number-rows-spanned="3" padding="2pt" text-align="right">
													<fo:block>
														<fo:inline>
															<xsl:text>NAVEPAA091211</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row width="100%">
												<fo:table-cell border="none" font-family="Arial" font-size="8pt" padding="2pt" display-align="before">
													<fo:block>
												...
												<fo:table-cell border="none" padding="2pt" display-align="before">
													<fo:block>
														...
														<xsl:for-each select="PACK_ID_PALLET_SEQUENCE">
															<xsl:variable name="value-of-template">
																<xsl:apply-templates/>
															</xsl:variable>
															<xsl:choose>
														...
														<xsl:for-each select="PACK_ID_PALLET_QTY">
															<xsl:variable name="value-of-template">
																<xsl:apply-templates/>
															</xsl:variable>
															<xsl:choose>
