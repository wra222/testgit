...
//						return EncodedData;
	...
	public	string UCC128(string InputValue)
		{
			string tempInput = "";
            int a = Microsoft.VisualBasic.Strings.AscW(InputValue.Substring(0, 1));
        //InputValue.Substring(0,1).Equals(Microsoft.VisualBasic.Strings.Asca())
            if ((a == 202) | ((a > 211) & (a < 219)))
            { }
            else
            {
                tempInput = Microsoft.VisualBasic.Strings.ChrW(202) + InputValue;
            }
            //if(InputValue.Substring(0, 1).Equals("?") == false)
