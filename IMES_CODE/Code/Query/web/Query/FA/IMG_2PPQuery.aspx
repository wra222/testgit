<%@ Page Title="ProductDistribute" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="IMG_2PPQuery.aspx.cs" Inherits="Query_FA_IMG_2PPQuery" EnableEventValidation="false" %>
...
<center>
 <fieldset id="grpCarton" style="border: thin solid #000000;">
    <legend align ="left" style ="height :20px" >
       <asp:Label ID="lblTitle" runat="server" Text="IMG_2PP" CssClass="iMes_label_13pt"></asp:Label></legend> 
         <table border="0" width="100%" style="font-family: Tahoma">                    
            <tr>
                ...
                <td rowspan="3" width="25%" >
                    ...
                    <asp:RadioButton Name="rbGroup" ID="rbIMG" runat="server" Text="IMG" 
                        Checked="true" GroupName="rbgroup"/>
                    <asp:RadioButton Name="rbGroup" ID="rb2PP" runat="server" Text="2PP" 
                        GroupName="rbgroup"/>                    
                    <br />
            ...
            <tr>
               ...
               <td >
                    <asp:Label ID="lblModel" runat="server" Text="ProductID:" CssClass="iMes_label_13pt"></asp:Label>
                </td>
               <td >
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server" >
            <ContentTemplate>
                <iMES:GridViewExt ID="gvResult" runat="server" AutoGenerateColumns="true" 
                    GvExtHeight="450px" GvExtWidth="100%" Height="1px" ShowFooter="True" 
                    style="top: 0px; left: -4px; width: 100%">            
                </iMES:GridViewExt>
            </ContentTemplate>
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="btnQuery" EventName="serverclick" />
