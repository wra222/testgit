<%@ Page Title="ProductDistribute" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="ProductRepairQuery.aspx.cs" Inherits="Query_FA_ProductRepairQuery" EnableEventValidation="false" %>
    ...
    <legend align ="left" style ="height :20px" >
       <asp:Label ID="lblTitle" runat="server" Text="ProductRepairQuery" 
         ...
         <table border="0" width="100%" style="font-family: Tahoma">                    
            ...
            <tr>
               <td >
                    <asp:Label ID="lblSN" runat="server" Text="SN\ProductID：" 
