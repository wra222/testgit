<%@ Page Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="TouchGlassTimeQuery.aspx.cs" Inherits="Query_FATouchGlassTime_Query" Title="Untitled Page" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
       ...
       <label id= "lbPlanFile" CssClass="iMes_label_13pt" align="right">QueryFile: </label>
        ...
        <button type="button" style ="width:60px;  " id="btnUpload"  onclick=" clickUpload();"   >
                    ...
                    <button id="btnExport" runat="server" onserverclick="btnExport_Click" 
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <asp:Label ID="CT" runat="server" Text="CT:"></asp:Label>
