...
public partial class Query_PAK_COARMAQuery : IMESQueryBasePage
{
   ...
   // IMES.Query.Interface.QueryIntf.IFamily Family = ServiceAgent.getInstance().GetObjectByName<IMES.Query.Interface.QueryIntf.IFamily>(WebConstant.IFamilyBObject);
    ...
    IPAK_COARMAQuery PAK_COARMAQuery = ServiceAgent.getInstance().GetObjectByName<IPAK_COARMAQuery>(WebConstant.IPAK_COARMAQuery);

    public string[] GvQueryColumnName = { "COASN", "IECPN", "RMA", "Cdt" };
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            String COA="",RMA="";
            hidModelListRMA.Value = hidModelListRMA.Value.Replace("'", "");
            hidModelListCOA.Value = hidModelListCOA.Value.Replace("'", "");
            txtCOA.Text = txtCOA.Text.Replace("'", "");
            txtRMA.Text = txtRMA.Text.Replace("'", "");
            if (rdbutCOA.SelectedItem.Value == "RMA")
            {
                if (txtRMA.Text != "")
                {
                    RMA = txtRMA.Text;
            ...
            //int sum = 0;
            dt = PAK_COARMAQuery.GetCOARMAQueryResult(DBConnection, RMA, COA, NumType);
