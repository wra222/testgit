<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="NonPaletProductQuery.aspx.cs" Inherits="Query_PAK_NonPaletProductQuery"  EnableEventValidation="false"  uiculture="auto"%>
...
<center>
 <fieldset id="grpCarton" style="border: thin solid #000000;">
    <legend align ="left" style ="height :20px" >
       <asp:Label ID="lblTitle" runat="server" Text="Non Palet Product Query" 
    ...
    <asp:Button ID="btnMail" runat="server" onclick="btnMail_Click" Text="Mail" style=" display:none" OnClientClick="beginWaitingCoverDiv()"/>
         ...
         <input   id="btnSetMail" type="button" value="設定收件人" onclick="btnSetMail_Click()" style=" display:none" />
...
//    });
    ...
    function btnSetMail_Click() {
        ...
        reportName = "NonPaletReportMailList";
