...
public partial class Query_PAK_ShipPLT3: IMESQueryBasePage
{
   ...
   // IMES.Query.Interface.QueryIntf.IFamily Family = ServiceAgent.getInstance().GetObjectByName<IMES.Query.Interface.QueryIntf.IFamily>(WebConstant.IFamilyBObject);
    ...
    IPAK_ShipPLT3 PAK_ShipPLT3 = ServiceAgent.getInstance().GetObjectByName<IPAK_ShipPLT3>(WebConstant.IPAK_ShipPLT3);

    public string[] GvQueryColumnName = { "Customer", "Forwarder", "DeliveryNo", "ShipmentNo", "HAWB", "Model", "PalletNo", "Qty", "已入庫", "未入庫" };
    public int[] GvQueryColumnNameWidth = { 40, 40, 45, 45, 40, 40, 40, 30, 50, 40};
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //int sum = 0;
            dt = PAK_ShipPLT3.GetShipPLT3Report(DBConnection, DateTime.Parse(txtFromDate.Text));
