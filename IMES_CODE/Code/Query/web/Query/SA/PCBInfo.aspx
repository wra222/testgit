...
<asp:Content ID="Content1" ContentPlaceHolderID="iMESContent" runat="Server">
    ...
    <div>
        <asp:ScriptManager ID="ScriptManager1" runat="server">
         ...
         <center>
                ...
                <table border="1" width="100%" style="border-width:thin;">
                    <tr>                    
                        <td style=" text-align:center; width: 60%;" >
                            <asp:Label ID="Label4" runat="server" Text="MB SN / MAC /CPU:" ></asp:Label>  
            ...
            <table style="width : 98%">
                <tr>
                    <td width="60%">
                        <fieldset id="Fieldset2" style="border: thin solid #000000; width: 98%; height: 130px;">
                            <legend align="left" style="height: 20px">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                <ContentTemplate>
                                    ...
                                    GvExtWidth="100%" GvExtHeight="110px" Height="1px">
                                    </iMES:GridViewExt>
                                </ContentTemplate>
                                <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="btnQuery" EventName="ServerClick" />
                    ...
                    <td>
                        <fieldset id="Fieldset1" style="border: thin solid #000000; width: 98%; height: 130px;">
                            <legend align="left" style="height: 20px">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                <ContentTemplate>
                                    <iMES:GridViewExt ID="gvPCANextStation" runat="server" AutoGenerateColumns="true"
                                        Width="98%" GvExtWidth="100%" GvExtHeight="110px" Height="1px">
                                    </iMES:GridViewExt>                            
                                </ContentTemplate>
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="btnQuery" EventName="ServerClick" />
            ...
            <fieldset id="Fieldset5" style="border: thin solid #000000; width: 98%;" height="160px">
                <legend align="left" style="height: 20px">
            ...
            <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                ...
                <Triggers>
                 ...
                 <fieldset id="Fieldset6" style="border: thin solid #000000; width:98%;">
            <legend align="left" style="height: 20px">
                <asp:Label ID="Label8" runat="server" CssClass="iMes_label_13pt" Text="PCBInfo"></asp:Label></legend>
            <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                <ContentTemplate>
                    <iMES:GridViewExt ID="gvPCBInfo" runat="server" AutoGenerateColumns="true"
                        Width="98%" GvExtWidth="100%" GvExtHeight="85px" Height="1px" 
                        style="top: 21px; left: 2px">
                    </iMES:GridViewExt>   
        ...
        <fieldset id="Fieldset3" style="border: thin solid #000000;" height="80px">
            <legend align="left" style="height: 20px">
            ...
            <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                <ContentTemplate>
                    <iMES:GridViewExt ID="gvChangePCBLog" runat="server" AutoGenerateColumns="true"
                        Width="100%" GvExtWidth="100%" GvExtHeight="60px" Height="1px" 
                        style="top: 21px; left: 2px">
                    </iMES:GridViewExt>                            
                </ContentTemplate>
                <Triggers>
