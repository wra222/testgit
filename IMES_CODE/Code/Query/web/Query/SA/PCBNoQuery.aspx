<%@ Page Title="ProductDistribute" Language="C#" MasterPageFile="~/MasterPageMaintain.master" AutoEventWireup="true" CodeFile="PCBNoQuery.aspx.cs" Inherits="Query_SA_PCBNoQuery" EnableEventValidation="false" %>
    ...
    <legend align ="left" style ="height :20px" >
       <asp:Label ID="lblTitle" runat="server" Text="PCBNoQuery" 
         ...
         <table border="0" width="100%" style="font-family: Tahoma">                    
            ...
            <tr>
               <td >
                    <asp:Label ID="lblPCBNo" runat="server" Text="PCBNo：" 
                        CssClass="iMes_label_13pt"></asp:Label>                    
               </td>
               <td >                   
                   <asp:TextBox ID="txtNewPCBNo" runat="server" Width="300px">
                   </asp:TextBox>
