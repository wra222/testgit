...
public partial class Query_SA_BoardHistoryQuery : System.Web.UI.Page
{
    ...
    private void InitPCAStatusGridView()
    {
        ...
        gvPCAStatus.HeaderRow.Cells[12].Width = Unit.Pixel(150); //CPU
        gvPCAStatus.HeaderRow.Cells[13].Width = Unit.Pixel(180);//Udt
    ...
    private DataTable initTable()
    {
        ...
        retTable.Columns.Add("CPU", Type.GetType("System.String"));
