...
namespace com.inventec.imes.manager
{
    ...
    public class AuthorityManager
    {
       ...
       // private UserInfo userInfo = new UserInfo();
	    ...
	    public IAccountRoleEx accountRoleEx = null;
        ...
        */
        ...
        public DataTable GetAllPermissionList()
        {
            ...
            PermissionInfo[] permissins;
            if (userInfo == null)
            {
                permissins = permissionMgr.findPermissionsByApplication(application);
            }
            else
            {
                permissins = (accountRoleEx.GetOwnPermissionByLoginApplication(userInfo.Login, application)).ToArray();
            }
