...
namespace com.inventec.iMESWEB
{
    ...
    public class IMESQueryBasePage : System.Web.UI.Page
    {
        ...
        public static string PAKCosmetic_SUM;

        public static string EfficiencyStation;

        
        public static string FAShipmentStation;
        public static string PAKBTOnlineStation;
        ...
        {
            //string err = "";
            List<string> lst = new List<string> { "PAKStation", "FAStation", "PAKOnlineStation", 
                "FAOnlineStation", "YieldStation", "Status87", "PCAInputStation", "MVS_SUM", 
                "ITCND_SUM", "COA_SUM", "EffStation","FAShipmentStation","PAKBTOnlineStation","PAKCosmetic_SUM"};
            ...
            PAKCosmetic_SUM = FindValue(dt, "PAKCosmetic_SUM"); 
