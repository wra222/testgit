    ...
    public class PAK_Common : MarshalByRefObject, IPAK_Common
    {
        ...
        public DataTable GetSnByPalletNo(string Connection, string palletNo)
        {
            ...
            try
            {
                ...
                return SQLHelper.ExecuteDataFill(Connection,
                                                 System.Data.CommandType.StoredProcedure,
                                                 "sp_Query_PAK_GetSnByPalletNo",
                                                  SQLHelper.CreateSqlParameter("@PalletNoOrSnList", 2056, palletNo));
        ...
        public DataTable GetByCartonSN(string Connection, string CartonSN)
        {
            string methodName = MethodBase.GetCurrentMethod().Name;
            ...
            try
            {
                string SQLText = @"select a.ProductID,a.CUSTSN,a.CartonSN,a.Model,a.DeliveryNo,a.PalletNo,b.Station,b.Line,a.UnitWeight from Product a  WITH(NOLOCK)
                                   LEFT JOIN ProductStatus b on a.ProductID=b.ProductID where a.CartonSN in
                                            (select value from fn_split('{0}',',')) order by a.CartonSN";
                SQLText = string.Format(SQLText, CartonSN);
                return SQLHelper.ExecuteDataFill(Connection,
                                                 System.Data.CommandType.Text,
                                                 SQLText);
        ...
        public DataTable GetPalletReqQty(string Connection)
        {
            string methodName = MethodBase.GetCurrentMethod().Name;
            BaseLog.LoggingBegin(logger, methodName);
            ...
            try
            {
                string SQLText = @"sp_Query_PAK_GetPalletReqQty";
                DataTable dt = SQLHelper.ExecuteDataFill(Connection,
                                                                  System.Data.CommandType.StoredProcedure,
                                                                  SQLText);
