 ...
 * Known issues:
--%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smtLineEdit.aspx.cs" Inherits="webroot_aspx_dashboard_smtLineEdit" %>
...
function initControlValue()
{
    ...
    setCheckBoxValue(document.getElementById("dAOIOutput"), lineItem.IsAOIOutputDsp);
    setCheckBoxValue(document.getElementById("dAOIDefect"), lineItem.IsAOIDefectDsp);
...
function showWindow(){
    ...
    itemArray[17]={baseName:"AOIOutput",type:"checkbox",item:"AOI&nbspOutput"}
    itemArray[18]={baseName:"AOIDefect",type:"checkbox",item:"AOI&nbspDefect"}
...
function dealSave(){
    ...
    itemArray[14]={baseName:"Input",type:"checkbox",item:"Input"}
    itemArray[15]={baseName:"Defect",type:"checkbox",item:"Defect"}
    itemArray[16]={baseName:"YieldRate",type:"checkbox",item:"Yield Rate"}
    itemArray[17]={baseName:"AOIOutput",type:"checkbox",item:"AOI Output"}
    itemArray[18]={baseName:"AOIDefect",type:"checkbox",item:"AOI Defect"}
    ...
    if(getCheckBoxValue(document.all("dAOIOutput"))==true)
    {
        lineItem.IsAOIOutputDsp="True";
    }
    else
    {
        lineItem.IsAOIOutputDsp="False";
    }
    
    if(getCheckBoxValue(document.all("dAOIDefect"))==true)
    {
        lineItem.IsAOIDefectDsp="True";
    }
    else
    {
        lineItem.IsAOIDefectDsp="False";
    }
