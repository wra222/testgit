...
namespace UTL
{
     ...
     public enum MsgType { CheckWC, DataCollectionIndex, TestCompletedIndex, QueryBoxInfoIndex, QueryMBInfoIndex, ProcessCompletedIndex, AutoWeightIndex, LabelLightGuidIndex };
     public class Tool
    {
         ...
         {    int result=0;
              switch (msg)
              {
                  ...
                  case MsgType.QueryMBInfoIndex:
                      ...
                      break;
                  case MsgType.ProcessCompletedIndex:
                      result = ProcessCompletedIndex.MsgArrayLength;
                      break;
                  case MsgType.AutoWeightIndex:
                      result = AutoWeightIndex.MsgArrayLength;
                      break;
                  case MsgType.LabelLightGuidIndex:
                      result = LabelLightGuidIndex.MsgArrayLength;
                      break;
              }
               return result;
         }
